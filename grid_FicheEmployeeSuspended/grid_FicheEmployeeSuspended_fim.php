...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_FicheEmployeeSuspended"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_FicheEmployeeSuspended"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_FicheEmployeeSuspended'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_FicheEmployeeSuspended</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployeeSuspended']['embutida_filho'] as $ind => $sc_init)
          {
