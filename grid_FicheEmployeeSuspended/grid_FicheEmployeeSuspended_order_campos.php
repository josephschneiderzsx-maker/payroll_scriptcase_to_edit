<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_FicheEmployeeSuspended']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_FicheEmployeeSuspended_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_FicheEmployeeSuspended_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['userid_int'] = "userid_int";
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["userid_int"] : "ID";
   $tab_ger_campos['employee_name'] = "on";
   $tab_def_campos['employee_name'] = "employee_name";
   $tab_labels["employee_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["employee_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["employee_name"] : "Employee Name";
   $tab_ger_campos['designation'] = "on";
   $tab_def_campos['designation'] = "designation";
   $tab_labels["designation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["designation"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["designation"] : "Designation";
   $tab_ger_campos['dept'] = "on";
   $tab_def_campos['dept'] = "dept";
   $tab_labels["dept"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["dept"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["dept"] : "Department";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "Phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["phone"] : "Phone";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "Email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["email"] : "Email";
   $tab_ger_campos['gender'] = "on";
   $tab_def_campos['gender'] = "Gender";
   $tab_labels["gender"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["gender"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["gender"] : "Gender";
   $tab_ger_campos['hiredate'] = "on";
   $tab_def_campos['hiredate'] = "hiredate";
   $tab_labels["hiredate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["hiredate"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["hiredate"] : "Hiredate";
   $tab_ger_campos['firedate'] = "on";
   $tab_def_campos['firedate'] = "firedate";
   $tab_labels["firedate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["firedate"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["firedate"] : "Suspended Date";
   $tab_ger_campos['rate_fixed'] = "on";
   $tab_def_campos['rate_fixed'] = "rate_fixed";
   $tab_labels["rate_fixed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["rate_fixed"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["rate_fixed"] : "Gross Income";
   $tab_ger_campos['revenu_net'] = "on";
   $tab_def_campos['revenu_net'] = "revenu_net";
   $tab_labels["revenu_net"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["revenu_net"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['labels']["revenu_net"] : "Net Income";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_FicheEmployeeSuspended_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_FicheEmployeeSuspended']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
