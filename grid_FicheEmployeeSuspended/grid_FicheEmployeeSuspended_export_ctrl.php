<?php
@session_start() ;
$_SESSION['scriptcase']['grid_FicheEmployeeSuspended']['sc_process_barr'] = true;
require_once('../grid_FicheEmployeeSuspended/index.php');
unset($_SESSION['scriptcase']['grid_FicheEmployeeSuspended']['sc_process_barr']);
$ExportCtrl = new grid_FicheEmployeeSuspended_export_control;
$ExportCtrl->Export_barr();

class grid_FicheEmployeeSuspended_export_control
{
