...
class frm_UpdateOTOffdayFactorByValue_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe=true, $err_usr=false)
   {
      ...
      $this->monta_mensagem();
      return frm_UpdateOTOffdayFactorByValue_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe, $err_usr);
   }
