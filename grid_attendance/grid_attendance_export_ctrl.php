<?php
@session_start() ;
$_SESSION['scriptcase']['grid_attendance']['sc_process_barr'] = true;
require_once('../grid_attendance/index.php');
unset($_SESSION['scriptcase']['grid_attendance']['sc_process_barr']);
$ExportCtrl = new grid_attendance_export_control;
$ExportCtrl->Export_barr();

class grid_attendance_export_control
{
