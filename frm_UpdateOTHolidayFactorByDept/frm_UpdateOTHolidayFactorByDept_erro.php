...
$old_error_handler = set_error_handler("frm_UpdateOTHolidayFactorByDept_scriptcase_error_handler");

function frm_UpdateOTHolidayFactorByDept_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frm_UpdateOTHolidayFactorByDept']['contr_erro']) && $_SESSION['scriptcase']['frm_UpdateOTHolidayFactorByDept']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frm_UpdateOTHolidayFactorByDept->contr_frm_UpdateOTHolidayFactorByDept->Apl_com_erro = true;
            if ($inicial_frm_UpdateOTHolidayFactorByDept->contr_frm_UpdateOTHolidayFactorByDept->NM_ajax_flag)
            {
                $inicial_frm_UpdateOTHolidayFactorByDept->contr_frm_UpdateOTHolidayFactorByDept->NM_ajax_info['errList']['geral_frm_UpdateOTHolidayFactorByDept'][] = $msg;
                return;
            }
            frm_UpdateOTHolidayFactorByDept_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frm_UpdateOTHolidayFactorByDept_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByDept'])  && '' != $_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByDept'])  ? $_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByDept']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByDept']) && '' != $_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByDept']) ? $_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByDept'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByDept']) && '' != $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByDept']) ? $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByDept'] : '';
?>
