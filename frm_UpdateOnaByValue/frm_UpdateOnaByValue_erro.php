...
$old_error_handler = set_error_handler("frm_UpdateOnaByValue_scriptcase_error_handler");

function frm_UpdateOnaByValue_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frm_UpdateOnaByValue']['contr_erro']) && $_SESSION['scriptcase']['frm_UpdateOnaByValue']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frm_UpdateOnaByValue->contr_frm_UpdateOnaByValue->Apl_com_erro = true;
            if ($inicial_frm_UpdateOnaByValue->contr_frm_UpdateOnaByValue->NM_ajax_flag)
            {
                $inicial_frm_UpdateOnaByValue->contr_frm_UpdateOnaByValue->NM_ajax_info['errList']['geral_frm_UpdateOnaByValue'][] = $msg;
                return;
            }
            frm_UpdateOnaByValue_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frm_UpdateOnaByValue_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frm_UpdateOnaByValue'])  && '' != $_SESSION['scriptcase']['error_icon']['frm_UpdateOnaByValue'])  ? $_SESSION['scriptcase']['error_icon']['frm_UpdateOnaByValue']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frm_UpdateOnaByValue']) && '' != $_SESSION['scriptcase']['error_span_title']['frm_UpdateOnaByValue']) ? $_SESSION['scriptcase']['error_span_title']['frm_UpdateOnaByValue'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frm_UpdateOnaByValue']) && '' != $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOnaByValue']) ? $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOnaByValue'] : '';
?>
