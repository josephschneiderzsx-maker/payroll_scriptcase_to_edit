<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reg_gross_income02']['sc_process_barr'] = true;
require_once('../grid_reg_gross_income02/index.php');
unset($_SESSION['scriptcase']['grid_reg_gross_income02']['sc_process_barr']);
$ExportCtrl = new grid_reg_gross_income02_export_control;
$ExportCtrl->Export_barr();

class grid_reg_gross_income02_export_control
{
