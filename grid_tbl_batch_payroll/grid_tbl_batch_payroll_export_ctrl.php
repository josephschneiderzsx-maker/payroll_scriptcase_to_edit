<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbl_batch_payroll']['sc_process_barr'] = true;
require_once('../grid_tbl_batch_payroll/index.php');
unset($_SESSION['scriptcase']['grid_tbl_batch_payroll']['sc_process_barr']);
$ExportCtrl = new grid_tbl_batch_payroll_export_control;
$ExportCtrl->Export_barr();

class grid_tbl_batch_payroll_export_control
{
