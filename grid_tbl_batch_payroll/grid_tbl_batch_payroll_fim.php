...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_batch_payroll"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_batch_payroll"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_batch_payroll'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbl_batch_payroll</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_payroll']['embutida_filho'] as $ind => $sc_init)
          {
