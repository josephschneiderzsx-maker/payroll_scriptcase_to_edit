...
function scHidePage(pageNo) {
        $("#id_form_FicheEmployeeSuspended_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_dob" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_dob(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hiredate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_hiredate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_firedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_firedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_loan" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_date_loan(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_payment" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_date_payment(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_loan_start_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_loan_start_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_loan_end_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_loan_end_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_loan_bank" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_date_loan_bank(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_loan_start_deduct_bank" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_loan_start_deduct_bank(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_loan_end_deduct_bank" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_loan_end_deduct_bank(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_other_loan" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_date_other_loan(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_other_loan_start_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_other_loan_start_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_other_loan_end_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_other_loan_end_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_date_purchase" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_date_purchase(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_purchase_start_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_purchase_start_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_purchase_end_deduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_purchase_end_deduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_FicheEmployeeSuspended_mob_validate_update_time(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_photo_name" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_FicheEmployeeSuspended_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_FicheEmployeeSuspended_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
