...
class form_FicheEmployeeSuspended_mob_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe=true, $err_usr=false)
   {
      ...
      $this->monta_mensagem();
      return form_FicheEmployeeSuspended_mob_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe, $err_usr);
   }
