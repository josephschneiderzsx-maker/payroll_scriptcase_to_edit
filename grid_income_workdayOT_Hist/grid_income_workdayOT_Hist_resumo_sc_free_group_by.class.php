...
class grid_income_workdayOT_Hist_resumo
{
   ...
   if ($this->Ini->Embutida_iframe) {
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['heatmap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['treemap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chord_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['sankey_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['sunburst_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        if (!empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['SC_Gb_Free_cmp']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_x_axys']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_y_axys'])) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            ...
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
                ...
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_order_direction'] [$dimensionIndex];
    
                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_x_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
                }
                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_y_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['y'] [] = $dimensionName;
                }
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_record_count']; 
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length']; 
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_income_workdayOT_Hist/index.php";
...
SCEOT;
    ...
    let windowName = "grid_income_workdayOT_Hist_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
    ...
    function display_pdf_charts()
    {
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level']) {
                continue;
            }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($chartInfo['info_type'] != $chartInfoType) {
                continue;
            } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_level']) {
                continue;
            }

            if ($this->progress_fp) {
                grid_income_workdayOT_Hist_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_income_workdayOT_Hist_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...\n", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChartAppCharts()
    {
        ...
        if (1 < count($this->SC_APP_info['group_by'] ['metric'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['graf_opc_atual'] = 2;
        } else {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['graf_opc_atual'] = 1;
        }
        ...
        foreach ($this->SC_APP_data['ordered_y_matrix'] as $rowDimensionInfo) {
            ...
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_drill_down']) || !$_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['summarizing_drill_down']) {
                continue;
            }
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_md5_list'] = $this->SC_APP_data['chart_md5_list'];
    ...
    function aux_addChartAppGrandTotalChart()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_income_workdayOT_Hist@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_income_workdayOT_Hist'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_income_workdayOT_Hist'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_income_workdayOT_Hist'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['cfg_graf'] ['graf_tipo']) {
            case 'Chord':
                return 'chord_info';
            case 'Heatmap':
                return 'heatmap_info';
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['opcao']) {
            return true;
        }
    ...
    {
        return $this->aux_isPdf() && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['skip_summary'];
    }
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_def'] = [
            'field' => [],
            'label' => [],
            'summ' => [],
        ];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_data'] = [];

        foreach ($this->SC_APP_info['group_by'] ['metric'] as $i => $metricName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_def'] ['field'] [] = $metricName;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_def'] ['label'] [] = $this->SC_APP_info['metric'] [$metricName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_def'] ['summ'] [] = $i;
        }

        $this->aux_storeSummaryTableInfo_recursive($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['comb_table_data'], $this->SC_APP_data['ordered_y_axys'], 0, []);
    }
...
SCEOT;
    ...
    function generateChartImages()
    {
        ...
        $chartInfoType = $this->aux_getChartInfoType();
        $chartList = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_workdayOT_Hist'] ['chart_md5_list'];
        $chartFiles = array();

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['phantomjs_export_process'] = true;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step']     = 'image';
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_count']    = 0;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_total']    = 0;
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_total']++;
            }
        }
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['phantomjs_export_file'] = '';
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_count']++;
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['phantomjs_export_process'] = false;
    ...
    function zipChartImages($password = '')
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step'] = 'zip';

        $this->writeProgressFile();

        $zipFile = $this->zipFileList($chartImages, $password);

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step'] = 'end';
    ...
    function zipFileList($fileList, $password = '') {
        $tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_income_workdayOT_Hist']['glo_nm_path_imag_temp'] . '/';
    ...
    function writeProgressFile() {
        if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_total']}###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_step']) {
            $content = "ok###100";
        } else {
            $content = "init###0";
        }

        $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_income_workdayOT_Hist']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['export_progress_file']}", 'w');
        fwrite($f, $content);
        fclose($f);
    }
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_dept = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total_line']['dept'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_dept = array();
                $this->totaliza();
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_clear_total'] = true;
            }
          $this->array_total_dept = array();
          $this->totaliza('main');
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total']['dept'] = $this->array_total_dept;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total_line']['dept'] = $this->array_line_dept;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['json_use_label'])
       {
          $Lab_dept = "dept";
       }
       else
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['dept'] = $Lab_dept; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['userid_int']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['userid_int'] = "ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['username']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['username'] = "Employee Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['pay_startdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['pay_startdate'] = "Start Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['pay_enddate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['pay_enddate'] = "End Date"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['ot_hh_w']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['ot_hh_w'] = "OT AM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['ot_hh_w_pm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['ot_hh_w_pm'] = "OT PM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_ot_factor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_ot_factor'] = "Rate OT Factor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_work']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_work'] = "Rate Work"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['income_workday_ot']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['income_workday_ot'] = "Income Workday OT"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['hiredate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['hiredate'] = "Hiredate"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['dept']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['dept'] = "Department"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['designation']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['designation'] = "Designation"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_salf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['rate_salf'] = "Fixed Salary"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['work_hh_w']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['work_hh_w'] = "Workday AM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['work_hh_w_pm']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['work_hh_w_pm'] = "Worday PM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['income_workday']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['labels']['income_workday'] = "Income Workday"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "HH OT AM (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "HH OT PM (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Income Workday OT (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "ot_hh_w", 'show' => true),
           3 => array('field' => "ot_hh_w_pm", 'show' => true),
           4 => array('field' => "income_workday_ot", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_ot_hh_w_sum",
           3 => "css_ot_hh_w_pm_sum",
           4 => "css_income_workday_ot_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_income_workdayOT_Hist@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "grid_income_workdayOT_Hist_total.class.php"); 
      }
      ...
      $this->Total   = new grid_income_workdayOT_Hist_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['LigR_Md5'] = array();
   }
   ...
   function totaliza($tipo='')
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_fast'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_fast'] . ")";
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq_fast'] . ")";
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_resumo_search'] . ")"; 
               }
          }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][2];
      $this->array_total_geral[1][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][3];
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][4];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][2];
          $this->array_total_geral[2][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][3];
          $this->array_total_geral[2][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][4];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE html>\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_income_workdayOT_Hist_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_income_workdayOT_Hist_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_income_workdayOT_Hist_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_income_workdayOT_Hist/grid_income_workdayOT_Hist_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'] && !$this->aux_isPdf())
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_income_workdayOT_Hist/grid_income_workdayOT_Hist_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_income_workdayOT_Hist&nm_tp_xls=xls&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_income_workdayOT_Hist_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_income_workdayOT_Hist']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_income_workdayOT_Hist']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_income_workdayOT_Hist_config_pivot.php?nome_apl=grid_income_workdayOT_Hist&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_income_workdayOT_Hist_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_income_workdayOT_Hist_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_income_workdayOT_Hist/grid_income_workdayOT_Hist_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_ot_hh_w, $sum_ot_hh_w_pm, $sum_income_workday_ot, $quebra_dept, $quebra_dept_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_workdayOT_Hist']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_ot_hh_w . ';
              $this->' . $arr_name . '[2] = ' . $sum_ot_hh_w_pm . ';
              $this->' . $arr_name . '[3] = ' . $sum_income_workday_ot . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_ot_hh_w . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_ot_hh_w_pm . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_income_workday_ot . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ot_hh_w = $rs_res->fields[4] ;  
            $this->ot_hh_w_pm = $rs_res->fields[5] ;  
            $this->rate_ot_factor = $rs_res->fields[6] ;  
            $this->rate_work = $rs_res->fields[7] ;  
            $this->rate_work =  str_replace(",", ".", $this->rate_work);
            $this->income_workday_ot = $rs_res->fields[8] ;  
            ...
            $this->rate_salf = $rs_res->fields[12] ;  
            $this->rate_salf =  str_replace(",", ".", $this->rate_salf);
            $this->dept_orig = $this->dept;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ot_hh_w, $this->ot_hh_w_pm, $this->income_workday_ot, $this->dept, $this->dept_orig);
            }
   }
//
