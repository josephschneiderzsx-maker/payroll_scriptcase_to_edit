<?php
@session_start() ;
$_SESSION['scriptcase']['grid_income_offday']['sc_process_barr'] = true;
require_once('../grid_income_offday/index.php');
unset($_SESSION['scriptcase']['grid_income_offday']['sc_process_barr']);
$ExportCtrl = new grid_income_offday_export_control;
$ExportCtrl->Export_barr();

class grid_income_offday_export_control
{
