<?php
//
class form_FicheEmployee02_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_FicheEmployee02_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['upload_field_info']['photo_name'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_FicheEmployee02_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02_mob']['upload_field_info']['photo_file'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_FicheEmployee02_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FicheEmployee02_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FicheEmployee02_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FicheEmployee02_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FicheEmployee02_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_FicheEmployee02_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FicheEmployee02_mob']['label'] = "Employee Sheet";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_FicheEmployee02_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->nm_new_label['phone'] = '' . $this->Ini->Nm_lang['lang_username'] . '';
      ...
      $this->arr_buttons['sc_btn_2']['value']            = "Salary History";
      ...
      $_SESSION['scriptcase']['error_icon']['form_FicheEmployee02_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_FicheEmployee02_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_field_ul_name'][$this->photo_name_ul_name]))
          {
              $this->NM_ajax_info['param']['photo_name_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_field_ul_name'][$this->photo_name_ul_name];
          }
      ...
      elseif (isset($this->photo_name_ul_name) && '' != $this->photo_name_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_field_ul_name'][$this->photo_name_ul_name]))
          {
              $this->photo_name_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_field_ul_name'][$this->photo_name_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FicheEmployee02_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FicheEmployee02_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FicheEmployee02_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form'];
          ...
          if (!isset($this->firedate)){$this->firedate = $this->nmgp_dados_form['firedate'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_FicheEmployee02_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_FicheEmployee02/form_FicheEmployee02_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_FicheEmployee02_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_FicheEmployee02_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_FicheEmployee02_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_FicheEmployee02/form_FicheEmployee02_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_FicheEmployee02_mob_erro.class.php"); 
      }
      $this->Erro      = new form_FicheEmployee02_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02_mob']['start']);
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_FicheEmployee02']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['botoes']['sc_btn_0'];
          $this->nmgp_botoes['sc_btn_1'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['botoes']['sc_btn_1'];
          $this->nmgp_botoes['sc_btn_2'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['botoes']['sc_btn_2'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['total']);
      ...
      $this->sc_insert_on = false;
        ...
        case 'photo_name':
            ...
            $__file_download = $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_cache'] . (isset($_POST['p_cache']) ? $_POST['p_cache'] : '//' ). basename($_POST['AjaxCheckImg']);
            $img_width = '200';
            $img_height = '200';
            $file_name = '/sc_'.$_REQUEST['rsargs']. '_' . md5("".'_'.basename($__file_download)) .'.' . 'gif';
            if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['download_filenames']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['download_filenames'] = array();
            }
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['download_filenames'][$_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_imag_temp'] .$file_name] = utf8_decode($_POST['AjaxCheckImg']);

            if(file_exists($__file_download)){ break; }

            if(!__sc_api_storage_check([
                    'profile' => 'grp__NM__PHIFA_API',
                    'file' => $_SERVER['DOCUMENT_ROOT'] .'/' . $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_imagens'] . "" . '/' . $_POST['AjaxCheckImg'],
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['firedate']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['firedate']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['firedate']['date_display'] = "ddmmaaaa";
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "incluir") {
          $this->employee_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['employee_name'];
          $this->ic = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['ic'];
          $this->designation = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['designation'];
          $this->dept = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['dept'];
          $this->gender = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['gender'];
          $this->dob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['dob'];
      ...
      elseif ('null' == $this->dob || '' == $this->dob)
      {
          ...
          $this->address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['address'];
          $this->phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['phone'];
          $this->hiredate = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['hiredate'];
      ...
      elseif ('null' == $this->hiredate || '' == $this->hiredate)
      {
          ...
          $this->email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['email'];
          $this->hiring_duration = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['hiring_duration'];
      if ('' !== $this->hiring_duration || (!empty($format_fields) && isset($format_fields['hiring_duration'])))
      {
          ...
          $this->tax_cass = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['tax_cass'];
      if ('' !== $this->tax_cass || (!empty($format_fields) && isset($format_fields['tax_cass'])))
      {
          ...
          $this->tax_cfgdct = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['tax_cfgdct'];
      if ('' !== $this->tax_cfgdct || (!empty($format_fields) && isset($format_fields['tax_cfgdct'])))
      {
          ...
          $this->tax_ona = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['tax_ona'];
      if ('' !== $this->tax_ona || (!empty($format_fields) && isset($format_fields['tax_ona'])))
      {
          ...
          $this->tax_fdu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['tax_fdu'];
      if ('' !== $this->tax_fdu || (!empty($format_fields) && isset($format_fields['tax_fdu'])))
      {
          ...
          $this->rate_iris = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['rate_iris'];
      if ('' !== $this->rate_iris || (!empty($format_fields) && isset($format_fields['rate_iris'])))
      {
          ...
          $this->revenu_net = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['revenu_net'];
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['employee_name']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->employee_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['employee_name'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['ic']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ic = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['ic'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['designation']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->designation = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['designation'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['dept']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dept = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['dept'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['gender']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->gender = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['gender'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['dob']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['dob'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['address']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->address = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['address'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['phone']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->phone = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['phone'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['hiredate']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hiredate = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['hiredate'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['email']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['email'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['hiring_duration']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hiring_duration = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['hiring_duration'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_cass']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tax_cass = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_cass'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_cfgdct']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tax_cfgdct = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_cfgdct'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_ona']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tax_ona = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_ona'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_fdu']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tax_fdu = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['tax_fdu'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['rate_iris']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->rate_iris = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['rate_iris'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['revenu_net']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->revenu_net = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select']['revenu_net'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_FicheEmployee02_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_FicheEmployee02_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_FicheEmployee02_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_FicheEmployee02_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   ...
   function sc_btn_sc_btn_0() 
   {
     ...
     if (empty($this->photo_name)) {
         $this->photo_name = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['photo_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['photo_name'] : "";
     }
?>
<!DOCTYPE html>
...
<?php
include_once("form_FicheEmployee02_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'] == "incluir")
      {
          $nmgp_opc_ant_saida_php = "novo";
          $nmgp_opcao_saida_php   = "recarga";
      }
      $nm_f_saida = "form_FicheEmployee02_mob.php";
      ...
      $this->nm_converte_datas();
      $_SESSION['scriptcase']['form_FicheEmployee02_mob']['contr_erro'] = 'on';
...
<?php
      ...
      {
          if (!isset($this->userid_int) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['userid_int']))
          {
              $varloc_btn_php['userid_int'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form']['userid_int'];
          }
      }
      $nm_f_saida = "form_FicheEmployee02_mob.php";
      nm_limpa_numero($this->userid_int, $this->field_config['userid_int']['symbol_grp']) ; 
...
$_SESSION['scriptcase']['form_FicheEmployee02_mob']['contr_erro'] = 'off'; 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']);
    echo ob_get_clean();
?>
      </td></tr><tr><td align="center">
      <form name="FPHP" method="post" 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_FicheEmployee02_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_FicheEmployee02_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_FicheEmployee02_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_FicheEmployee02_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_userid_int(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fingertec ID: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_phone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_username'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->photo_name && "S" != $this->photo_name_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_FicheEmployee02_mob_doc_name.php';
                }
    ...
    function ValidateField_rate_cfgdct(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "CFGDCT: " . $this->Ini->Nm_lang['lang_errm_size']; 
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_FicheEmployee02_mob_pack_protect_string($this->nmgp_dados_form['id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['foreign_key']['userid_int'] = $this->nmgp_dados_form['userid_int'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['where_filter'] = "userid_int = " . $this->nmgp_dados_form['userid_int'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['where_detal']  = "userid_int = " . $this->nmgp_dados_form['userid_int'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['form_tbl_note_employee_mob_script_case_init'] ]['form_tbl_note_employee_mob']['total']);
              }
          }
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['firedate']) && $NM_val_form['firedate'] != $this->nmgp_dados_select['firedate']) 
              { 
                  $SC_fields_update[] = "firedate = " . $this->Ini->date_delim . $this->firedate . $this->Ini->date_delim1 . ""; 
              } 
            ...
            sc_api_storage_delete([
                    ...
                    'parents' => '/PAYROLLHTG/EMPPHOTO',
                     ...
                     $__file_api = $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_cache'] . '//'. basename($this->nmgp_dados_form['photo_name']);
            ...
            if (!empty($aEraseFiles)){
                foreach ($aEraseFiles as $aEraseData){
                    ...
                    $__file_api = $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_cache'] . '//'. basename($aEraseData['file']);
                     if(file_exists($__file_api)){
                        unlink($__file_api);
                     }
                }
        ...
        if( !empty($this->photo_name_scfile_name) ){
              ...
              sc_api_upload([
                    ...
                    'parents' => '/PAYROLLHTG/EMPPHOTO',
                     ...
                     @mkdir($_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_cache'] . '//', 0755, true);
                     @copy($this->Ini->root . $this->Ini->path_imagens . "" . '/' .  $this->photo_name_scfile_name, $_SESSION['scriptcase']['form_FicheEmployee02_mob']['glo_nm_path_cache'] . '//'.  $this->photo_name_scfile_name);
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['photo_name_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('userid_int', 'employee_name', 'ic', 'designation', 'dept', 'gender', 'dob', 'address', 'phone', 'hiredate', 'email', 'field01', 'hiring_duration', 'photo_name', 'photo_size', 'rate_cass', 'tax_cass', 'rate_cfgdct', 'tax_cfgdct', 'rate_ona', 'tax_ona', 'rate_fdu', 'tax_fdu', 'field02', 'rate_iris', 'rate_fixed', 'revenu_net', 'block_note'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']);
              }
        ...
        if( !empty($this->photo_name_scfile_name) ){
            ...
            sc_api_upload([
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
...
if(!empty($this->nmgp_dados_form['photo_name'])){
            sc_api_storage_delete([
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] = 0; 
              }
...
if(!empty($this->nmgp_dados_form['photo_name'])){
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_FicheEmployee02_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] = $qt_geral_reg_form_FicheEmployee02_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_FicheEmployee02_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] > $qt_geral_reg_form_FicheEmployee02_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] = $qt_geral_reg_form_FicheEmployee02_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_FicheEmployee02_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['parms'] = ""; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              $aWhere[] = "id = $this->id"; 
              if (!empty($sc_where_filter))  
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['sub_dir'][1]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] < $qt_geral_reg_form_FicheEmployee02_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao']   = '';
          }
      } 
   ...
   { 
     ...
     return ;  
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_photo_name))
       {
        ...
        $this->initFormPages();
    include_once("form_FicheEmployee02_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("userid_int", "employee_name", "ic", "designation", "dept", "gender", "dob", "address", "phone", "hiredate", "email", "hiring_duration", "photo_name", "photo_size", "rate_cass", "tax_cass", "rate_cfgdct", "tax_cfgdct", "rate_ona", "tax_ona", "rate_fdu", "tax_fdu", "rate_iris", "rate_fixed", "revenu_net", "block_note"))) {
            $searchOk = true;
        }
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("userid_int", "employee_name", "ic", "designation", "dept", "gender", "dob", "address", "phone", "hiredate", "email", "hiring_duration", "photo_name", "photo_size", "rate_cass", "tax_cass", "rate_cfgdct", "tax_cfgdct", "rate_ona", "tax_ona", "rate_fdu", "tax_fdu", "rate_iris", "rate_fixed", "revenu_net", "block_note"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_FicheEmployee02_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] = $qt_geral_reg_form_FicheEmployee02_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_FicheEmployee02_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["dob"] = "date";$Nm_datas["hiredate"] = "date";$Nm_datas["firedate"] = "date";$Nm_datas["date_loan"] = "date";$Nm_datas["date_payment"] = "date";$Nm_datas["loan_start_deduct"] = "date";$Nm_datas["loan_end_deduct"] = "date";$Nm_datas["date_loan_bank"] = "date";$Nm_datas["loan_start_deduct_bank"] = "date";$Nm_datas["loan_end_deduct_bank"] = "date";$Nm_datas["date_other_loan"] = "date";$Nm_datas["other_loan_start_deduct"] = "date";$Nm_datas["other_loan_end_deduct"] = "date";$Nm_datas["date_purchase"] = "date";$Nm_datas["purchase_start_deduct"] = "date";$Nm_datas["purchase_end_deduct"] = "date";$Nm_datas["update_time"] = "timestamp";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_FicheEmployee02_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_FicheEmployee02_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "update":
                ...
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-2", "sys_separator.sc-unique-btn-3", "sys_separator.sc-unique-btn-13", "sys_separator.sc-unique-btn-14");
                break;
            case "sc_btn_1":
            ...
            case "sc_btn_0":
                ...
                break;
            case "sc_btn_2":
                return array("sc_sc_btn_2_top", "sc_sc_btn_2_top");
                break;
            case "breload":
                return array("sc_b_reload_t.sc-unique-btn-4", "sc_b_reload_t.sc-unique-btn-15");
                break;
            case "help":
            ...
            case "birpara":
                ...
                break;
            case "first":
                return array("sc_b_ini_b.sc-unique-btn-8", "sc_b_ini_b.sc-unique-btn-19");
                break;
            case "back":
                return array("sc_b_ret_b.sc-unique-btn-9", "sc_b_ret_b.sc-unique-btn-20");
                break;
            case "forward":
                return array("sc_b_avc_b.sc-unique-btn-10", "sc_b_avc_b.sc-unique-btn-21");
                break;
            case "last":
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FicheEmployee02_mob']['ordem_ord'] == " desc") {
