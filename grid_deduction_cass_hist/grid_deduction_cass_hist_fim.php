...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cass_hist"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cass_hist"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_deduction_cass_hist</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass_hist']['embutida_filho'] as $ind => $sc_init)
          {
