<?php
@session_start() ;
$_SESSION['scriptcase']['grid_deduction_cass_hist']['sc_process_barr'] = true;
require_once('../grid_deduction_cass_hist/index.php');
unset($_SESSION['scriptcase']['grid_deduction_cass_hist']['sc_process_barr']);
$ExportCtrl = new grid_deduction_cass_hist_export_control;
$ExportCtrl->Export_barr();

class grid_deduction_cass_hist_export_control
{
