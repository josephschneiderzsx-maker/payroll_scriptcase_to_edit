...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_additional"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_additional"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_additional']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_income_additional']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_additional']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_income_additional']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_income_additional']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_income_additional</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_income_additional']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_income_additional']['embutida_filho'] as $ind => $sc_init)
          {
