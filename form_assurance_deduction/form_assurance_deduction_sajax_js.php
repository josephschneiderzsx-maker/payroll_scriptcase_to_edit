  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_assurance_deduction" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_assurance_deduction_form();
        }
...
?>
  ...
  function do_ajax_form_assurance_deduction_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldText(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_userid_int__cb);
  } // do_ajax_form_assurance_deduction_validate_userid_int_

  function do_ajax_form_assurance_deduction_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_form_assurance_deduction_validate_employee_name_(iNumLinha)
  {
    var nomeCampo_employee_name_ = "employee_name_" + iNumLinha;
    var var_employee_name_ = scAjaxGetFieldText(nomeCampo_employee_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_employee_name__cb);
  } // do_ajax_form_assurance_deduction_validate_employee_name_

  function do_ajax_form_assurance_deduction_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_employee_name__cb

  // ---------- Validate dept_
  function do_ajax_form_assurance_deduction_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldText(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_dept__cb);
  } // do_ajax_form_assurance_deduction_validate_dept_

  function do_ajax_form_assurance_deduction_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_dept__cb

  // ---------- Validate deduct_assurance_
  function do_ajax_form_assurance_deduction_validate_deduct_assurance_(iNumLinha)
  {
    var nomeCampo_deduct_assurance_ = "deduct_assurance_" + iNumLinha;
    var var_deduct_assurance_ = scAjaxGetFieldText(nomeCampo_deduct_assurance_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_deduct_assurance_(var_deduct_assurance_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_deduct_assurance__cb);
  } // do_ajax_form_assurance_deduction_validate_deduct_assurance_

  function do_ajax_form_assurance_deduction_validate_deduct_assurance__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "deduct_assurance_" + iLineNumber;
    }
    else
    {
      sFieldValid = "deduct_assurance_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_deduct_assurance__cb

  // ---------- Validate desc_assurance_
  function do_ajax_form_assurance_deduction_validate_desc_assurance_(iNumLinha)
  {
    var nomeCampo_desc_assurance_ = "desc_assurance_" + iNumLinha;
    var var_desc_assurance_ = scAjaxGetFieldText(nomeCampo_desc_assurance_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_desc_assurance_(var_desc_assurance_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_desc_assurance__cb);
  } // do_ajax_form_assurance_deduction_validate_desc_assurance_

  function do_ajax_form_assurance_deduction_validate_desc_assurance__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "desc_assurance_" + iLineNumber;
    }
    else
    {
      sFieldValid = "desc_assurance_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_desc_assurance__cb

  // ---------- Validate select_assurance_
  function do_ajax_form_assurance_deduction_validate_select_assurance_(iNumLinha)
  {
    var nomeCampo_select_assurance_ = "select_assurance_" + iNumLinha;
    var var_select_assurance_ = scAjaxGetFieldSelect(nomeCampo_select_assurance_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_validate_select_assurance_(var_select_assurance_, iNumLinha, var_script_case_init, do_ajax_form_assurance_deduction_validate_select_assurance__cb);
  } // do_ajax_form_assurance_deduction_validate_select_assurance_

  function do_ajax_form_assurance_deduction_validate_select_assurance__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "select_assurance_" + iLineNumber;
    }
    else
    {
      sFieldValid = "select_assurance_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_assurance_deduction_validate_select_assurance__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_assurance_deduction_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_assurance_deduction_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_assurance_deduction_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_assurance_deduction_add_new_line_cb);
  } // do_ajax_form_assurance_deduction_add_new_line

  function do_ajax_form_assurance_deduction_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_assurance_deduction_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_assurance_deduction_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_assurance_deduction_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_assurance_deduction_backup_line_cb);
  } // do_ajax_form_assurance_deduction_backup_line

  function do_ajax_form_assurance_deduction_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_assurance_deduction_backup_line_cb

  function do_ajax_form_assurance_deduction_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_assurance_deduction_cancel_insert

  function do_ajax_form_assurance_deduction_cancel_update(iSeqVert)
  {
    do_ajax_form_assurance_deduction_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_assurance_deduction_cancel_update

  function do_ajax_form_assurance_deduction_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_assurance_deduction_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_assurance_deduction_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_assurance_deduction_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_assurance_deduction_table_refresh_cb);
  } //  do_ajax_form_assurance_deduction_table_refresh

  function do_ajax_form_assurance_deduction_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_assurance_deduction_table_refresh_cb_after_alert);
  } // do_ajax_form_assurance_deduction_table_refresh_cb
  function do_ajax_form_assurance_deduction_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_assurance_deduction_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_assurance_deduction_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_assurance_deduction_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_userid_int_ = scAjaxGetFieldText("userid_int_" + iNumLinha);
    var var_employee_name_ = scAjaxGetFieldText("employee_name_" + iNumLinha);
    var var_dept_ = scAjaxGetFieldText("dept_" + iNumLinha);
    var var_deduct_assurance_ = scAjaxGetFieldText("deduct_assurance_" + iNumLinha);
    var var_desc_assurance_ = scAjaxGetFieldText("desc_assurance_" + iNumLinha);
    var var_select_assurance_ = scAjaxGetFieldSelect("select_assurance_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_assurance_deduction_submit_form(var_userid_int_, var_employee_name_, var_dept_, var_deduct_assurance_, var_desc_assurance_, var_select_assurance_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_assurance_deduction_submit_form_cb);
  } // do_ajax_form_assurance_deduction_submit_form

  function do_ajax_form_assurance_deduction_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_assurance_deduction_submit_form_cb_after_alert);
  } // do_ajax_form_assurance_deduction_submit_form_cb
  function do_ajax_form_assurance_deduction_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_assurance_deduction_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_assurance_deduction_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_assurance_deduction_navigate_form, function() {});
    } else {
      perform_ajax_form_assurance_deduction_navigate_form();
    }
  }

  function perform_ajax_form_assurance_deduction_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_assurance_deduction_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_assurance_deduction_navigate_form_cb);
  } // do_ajax_form_assurance_deduction_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_assurance_deduction']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_assurance_deduction_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_assurance_deduction_navigate_form_cb_after_alert);
  } // do_ajax_form_assurance_deduction_navigate_form_cb
  function do_ajax_form_assurance_deduction_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_assurance_deduction_navigate_form_cb_after_alert

    function sc_form_assurance_deduction_get_last_line_number()
    {
    ...
    } //sc_form_assurance_deduction_get_last_line_number

  function sc_hide_form_assurance_deduction_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "deduct_assurance_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_assurance_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "select_assurance_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["userid_int_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["employee_name_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_username'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["dept_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_departement'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["deduct_assurance_" + iNumLinha] = {"label": "Assurance<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["desc_assurance_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_description'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["select_assurance_" + iNumLinha] = {"label": "Compagnie<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["deduct_assurance_"][iNumLinha] = "deduct_assurance_" + iNumLinha;
    ajax_field_mult["desc_assurance_"][iNumLinha] = "desc_assurance_" + iNumLinha;
    ajax_field_mult["select_assurance_"][iNumLinha] = "select_assurance_" + iNumLinha;
    ...
    ajax_field_id["deduct_assurance_" + iNumLinha] = new Array("hidden_field_label_deduct_assurance_", "hidden_field_data_deduct_assurance_" + iNumLinha);
    ajax_field_id["desc_assurance_" + iNumLinha] = new Array("hidden_field_label_desc_assurance_", "hidden_field_data_desc_assurance_" + iNumLinha);
    ajax_field_id["select_assurance_" + iNumLinha] = new Array("hidden_field_label_select_assurance_", "hidden_field_data_select_assurance_" + iNumLinha);
    ...
    ajax_error_count["deduct_assurance_" + iNumLinha] = "off";
    ajax_error_count["desc_assurance_" + iNumLinha] = "off";
    ajax_error_count["select_assurance_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["deduct_assurance_" + iNumLinha] = "off";
    ajax_read_only["desc_assurance_" + iNumLinha] = "off";
    ajax_read_only["select_assurance_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["employee_name_" + iNumLinha] = "on";
    ajax_read_only["dept_" + iNumLinha] = "on";
    ajax_read_only["deduct_assurance_" + iNumLinha] = "on";
    ajax_read_only["desc_assurance_" + iNumLinha] = "on";
    ajax_read_only["select_assurance_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["deduct_assurance_" + iNumLinha] = null;
    ajax_error_list["desc_assurance_" + iNumLinha] = null;
    ajax_error_list["select_assurance_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "deduct_assurance_": new Array(),
    "desc_assurance_": new Array(),
    "select_assurance_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["deduct_assurance_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["deduct_assurance_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["deduct_assurance_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["deduct_assurance_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["deduct_assurance_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["desc_assurance_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["desc_assurance_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["desc_assurance_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["desc_assurance_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["desc_assurance_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["select_assurance_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["select_assurance_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["select_assurance_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["select_assurance_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["select_assurance_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['userid_int_'])) ? $this->nmgp_cmp_readonly['userid_int_'] : 'on';
?>
    scAjaxFieldRead("userid_int_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['employee_name_'])) ? $this->nmgp_cmp_readonly['employee_name_'] : 'on';
?>
    scAjaxFieldRead("employee_name_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dept_'])) ? $this->nmgp_cmp_readonly['dept_'] : 'on';
?>
    scAjaxFieldRead("dept_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['deduct_assurance_'])) ? $this->nmgp_cmp_readonly['deduct_assurance_'] : 'off';
?>
    scAjaxFieldRead("deduct_assurance_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['desc_assurance_'])) ? $this->nmgp_cmp_readonly['desc_assurance_'] : 'off';
?>
    scAjaxFieldRead("desc_assurance_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['select_assurance_'])) ? $this->nmgp_cmp_readonly['select_assurance_'] : 'off';
?>
    scAjaxFieldRead("select_assurance_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("deduct_assurance_" + iSeq, "on");
    scAjaxFieldRead("desc_assurance_" + iSeq, "on");
    scAjaxFieldRead("select_assurance_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["deduct_assurance_" + iRow] || "on" == ajax_error_count["desc_assurance_" + iRow] || "on" == ajax_error_count["select_assurance_" + iRow]))
    {
      ...
      $("#hidden_field_data_deduct_assurance_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_desc_assurance_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_select_assurance_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["deduct_assurance_" + iRow] && "off" == ajax_error_count["desc_assurance_" + iRow] && "off" == ajax_error_count["select_assurance_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["deduct_assurance_" + iRow] = "off";
        ajax_error_count["desc_assurance_" + iRow] = "off";
        ajax_error_count["select_assurance_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_deduct_assurance_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_desc_assurance_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_select_assurance_" + iRow).removeClass("scFormErrorLine");
    }
  }
