<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_FicheEmployee']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_FicheEmployee_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_FicheEmployee_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["userid_int"] : "ID";
   $tab_ger_campos['employee_name'] = "on";
   $tab_def_campos['employee_name'] = "employee_name";
   $tab_labels["employee_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["employee_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["employee_name"] : "" . $this->Nm_lang['lang_username'] . "";
   $tab_ger_campos['designation'] = "on";
   $tab_def_campos['designation'] = "designation";
   $tab_labels["designation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["designation"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["designation"] : "" . $this->Nm_lang['lang_designation'] . "";
   $tab_ger_campos['dept'] = "on";
   $tab_def_campos['dept'] = "dept";
   $tab_labels["dept"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["dept"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["dept"] : "" . $this->Nm_lang['lang_departement'] . "";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "Phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["phone"] : "" . $this->Nm_lang['lang_phone'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "Email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["email"] : "Email";
   $tab_ger_campos['gender'] = "on";
   $tab_def_campos['gender'] = "Gender";
   $tab_labels["gender"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["gender"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["gender"] : "" . $this->Nm_lang['lang_gender'] . "";
   $tab_ger_campos['hiredate'] = "on";
   $tab_def_campos['hiredate'] = "hiredate";
   $tab_labels["hiredate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["hiredate"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["hiredate"] : "" . $this->Nm_lang['lang_hiredate'] . "";
   $tab_ger_campos['rate_fixed'] = "on";
   $tab_def_campos['rate_fixed'] = "rate_fixed";
   $tab_labels["rate_fixed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["rate_fixed"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["rate_fixed"] : "" . $this->Nm_lang['lang_rate_fixed'] . "";
   $tab_ger_campos['revenu_net'] = "on";
   $tab_def_campos['revenu_net'] = "revenu_net";
   $tab_labels["revenu_net"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["revenu_net"])) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['labels']["revenu_net"] : "" . $this->Nm_lang['lang_revenu_net'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_active_employee_list'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_FicheEmployee_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_FicheEmployee']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
