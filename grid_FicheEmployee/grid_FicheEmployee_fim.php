...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_FicheEmployee"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_FicheEmployee"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_FicheEmployee02'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_FicheEmployee</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FicheEmployee']['embutida_filho'] as $ind => $sc_init)
          {
