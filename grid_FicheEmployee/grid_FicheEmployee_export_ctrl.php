<?php
@session_start() ;
$_SESSION['scriptcase']['grid_FicheEmployee']['sc_process_barr'] = true;
require_once('../grid_FicheEmployee/index.php');
unset($_SESSION['scriptcase']['grid_FicheEmployee']['sc_process_barr']);
$ExportCtrl = new grid_FicheEmployee_export_control;
$ExportCtrl->Export_barr();

class grid_FicheEmployee_export_control
{
