...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cass"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cass"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_deduction_cass</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_deduction_cass']['embutida_filho'] as $ind => $sc_init)
          {
