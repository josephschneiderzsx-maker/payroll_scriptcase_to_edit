<?php
class pdf_boni_allpayslip_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdf_boni_allpayslip']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_select']['dept'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_select']['userid_int'] = 'asc'; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_ant']  = "dept,userid_int"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['userid_int'] = "Userid Int";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['hiredate'] = "Hiredate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['username'] = "Username";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['designation'] = "Designation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['dept'] = "Dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['bank_number'] = "Bank Number";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['pay_startdate'] = "Pay Startdate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['pay_enddate'] = "Pay Enddate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['boni_value'] = "Boni Value";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['tax_iric'] = "Tax Iric";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['boni_net'] = "Boni Net";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_payperiod'] = "lbl_PayPeriod";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_amount01'] = "lbl_amount01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_amount02'] = "lbl_amount02";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_companyname'] = "lbl_companyname";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_deductions'] = "lbl_deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_dept'] = "lbl_dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_designation'] = "lbl_designation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_earning'] = "lbl_earning";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_employeename'] = "lbl_employeename";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_fixedsalary'] = "lbl_fixedsalary";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_hiredate'] = "lbl_hiredate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_id'] = "lbl_id";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_incentive'] = "lbl_incentive";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_line01'] = "lbl_line01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_otvalue'] = "lbl_otvalue";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_payslip'] = "lbl_payslip";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['labels']['lbl_rappel'] = "lbl_rappel";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_boni_allpayslip']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['qt_col_grid']) 
      {  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_allpayslip']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          $this->nm_gera_mask($this->lbl_payslip[$this->nm_grid_colunas], "BONI PAYSLIP"); 
          ...
          $this->lbl_rappel[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->lbl_rappel[$this->nm_grid_colunas]);
            ...
            $cell_lbl_designation = array('posx' => '85', 'posy' => '24.50', 'data' => $this->lbl_designation[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cellpaystartdate = array('posx' => '40', 'posy' => '30.50', 'data' => $this->pay_startdate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
