<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_boni_allpayslip']['sc_process_barr'] = true;
require_once('../pdf_boni_allpayslip/index.php');
unset($_SESSION['scriptcase']['pdf_boni_allpayslip']['sc_process_barr']);
$ExportCtrl = new pdf_boni_allpayslip_export_control;
$ExportCtrl->Export_barr();

class pdf_boni_allpayslip_export_control
{
