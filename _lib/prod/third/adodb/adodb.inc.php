	...
	*/
    ...
    function startSSH($arr_ssh)
    {
        if(!empty($arr_ssh))
        {
            ...
            $str_unset_ld_library = (isset($_SERVER['NM_SC_SYS_CONFIG']) && $_SERVER['NM_SC_SYS_CONFIG']== 1 ? "unset LD_LIBRARY_PATH && " : '');
    ...
    function killSSH($arr_ssh)
    {
        if(!empty($arr_ssh))
        {
            ...
            $str_unset_ld_library = (isset($_SERVER['NM_SC_SYS_CONFIG']) && $_SERVER['NM_SC_SYS_CONFIG']== 1 ? "unset LD_LIBRARY_PATH && " : '');
            $str_command = $str_unset_ld_library.'ps aux | grep "' . trim(str_replace(' > /dev/null','',$this->getSSHCommand($arr_ssh))).'"'.
