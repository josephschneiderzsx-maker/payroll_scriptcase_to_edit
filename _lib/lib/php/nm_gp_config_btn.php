                        ...
                        $addAttr = '')
{
    ...
    */
    ...
    if ('' != $AltJ)
    {
        ...
        elseif(empty($sClick) && ('button' == $arr_buttons[$sBtn]['type'] || ($sClassJ=='thickbox' && strpos($AltJ, 'javascript')!==true)))
        {
    ...
    if ('' == $sStyle)
    {
        $dataElementDisplay = ' data-element-display="inline-block"';
    ...
    {
        $sCodigo .= "<a ". $sHref . $sTarget . $sAlt . $sId . $sClick . $sKey . $sClassB . $sHint . $sStyle . $dataElementDisplay . $sonMouseOver . $sonMouseOut .  $sonMouseDown .  $sonMouseUp . $sAddAttrs . ">";
    ...
    elseif ('image' == $arr_buttons[$sBtn]['type'])
    {
        ...
        $sCodigo .= "<a " . $sId . $sKey . $sClassB . $sTarget . $sBorder. $sHref. $sHint . $sStyle . $dataElementDisplay . $sAlign . $sClassI . $sClick . "><img " . $sIdImg . " src=\"" . $spath . "/" . $sSrc . "\" style=\"border-width: 0; cursor: pointer\" /></a>\r\n";
    }
    elseif ('fontawesomeicon' == $arr_buttons[$sBtn]['type'])
    {
        $sCodigo .= "<a " . $sId . $sKey . $sTarget . $sBorder. $sHref. $sHint . $sStyle . $dataElementDisplay . $sAlign . $sClassI . $sClick . "><i class=' icon_fa". $arr_buttons[$sBtn]['fontawesomeicon'] ."'></i></a>\r\n";
    }
    else
    {
        ...
        $sCodigo .= "<a" . $sId . $sHref . $sTarget . $sClassL . $sHint . $sStyle . $dataElementDisplay . $sClick . ">" . '<span class="btn-label">' . $sValue . '</span>' . "</a>\r\n";
    }
