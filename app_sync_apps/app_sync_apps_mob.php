...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_PAYROLL_STANCO02'])) {
                $_SESSION['scriptcase']['app_sync_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_PAYROLL_STANCO02'];
            }
        }
    }
