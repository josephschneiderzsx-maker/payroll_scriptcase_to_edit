...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_workday"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_workday"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_workday']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_income_workday']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_workday']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_income_workday']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_income_workday']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_income_workday</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_income_workday']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_income_workday']['embutida_filho'] as $ind => $sc_init)
          {
