<?php
@session_start() ;
$_SESSION['scriptcase']['grid_income_workday']['sc_process_barr'] = true;
require_once('../grid_income_workday/index.php');
unset($_SESSION['scriptcase']['grid_income_workday']['sc_process_barr']);
$ExportCtrl = new grid_income_workday_export_control;
$ExportCtrl->Export_barr();

class grid_income_workday_export_control
{
