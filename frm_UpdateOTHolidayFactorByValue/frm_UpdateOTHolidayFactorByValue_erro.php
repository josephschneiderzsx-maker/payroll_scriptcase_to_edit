...
$old_error_handler = set_error_handler("frm_UpdateOTHolidayFactorByValue_scriptcase_error_handler");

function frm_UpdateOTHolidayFactorByValue_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frm_UpdateOTHolidayFactorByValue']['contr_erro']) && $_SESSION['scriptcase']['frm_UpdateOTHolidayFactorByValue']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frm_UpdateOTHolidayFactorByValue->contr_frm_UpdateOTHolidayFactorByValue->Apl_com_erro = true;
            if ($inicial_frm_UpdateOTHolidayFactorByValue->contr_frm_UpdateOTHolidayFactorByValue->NM_ajax_flag)
            {
                $inicial_frm_UpdateOTHolidayFactorByValue->contr_frm_UpdateOTHolidayFactorByValue->NM_ajax_info['errList']['geral_frm_UpdateOTHolidayFactorByValue'][] = $msg;
                return;
            }
            frm_UpdateOTHolidayFactorByValue_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frm_UpdateOTHolidayFactorByValue_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByValue'])  && '' != $_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByValue'])  ? $_SESSION['scriptcase']['error_icon']['frm_UpdateOTHolidayFactorByValue']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByValue']) && '' != $_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByValue']) ? $_SESSION['scriptcase']['error_span_title']['frm_UpdateOTHolidayFactorByValue'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByValue']) && '' != $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByValue']) ? $_SESSION['scriptcase']['error_icon_title']['frm_UpdateOTHolidayFactorByValue'] : '';
?>
