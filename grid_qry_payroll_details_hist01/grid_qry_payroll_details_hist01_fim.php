...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_payroll_details_hist01"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_payroll_details_hist01"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_qry_payroll_details_hist01</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_details_hist01']['embutida_filho'] as $ind => $sc_init)
          {
