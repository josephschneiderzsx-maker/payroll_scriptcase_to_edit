...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_payroll_electronic"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_payroll_electronic"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_qry_payroll_electronic</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_qry_payroll_electronic']['embutida_filho'] as $ind => $sc_init)
          {
