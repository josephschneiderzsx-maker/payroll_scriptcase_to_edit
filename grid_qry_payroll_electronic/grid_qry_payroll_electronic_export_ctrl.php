<?php
@session_start() ;
$_SESSION['scriptcase']['grid_qry_payroll_electronic']['sc_process_barr'] = true;
require_once('../grid_qry_payroll_electronic/index.php');
unset($_SESSION['scriptcase']['grid_qry_payroll_electronic']['sc_process_barr']);
$ExportCtrl = new grid_qry_payroll_electronic_export_control;
$ExportCtrl->Export_barr();

class grid_qry_payroll_electronic_export_control
{
