...
class grid_reg_gross_income_Hist02_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_reg_gross_income_Hist02/grid_reg_gross_income_Hist02_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_reg_gross_income_Hist02_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_reg_gross_income_Hist02.zip";
          $this->Arquivo   .= "_grid_reg_gross_income_Hist02" . $this->Xls_tp;
          $this->Tit_doc    = "grid_reg_gross_income_Hist02" . $this->Xls_tp;
          $this->Tit_zip    = "grid_reg_gross_income_Hist02.zip";
      ...
      {
          $this->sum_income_workday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][2];
          $this->sum_income_holiday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][3];
          $this->sum_income_restday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][4];
          $this->sum_income_offday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][5];
          $this->sum_sal_sunday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][6];
          $this->sum_sal_holiday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][7];
          $this->sum_sal_leavetype = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][8];
          $this->sum_sal_brut_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][9];
          $this->sum_income_workday_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][10];
          $this->sum_income_holiday_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][11];
          $this->sum_income_restday_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][12];
          $this->sum_income_offday_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][13];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          $this->sum_income_workday = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][2];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['nolabel'])
       {
 ...
 function quebra_dept_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_dept_sc_free_group_by_bot()
   {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['income_workday'][$Tipo_Sum]) && $Cada_cmp == "income_workday" && (!isset($this->NM_cmp_hidden['income_workday']) || $this->NM_cmp_hidden['income_workday'] != "off"))
           {
           ...
           elseif (isset($NM_cmp_tot['sal_brut_reg'][$Tipo_Sum]) && $Cada_cmp == "sal_brut_reg" && (!isset($this->NM_cmp_hidden['sal_brut_reg']) || $this->NM_cmp_hidden['sal_brut_reg'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['income_workday'][$Tipo_Sum]) && $Cada_cmp == "income_workday" && (!isset($this->NM_cmp_hidden['income_workday']) || $this->NM_cmp_hidden['income_workday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['income_workday'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['income_holiday'][$Tipo_Sum]) && $Cada_cmp == "income_holiday" && (!isset($this->NM_cmp_hidden['income_holiday']) || $this->NM_cmp_hidden['income_holiday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['income_holiday'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['income_restday'][$Tipo_Sum]) && $Cada_cmp == "income_restday" && (!isset($this->NM_cmp_hidden['income_restday']) || $this->NM_cmp_hidden['income_restday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['income_restday'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['income_offday'][$Tipo_Sum]) && $Cada_cmp == "income_offday" && (!isset($this->NM_cmp_hidden['income_offday']) || $this->NM_cmp_hidden['income_offday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['income_offday'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['sal_sunday'][$Tipo_Sum]) && $Cada_cmp == "sal_sunday" && (!isset($this->NM_cmp_hidden['sal_sunday']) || $this->NM_cmp_hidden['sal_sunday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['sal_sunday'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['sal_holiday'][$Tipo_Sum]) && $Cada_cmp == "sal_holiday" && (!isset($this->NM_cmp_hidden['sal_holiday']) || $this->NM_cmp_hidden['sal_holiday'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['sal_holiday'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['sal_leavetype'][$Tipo_Sum]) && $Cada_cmp == "sal_leavetype" && (!isset($this->NM_cmp_hidden['sal_leavetype']) || $this->NM_cmp_hidden['sal_leavetype'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['sal_leavetype'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['sal_brut_reg'][$Tipo_Sum]) && $Cada_cmp == "sal_brut_reg" && (!isset($this->NM_cmp_hidden['sal_brut_reg']) || $this->NM_cmp_hidden['sal_brut_reg'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['tot_geral'][$NM_cmp_tot['sal_brut_reg'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>REGULAR GROSS INCOME HISTORIZED :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reg_gross_income_Hist02']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
