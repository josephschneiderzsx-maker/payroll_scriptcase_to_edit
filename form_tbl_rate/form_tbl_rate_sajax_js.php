  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_rate" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_tbl_rate_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_userid_int__cb);
  } // do_ajax_form_tbl_rate_validate_userid_int_

  function do_ajax_form_tbl_rate_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_form_tbl_rate_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_employee_name__cb);
  } // do_ajax_form_tbl_rate_validate_employee_name_

  function do_ajax_form_tbl_rate_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_employee_name__cb

  // ---------- Validate designation_
  function do_ajax_form_tbl_rate_validate_designation_(iNumLinha)
  {
    var nomeCampo_designation_ = "designation_" + iNumLinha;
    var var_designation_ = scAjaxGetFieldHidden(nomeCampo_designation_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_designation_(var_designation_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_designation__cb);
  } // do_ajax_form_tbl_rate_validate_designation_

  function do_ajax_form_tbl_rate_validate_designation__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_designation__cb

  // ---------- Validate dept_
  function do_ajax_form_tbl_rate_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_dept__cb);
  } // do_ajax_form_tbl_rate_validate_dept_

  function do_ajax_form_tbl_rate_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_dept__cb

  // ---------- Validate hiredate_
  function do_ajax_form_tbl_rate_validate_hiredate_(iNumLinha)
  {
    var nomeCampo_hiredate_ = "hiredate_" + iNumLinha;
    var var_hiredate_ = scAjaxGetFieldHidden(nomeCampo_hiredate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_hiredate_(var_hiredate_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_hiredate__cb);
  } // do_ajax_form_tbl_rate_validate_hiredate_

  function do_ajax_form_tbl_rate_validate_hiredate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_hiredate__cb

  // ---------- Validate rate_fixed_
  function do_ajax_form_tbl_rate_validate_rate_fixed_(iNumLinha)
  {
    var nomeCampo_rate_fixed_ = "rate_fixed_" + iNumLinha;
    var var_rate_fixed_ = scAjaxGetFieldText(nomeCampo_rate_fixed_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_rate_fixed_(var_rate_fixed_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_rate_fixed__cb);
  } // do_ajax_form_tbl_rate_validate_rate_fixed_

  function do_ajax_form_tbl_rate_validate_rate_fixed__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_fixed_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_fixed_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_fixed_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_fixed_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_rate_fixed__cb

  // ---------- Validate rate_work_
  function do_ajax_form_tbl_rate_validate_rate_work_(iNumLinha)
  {
    var nomeCampo_rate_work_ = "rate_work_" + iNumLinha;
    var var_rate_work_ = scAjaxGetFieldText(nomeCampo_rate_work_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_rate_work_(var_rate_work_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_rate_work__cb);
  } // do_ajax_form_tbl_rate_validate_rate_work_

  function do_ajax_form_tbl_rate_validate_rate_work__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_work_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_work_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_work_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_work_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_rate_work__cb

  // ---------- Validate bank_number_
  function do_ajax_form_tbl_rate_validate_bank_number_(iNumLinha)
  {
    var nomeCampo_bank_number_ = "bank_number_" + iNumLinha;
    var var_bank_number_ = scAjaxGetFieldText(nomeCampo_bank_number_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_validate_bank_number_(var_bank_number_, iNumLinha, var_script_case_init, do_ajax_form_tbl_rate_validate_bank_number__cb);
  } // do_ajax_form_tbl_rate_validate_bank_number_

  function do_ajax_form_tbl_rate_validate_bank_number__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "bank_number_" + iLineNumber;
    }
    else
    {
      sFieldValid = "bank_number_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "bank_number_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "bank_number_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_rate_validate_bank_number__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbl_rate_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbl_rate_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbl_rate_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbl_rate_add_new_line_cb);
  } // do_ajax_form_tbl_rate_add_new_line

  function do_ajax_form_tbl_rate_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbl_rate_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbl_rate_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_rate_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbl_rate_backup_line_cb);
  } // do_ajax_form_tbl_rate_backup_line

  function do_ajax_form_tbl_rate_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbl_rate_backup_line_cb

  function do_ajax_form_tbl_rate_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbl_rate_cancel_insert

  function do_ajax_form_tbl_rate_cancel_update(iSeqVert)
  {
    do_ajax_form_tbl_rate_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbl_rate_cancel_update

  function do_ajax_form_tbl_rate_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbl_rate_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbl_rate_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_rate_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_rate_table_refresh_cb);
  } //  do_ajax_form_tbl_rate_table_refresh

  function do_ajax_form_tbl_rate_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbl_rate_table_refresh_cb_after_alert);
  } // do_ajax_form_tbl_rate_table_refresh_cb
  function do_ajax_form_tbl_rate_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbl_rate_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbl_rate_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbl_rate_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_rate_fixed_ = scAjaxGetFieldText("rate_fixed_" + iNumLinha);
    var var_rate_work_ = scAjaxGetFieldText("rate_work_" + iNumLinha);
    var var_bank_number_ = scAjaxGetFieldText("bank_number_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbl_rate_submit_form(var_userid_int_, var_employee_name_, var_designation_, var_dept_, var_hiredate_, var_rate_fixed_, var_rate_work_, var_bank_number_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_rate_submit_form_cb);
  } // do_ajax_form_tbl_rate_submit_form

  function do_ajax_form_tbl_rate_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("rate_fixed_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_work_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("bank_number_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbl_rate_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_rate_submit_form_cb
  function do_ajax_form_tbl_rate_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_rate_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_rate_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tbl_rate_navigate_form, function() {});
    } else {
      perform_ajax_form_tbl_rate_navigate_form();
    }
  }

  function perform_ajax_form_tbl_rate_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("rate_fixed_" + iNavForm);
      scAjaxHideErrorDisplay("rate_work_" + iNavForm);
      scAjaxHideErrorDisplay("bank_number_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_rate_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_rate_navigate_form_cb);
  } // do_ajax_form_tbl_rate_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_rate']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_rate_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_rate_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_rate_navigate_form_cb
  function do_ajax_form_tbl_rate_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbl_rate_navigate_form_cb_after_alert

    function sc_form_tbl_rate_get_last_line_number()
    {
    ...
    } //sc_form_tbl_rate_get_last_line_number

  function sc_hide_form_tbl_rate_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_fixed_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_work_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "bank_number_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["rate_fixed_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_rate_fixed'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_work_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pay_rate'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["bank_number_" + iNumLinha] = {"label": "Bank Number<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["rate_fixed_"][iNumLinha] = "rate_fixed_" + iNumLinha;
    ajax_field_mult["rate_work_"][iNumLinha] = "rate_work_" + iNumLinha;
    ajax_field_mult["bank_number_"][iNumLinha] = "bank_number_" + iNumLinha;
    ...
    ajax_field_id["rate_fixed_" + iNumLinha] = new Array("hidden_field_label_rate_fixed_", "hidden_field_data_rate_fixed_" + iNumLinha);
    ajax_field_id["rate_work_" + iNumLinha] = new Array("hidden_field_label_rate_work_", "hidden_field_data_rate_work_" + iNumLinha);
    ajax_field_id["bank_number_" + iNumLinha] = new Array("hidden_field_label_bank_number_", "hidden_field_data_bank_number_" + iNumLinha);
    ...
    ajax_error_count["rate_fixed_" + iNumLinha] = "off";
    ajax_error_count["rate_work_" + iNumLinha] = "off";
    ajax_error_count["bank_number_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["rate_fixed_" + iNumLinha] = "off";
    ajax_read_only["rate_work_" + iNumLinha] = "off";
    ajax_read_only["bank_number_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["rate_fixed_" + iNumLinha] = "on";
    ajax_read_only["rate_work_" + iNumLinha] = "on";
    ajax_read_only["bank_number_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["rate_fixed_" + iNumLinha] = null;
    ajax_error_list["rate_work_" + iNumLinha] = null;
    ajax_error_list["bank_number_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "hiredate_": new Array(),
    "rate_fixed_": new Array(),
    "rate_work_": new Array(),
    "bank_number_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["rate_fixed_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_fixed_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_fixed_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_fixed_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_fixed_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_work_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_work_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_work_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_work_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_work_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["bank_number_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["bank_number_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["bank_number_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["bank_number_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["bank_number_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_fixed_'])) ? $this->nmgp_cmp_readonly['rate_fixed_'] : 'off';
?>
    scAjaxFieldRead("rate_fixed_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_work_'])) ? $this->nmgp_cmp_readonly['rate_work_'] : 'off';
?>
    scAjaxFieldRead("rate_work_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['bank_number_'])) ? $this->nmgp_cmp_readonly['bank_number_'] : 'off';
?>
    scAjaxFieldRead("bank_number_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("rate_fixed_" + iSeq, "on");
    scAjaxFieldRead("rate_work_" + iSeq, "on");
    scAjaxFieldRead("bank_number_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["designation_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["hiredate_" + iRow] || "on" == ajax_error_count["rate_fixed_" + iRow] || "on" == ajax_error_count["rate_work_" + iRow] || "on" == ajax_error_count["bank_number_" + iRow]))
    {
      ...
      $("#hidden_field_data_rate_fixed_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_work_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_bank_number_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["designation_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["hiredate_" + iRow] && "off" == ajax_error_count["rate_fixed_" + iRow] && "off" == ajax_error_count["rate_work_" + iRow] && "off" == ajax_error_count["bank_number_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["rate_fixed_" + iRow] = "off";
        ajax_error_count["rate_work_" + iRow] = "off";
        ajax_error_count["bank_number_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rate_fixed_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_work_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_bank_number_" + iRow).removeClass("scFormErrorLine");
    }
  }
