...
class frm_UpdateProbationByDept_mob_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe=true, $err_usr=false)
   {
      ...
      $this->monta_mensagem();
      return frm_UpdateProbationByDept_mob_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe, $err_usr);
   }
