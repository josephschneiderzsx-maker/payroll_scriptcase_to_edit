<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tax']['sc_process_barr'] = true;
require_once('../grid_tax/index.php');
unset($_SESSION['scriptcase']['grid_tax']['sc_process_barr']);
$ExportCtrl = new grid_tax_export_control;
$ExportCtrl->Export_barr();

class grid_tax_export_control
{
