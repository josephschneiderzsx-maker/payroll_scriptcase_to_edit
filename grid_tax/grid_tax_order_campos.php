...
<?php
   ...
   $Ord_Cmp = new grid_tax_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tax_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["userid_int"] : "Userid Int";
   $tab_ger_campos['employee_name'] = "on";
   $tab_def_campos['employee_name'] = "employee_name";
   $tab_labels["employee_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["employee_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["employee_name"] : "Employee Name";
   $tab_ger_campos['designation'] = "on";
   $tab_def_campos['designation'] = "designation";
   $tab_labels["designation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["designation"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["designation"] : "Designation";
   $tab_ger_campos['dept'] = "on";
   $tab_def_campos['dept'] = "dept";
   $tab_labels["dept"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["dept"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["dept"] : "Dept";
   $tab_ger_campos['rate_ona'] = "on";
   $tab_def_campos['rate_ona'] = "rate_ona";
   $tab_labels["rate_ona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_ona"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_ona"] : "Rate Ona";
   $tab_ger_campos['rate_iris'] = "on";
   $tab_def_campos['rate_iris'] = "rate_iris";
   $tab_labels["rate_iris"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_iris"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_iris"] : "Rate Iris";
   $tab_ger_campos['rate_iric'] = "on";
   $tab_def_campos['rate_iric'] = "rate_iric";
   $tab_labels["rate_iric"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_iric"])) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['labels']["rate_iric"] : "Rate Iric";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tax']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tax']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tax']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
