...
?>
  ...
  function do_ajax_form_meal_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_userid_int__cb);
  } // do_ajax_form_meal_validate_userid_int_

  function do_ajax_form_meal_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_form_meal_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_employee_name__cb);
  } // do_ajax_form_meal_validate_employee_name_

  function do_ajax_form_meal_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_employee_name__cb

  // ---------- Validate designation_
  function do_ajax_form_meal_validate_designation_(iNumLinha)
  {
    var nomeCampo_designation_ = "designation_" + iNumLinha;
    var var_designation_ = scAjaxGetFieldHidden(nomeCampo_designation_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_designation_(var_designation_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_designation__cb);
  } // do_ajax_form_meal_validate_designation_

  function do_ajax_form_meal_validate_designation__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_designation__cb

  // ---------- Validate dept_
  function do_ajax_form_meal_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_dept__cb);
  } // do_ajax_form_meal_validate_dept_

  function do_ajax_form_meal_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_dept__cb

  // ---------- Validate start_date_cons_
  function do_ajax_form_meal_validate_start_date_cons_(iNumLinha)
  {
    var nomeCampo_start_date_cons_ = "start_date_cons_" + iNumLinha;
    var var_start_date_cons_ = scAjaxGetFieldText(nomeCampo_start_date_cons_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_start_date_cons_(var_start_date_cons_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_start_date_cons__cb);
  } // do_ajax_form_meal_validate_start_date_cons_

  function do_ajax_form_meal_validate_start_date_cons__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "start_date_cons_" + iLineNumber;
    }
    else
    {
      sFieldValid = "start_date_cons_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "start_date_cons_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "start_date_cons_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_start_date_cons__cb

  // ---------- Validate end_date_cons_
  function do_ajax_form_meal_validate_end_date_cons_(iNumLinha)
  {
    var nomeCampo_end_date_cons_ = "end_date_cons_" + iNumLinha;
    var var_end_date_cons_ = scAjaxGetFieldText(nomeCampo_end_date_cons_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_end_date_cons_(var_end_date_cons_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_end_date_cons__cb);
  } // do_ajax_form_meal_validate_end_date_cons_

  function do_ajax_form_meal_validate_end_date_cons__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "end_date_cons_" + iLineNumber;
    }
    else
    {
      sFieldValid = "end_date_cons_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "end_date_cons_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "end_date_cons_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_end_date_cons__cb

  // ---------- Validate day_cons_
  function do_ajax_form_meal_validate_day_cons_(iNumLinha)
  {
    var nomeCampo_day_cons_ = "day_cons_" + iNumLinha;
    var var_day_cons_ = scAjaxGetFieldText(nomeCampo_day_cons_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_day_cons_(var_day_cons_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_day_cons__cb);
  } // do_ajax_form_meal_validate_day_cons_

  function do_ajax_form_meal_validate_day_cons__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "day_cons_" + iLineNumber;
    }
    else
    {
      sFieldValid = "day_cons_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "day_cons_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "day_cons_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_day_cons__cb

  // ---------- Validate rate_cons_
  function do_ajax_form_meal_validate_rate_cons_(iNumLinha)
  {
    var nomeCampo_rate_cons_ = "rate_cons_" + iNumLinha;
    var var_rate_cons_ = scAjaxGetFieldText(nomeCampo_rate_cons_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_validate_rate_cons_(var_rate_cons_, iNumLinha, var_script_case_init, do_ajax_form_meal_validate_rate_cons__cb);
  } // do_ajax_form_meal_validate_rate_cons_

  function do_ajax_form_meal_validate_rate_cons__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_cons_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_cons_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_cons_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_cons_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_meal_validate_rate_cons__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_meal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_meal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_meal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_meal_add_new_line_cb);
  } // do_ajax_form_meal_add_new_line

  function do_ajax_form_meal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_meal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_meal_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_meal_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_meal_backup_line_cb);
  } // do_ajax_form_meal_backup_line

  function do_ajax_form_meal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_meal_backup_line_cb

  function do_ajax_form_meal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_meal_cancel_insert

  function do_ajax_form_meal_cancel_update(iSeqVert)
  {
    do_ajax_form_meal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_meal_cancel_update

  function do_ajax_form_meal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_meal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_meal_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_meal_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_meal_table_refresh_cb);
  } //  do_ajax_form_meal_table_refresh

  function do_ajax_form_meal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_meal_table_refresh_cb_after_alert);
  } // do_ajax_form_meal_table_refresh_cb
  function do_ajax_form_meal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_meal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_meal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_meal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_start_date_cons_ = scAjaxGetFieldText("start_date_cons_" + iNumLinha);
    var var_end_date_cons_ = scAjaxGetFieldText("end_date_cons_" + iNumLinha);
    var var_day_cons_ = scAjaxGetFieldText("day_cons_" + iNumLinha);
    var var_rate_cons_ = scAjaxGetFieldText("rate_cons_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_meal_submit_form(var_userid_int_, var_employee_name_, var_designation_, var_dept_, var_start_date_cons_, var_end_date_cons_, var_day_cons_, var_rate_cons_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_meal_submit_form_cb);
  } // do_ajax_form_meal_submit_form

  function do_ajax_form_meal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("start_date_cons_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("end_date_cons_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("day_cons_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_cons_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_meal_submit_form_cb_after_alert);
  } // do_ajax_form_meal_submit_form_cb
  function do_ajax_form_meal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_meal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_meal_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_meal_navigate_form, function() {});
    } else {
      perform_ajax_form_meal_navigate_form();
    }
  }

  function perform_ajax_form_meal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("start_date_cons_" + iNavForm);
      scAjaxHideErrorDisplay("end_date_cons_" + iNavForm);
      scAjaxHideErrorDisplay("day_cons_" + iNavForm);
      scAjaxHideErrorDisplay("rate_cons_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_meal_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_meal_navigate_form_cb);
  } // do_ajax_form_meal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_meal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_meal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_meal_navigate_form_cb_after_alert);
  } // do_ajax_form_meal_navigate_form_cb
  function do_ajax_form_meal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_form_meal_navigate_form_cb_after_alert

    function sc_form_meal_get_last_line_number()
    {
    ...
    } //sc_form_meal_get_last_line_number

  function sc_hide_form_meal_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "start_date_cons_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "end_date_cons_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "day_cons_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_cons_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["start_date_cons_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_start_date'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["end_date_cons_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_end_date'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["day_cons_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_meal'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_cons_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_rate_meal'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["start_date_cons_"][iNumLinha] = "start_date_cons_" + iNumLinha;
    ajax_field_mult["end_date_cons_"][iNumLinha] = "end_date_cons_" + iNumLinha;
    ajax_field_mult["day_cons_"][iNumLinha] = "day_cons_" + iNumLinha;
    ajax_field_mult["rate_cons_"][iNumLinha] = "rate_cons_" + iNumLinha;
    ...
    ajax_field_id["start_date_cons_" + iNumLinha] = new Array("hidden_field_label_start_date_cons_", "hidden_field_data_start_date_cons_" + iNumLinha);
    ajax_field_id["end_date_cons_" + iNumLinha] = new Array("hidden_field_label_end_date_cons_", "hidden_field_data_end_date_cons_" + iNumLinha);
    ajax_field_id["day_cons_" + iNumLinha] = new Array("hidden_field_label_day_cons_", "hidden_field_data_day_cons_" + iNumLinha);
    ajax_field_id["rate_cons_" + iNumLinha] = new Array("hidden_field_label_rate_cons_", "hidden_field_data_rate_cons_" + iNumLinha);
    ...
    ajax_error_count["start_date_cons_" + iNumLinha] = "off";
    ajax_error_count["end_date_cons_" + iNumLinha] = "off";
    ajax_error_count["day_cons_" + iNumLinha] = "off";
    ajax_error_count["rate_cons_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["start_date_cons_" + iNumLinha] = "off";
    ajax_read_only["end_date_cons_" + iNumLinha] = "off";
    ajax_read_only["day_cons_" + iNumLinha] = "off";
    ajax_read_only["rate_cons_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["start_date_cons_" + iNumLinha] = "on";
    ajax_read_only["end_date_cons_" + iNumLinha] = "on";
    ajax_read_only["day_cons_" + iNumLinha] = "on";
    ajax_read_only["rate_cons_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["start_date_cons_" + iNumLinha] = null;
    ajax_error_list["end_date_cons_" + iNumLinha] = null;
    ajax_error_list["day_cons_" + iNumLinha] = null;
    ajax_error_list["rate_cons_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "start_date_cons_": new Array(),
    "end_date_cons_": new Array(),
    "day_cons_": new Array(),
    "rate_cons_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["start_date_cons_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["start_date_cons_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["start_date_cons_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["start_date_cons_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["start_date_cons_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["end_date_cons_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["end_date_cons_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["end_date_cons_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["end_date_cons_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["end_date_cons_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["day_cons_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["day_cons_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["day_cons_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["day_cons_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["day_cons_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_cons_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_cons_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_cons_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_cons_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_cons_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['start_date_cons_'])) ? $this->nmgp_cmp_readonly['start_date_cons_'] : 'off';
?>
    scAjaxFieldRead("start_date_cons_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['end_date_cons_'])) ? $this->nmgp_cmp_readonly['end_date_cons_'] : 'off';
?>
    scAjaxFieldRead("end_date_cons_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['day_cons_'])) ? $this->nmgp_cmp_readonly['day_cons_'] : 'off';
?>
    scAjaxFieldRead("day_cons_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_cons_'])) ? $this->nmgp_cmp_readonly['rate_cons_'] : 'off';
?>
    scAjaxFieldRead("rate_cons_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("start_date_cons_" + iSeq, "on");
    scAjaxFieldRead("end_date_cons_" + iSeq, "on");
    scAjaxFieldRead("day_cons_" + iSeq, "on");
    scAjaxFieldRead("rate_cons_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["designation_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["start_date_cons_" + iRow] || "on" == ajax_error_count["end_date_cons_" + iRow] || "on" == ajax_error_count["day_cons_" + iRow] || "on" == ajax_error_count["rate_cons_" + iRow]))
    {
      ...
      $("#hidden_field_data_start_date_cons_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_end_date_cons_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_day_cons_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_cons_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["designation_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["start_date_cons_" + iRow] && "off" == ajax_error_count["end_date_cons_" + iRow] && "off" == ajax_error_count["day_cons_" + iRow] && "off" == ajax_error_count["rate_cons_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["start_date_cons_" + iRow] = "off";
        ajax_error_count["end_date_cons_" + iRow] = "off";
        ajax_error_count["day_cons_" + iRow] = "off";
        ajax_error_count["rate_cons_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_start_date_cons_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_end_date_cons_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_day_cons_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_cons_" + iRow).removeClass("scFormErrorLine");
    }
  }
