...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_rate"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_rate"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_rate'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_rate']['embutida_filho'] as $ind => $sc_init)
          {
