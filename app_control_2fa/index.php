...
//
   ...
   $_SESSION['scriptcase']['app_control_2fa']['glo_nm_perfil']          = "conn_mysql";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_control_2fa']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_control_2fa']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_control_2fa']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_control_2fa']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8);
    }
    else {
...
if (!isset($this->sc_temp_sett_brute_force_time_block)) {$this->sc_temp_sett_brute_force_time_block = (isset($_SESSION['sett_brute_force_time_block'])) ? $_SESSION['sett_brute_force_time_block'] : "";}
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_app_control_2fa';
