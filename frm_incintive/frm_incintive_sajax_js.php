  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_incintive" == sTestField)
        {
...
?>
  ...
  function do_ajax_frm_incintive_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_userid_int__cb);
  } // do_ajax_frm_incintive_validate_userid_int_

  function do_ajax_frm_incintive_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_frm_incintive_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_employee_name__cb);
  } // do_ajax_frm_incintive_validate_employee_name_

  function do_ajax_frm_incintive_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_employee_name__cb

  // ---------- Validate designation_
  function do_ajax_frm_incintive_validate_designation_(iNumLinha)
  {
    var nomeCampo_designation_ = "designation_" + iNumLinha;
    var var_designation_ = scAjaxGetFieldHidden(nomeCampo_designation_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_designation_(var_designation_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_designation__cb);
  } // do_ajax_frm_incintive_validate_designation_

  function do_ajax_frm_incintive_validate_designation__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_designation__cb

  // ---------- Validate dept_
  function do_ajax_frm_incintive_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_dept__cb);
  } // do_ajax_frm_incintive_validate_dept_

  function do_ajax_frm_incintive_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_dept__cb

  // ---------- Validate incentive_
  function do_ajax_frm_incintive_validate_incentive_(iNumLinha)
  {
    var nomeCampo_incentive_ = "incentive_" + iNumLinha;
    var var_incentive_ = scAjaxGetFieldText(nomeCampo_incentive_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_incentive_(var_incentive_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_incentive__cb);
  } // do_ajax_frm_incintive_validate_incentive_

  function do_ajax_frm_incintive_validate_incentive__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "incentive_" + iLineNumber;
    }
    else
    {
      sFieldValid = "incentive_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "incentive_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "incentive_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_incentive__cb

  // ---------- Validate incentive_desc_
  function do_ajax_frm_incintive_validate_incentive_desc_(iNumLinha)
  {
    var nomeCampo_incentive_desc_ = "incentive_desc_" + iNumLinha;
    var var_incentive_desc_ = scAjaxGetFieldText(nomeCampo_incentive_desc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_validate_incentive_desc_(var_incentive_desc_, iNumLinha, var_script_case_init, do_ajax_frm_incintive_validate_incentive_desc__cb);
  } // do_ajax_frm_incintive_validate_incentive_desc_

  function do_ajax_frm_incintive_validate_incentive_desc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "incentive_desc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "incentive_desc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "incentive_desc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "incentive_desc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_incintive_validate_incentive_desc__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_frm_incintive_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_frm_incintive_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_frm_incintive_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_frm_incintive_add_new_line_cb);
  } // do_ajax_frm_incintive_add_new_line

  function do_ajax_frm_incintive_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_frm_incintive_add_new_line_cb

  // ---------- backup_line
  function do_ajax_frm_incintive_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_incintive_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_frm_incintive_backup_line_cb);
  } // do_ajax_frm_incintive_backup_line

  function do_ajax_frm_incintive_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_frm_incintive_backup_line_cb

  function do_ajax_frm_incintive_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_frm_incintive_cancel_insert

  function do_ajax_frm_incintive_cancel_update(iSeqVert)
  {
    do_ajax_frm_incintive_backup_line(iSeqVert);
...
?>
  } // do_ajax_frm_incintive_cancel_update

  function do_ajax_frm_incintive_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_frm_incintive_restore_buttons

  // ---------- table_refresh
  function do_ajax_frm_incintive_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_frm_incintive_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_incintive_table_refresh_cb);
  } //  do_ajax_frm_incintive_table_refresh

  function do_ajax_frm_incintive_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_frm_incintive_table_refresh_cb_after_alert);
  } // do_ajax_frm_incintive_table_refresh_cb
  function do_ajax_frm_incintive_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_frm_incintive_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_frm_incintive_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_frm_incintive_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_incentive_ = scAjaxGetFieldText("incentive_" + iNumLinha);
    var var_incentive_desc_ = scAjaxGetFieldText("incentive_desc_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_frm_incintive_submit_form(var_userid_int_, var_employee_name_, var_designation_, var_dept_, var_incentive_, var_incentive_desc_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_incintive_submit_form_cb);
  } // do_ajax_frm_incintive_submit_form

  function do_ajax_frm_incintive_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("incentive_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("incentive_desc_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_frm_incintive_submit_form_cb_after_alert);
  } // do_ajax_frm_incintive_submit_form_cb
  function do_ajax_frm_incintive_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_incintive_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_incintive_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_incintive_navigate_form, function() {});
    } else {
      perform_ajax_frm_incintive_navigate_form();
    }
  }

  function perform_ajax_frm_incintive_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("incentive_" + iNavForm);
      scAjaxHideErrorDisplay("incentive_desc_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_frm_incintive_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_incintive_navigate_form_cb);
  } // do_ajax_frm_incintive_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_incintive']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_incintive_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_incintive_navigate_form_cb_after_alert);
  } // do_ajax_frm_incintive_navigate_form_cb
  function do_ajax_frm_incintive_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_frm_incintive_navigate_form_cb_after_alert

    function sc_frm_incintive_get_last_line_number()
    {
    ...
    } //sc_frm_incintive_get_last_line_number

  function sc_hide_frm_incintive_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "incentive_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "incentive_desc_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["incentive_" + iNumLinha] = {"label": "Income Extra<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["incentive_desc_" + iNumLinha] = {"label": "Description<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["incentive_"][iNumLinha] = "incentive_" + iNumLinha;
    ajax_field_mult["incentive_desc_"][iNumLinha] = "incentive_desc_" + iNumLinha;
    ...
    ajax_field_id["incentive_" + iNumLinha] = new Array("hidden_field_label_incentive_", "hidden_field_data_incentive_" + iNumLinha);
    ajax_field_id["incentive_desc_" + iNumLinha] = new Array("hidden_field_label_incentive_desc_", "hidden_field_data_incentive_desc_" + iNumLinha);
    ...
    ajax_error_count["incentive_" + iNumLinha] = "off";
    ajax_error_count["incentive_desc_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["incentive_" + iNumLinha] = "off";
    ajax_read_only["incentive_desc_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["incentive_" + iNumLinha] = "on";
    ajax_read_only["incentive_desc_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["incentive_" + iNumLinha] = null;
    ajax_error_list["incentive_desc_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "incentive_": new Array(),
    "incentive_desc_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["incentive_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["incentive_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["incentive_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["incentive_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["incentive_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["incentive_desc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["incentive_desc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["incentive_desc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["incentive_desc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["incentive_desc_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['incentive_'])) ? $this->nmgp_cmp_readonly['incentive_'] : 'off';
?>
    scAjaxFieldRead("incentive_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['incentive_desc_'])) ? $this->nmgp_cmp_readonly['incentive_desc_'] : 'off';
?>
    scAjaxFieldRead("incentive_desc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("incentive_" + iSeq, "on");
    scAjaxFieldRead("incentive_desc_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["designation_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["incentive_" + iRow] || "on" == ajax_error_count["incentive_desc_" + iRow]))
    {
      ...
      $("#hidden_field_data_incentive_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_incentive_desc_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["designation_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["incentive_" + iRow] && "off" == ajax_error_count["incentive_desc_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["incentive_" + iRow] = "off";
        ajax_error_count["incentive_desc_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_incentive_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_incentive_desc_" + iRow).removeClass("scFormErrorLine");
    }
  }
