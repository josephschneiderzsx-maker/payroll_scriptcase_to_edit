<?php
@session_start() ;
$_SESSION['scriptcase']['grid_deduction_ona_Hist']['sc_process_barr'] = true;
require_once('../grid_deduction_ona_Hist/index.php');
unset($_SESSION['scriptcase']['grid_deduction_ona_Hist']['sc_process_barr']);
$ExportCtrl = new grid_deduction_ona_Hist_export_control;
$ExportCtrl->Export_barr();

class grid_deduction_ona_Hist_export_control
{
