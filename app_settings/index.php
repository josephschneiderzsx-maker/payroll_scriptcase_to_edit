...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_settings']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'PAYROLL_STANCO02', 1, $this->force_db_utf8);
    }
    else {
