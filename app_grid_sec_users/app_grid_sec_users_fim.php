...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____app_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____app_grid_sec_users"]);
   }
