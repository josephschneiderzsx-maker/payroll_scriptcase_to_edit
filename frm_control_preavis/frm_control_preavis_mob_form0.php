...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>frm_control_preavis/frm_control_preavis_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("frm_control_preavis_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('frm_control_preavis_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['frm_control_preavis']['error_buffer']) && '' != $_SESSION['scriptcase']['frm_control_preavis']['error_buffer'])
{
    echo $_SESSION['scriptcase']['frm_control_preavis']['error_buffer'];
}
...
<?php
 include_once("frm_control_preavis_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="frm_control_preavis_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['frm_control_preavis_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['frm_control_preavis_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_employe_id_line" id="hidden_field_data_employe_id" style="<?php echo $sStyleHidden_employe_id; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_employe_id_label" style=""><span id="id_label_employe_id"><?php echo $this->nm_new_label['employe_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_name_line" id="hidden_field_data_name" style="<?php echo $sStyleHidden_name; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_name_label" style=""><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span></span><br><input type="hidden" name="name" value="<?php echo $this->form_encode_input($name); ?>"><span id="id_ajax_label_name"><?php echo nl2br($name); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hire_date_line" id="hidden_field_data_hire_date" style="<?php echo $sStyleHidden_hire_date; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_hire_date_label" style=""><span id="id_label_hire_date"><?php echo $this->nm_new_label['hire_date']; ?></span></span><br><input type="hidden" name="hire_date" value="<?php echo $this->form_encode_input($hire_date); ?>"><span id="id_ajax_label_hire_date"><?php echo nl2br($hire_date); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fire_date_line" id="hidden_field_data_fire_date" style="<?php echo $sStyleHidden_fire_date; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_fire_date_label" style=""><span id="id_label_fire_date"><?php echo $this->nm_new_label['fire_date']; ?></span></span><br><input type="hidden" name="fire_date" value="<?php echo $this->form_encode_input($fire_date); ?>"><span id="id_ajax_label_fire_date"><?php echo nl2br($fire_date); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_net_earnings_line" id="hidden_field_data_net_earnings" style="<?php echo $sStyleHidden_net_earnings; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_net_earnings_label" style=""><span id="id_label_net_earnings"><?php echo $this->nm_new_label['net_earnings']; ?></span></span><br><input type="hidden" name="net_earnings" value="<?php echo $this->form_encode_input($net_earnings); ?>"><span id="id_ajax_label_net_earnings"><?php echo nl2br($net_earnings); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_duration_line" id="hidden_field_data_duration" style="<?php echo $sStyleHidden_duration; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_duration_label" style=""><span id="id_label_duration"><?php echo $this->nm_new_label['duration']; ?></span></span><br><input type="hidden" name="duration" value="<?php echo $this->form_encode_input($duration); ?>"><span id="id_ajax_label_duration"><?php echo nl2br($duration); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_serv_month_line" id="hidden_field_data_serv_month" style="<?php echo $sStyleHidden_serv_month; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_serv_month_label" style=""><span id="id_label_serv_month"><?php echo $this->nm_new_label['serv_month']; ?></span></span><br><input type="hidden" name="serv_month" value="<?php echo $this->form_encode_input($serv_month); ?>"><span id="id_ajax_label_serv_month"><?php echo nl2br($serv_month); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_type_preavis_line" id="hidden_field_data_type_preavis" style="<?php echo $sStyleHidden_type_preavis; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_type_preavis_label" style=""><span id="id_label_type_preavis"><?php echo $this->nm_new_label['type_preavis']; ?></span></span><br><input type="hidden" name="type_preavis" value="<?php echo $this->form_encode_input($type_preavis); ?>"><span id="id_ajax_label_type_preavis"><?php echo nl2br($type_preavis); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_preavis_net_line" id="hidden_field_data_preavis_net" style="<?php echo $sStyleHidden_preavis_net; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_preavis_net_label" style=""><span id="id_label_preavis_net"><?php echo $this->nm_new_label['preavis_net']; ?></span></span><br><input type="hidden" name="preavis_net" value="<?php echo $this->form_encode_input($preavis_net); ?>"><span id="id_ajax_label_preavis_net"><?php echo nl2br($preavis_net); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jours_conges_pris_line" id="hidden_field_data_jours_conges_pris" style="<?php echo $sStyleHidden_jours_conges_pris; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_jours_conges_pris_label" style=""><span id="id_label_jours_conges_pris"><?php echo $this->nm_new_label['jours_conges_pris']; ?></span></span><br><input type="hidden" name="jours_conges_pris" value="<?php echo $this->form_encode_input($jours_conges_pris); ?>"><span id="id_ajax_label_jours_conges_pris"><?php echo nl2br($jours_conges_pris); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jours_conges_acquis_line" id="hidden_field_data_jours_conges_acquis" style="<?php echo $sStyleHidden_jours_conges_acquis; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_jours_conges_acquis_label" style=""><span id="id_label_jours_conges_acquis"><?php echo $this->nm_new_label['jours_conges_acquis']; ?></span></span><br><input type="hidden" name="jours_conges_acquis" value="<?php echo $this->form_encode_input($jours_conges_acquis); ?>"><span id="id_ajax_label_jours_conges_acquis"><?php echo nl2br($jours_conges_acquis); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jours_conges_restant_line" id="hidden_field_data_jours_conges_restant" style="<?php echo $sStyleHidden_jours_conges_restant; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_jours_conges_restant_label" style=""><span id="id_label_jours_conges_restant"><?php echo $this->nm_new_label['jours_conges_restant']; ?></span></span><br><input type="hidden" name="jours_conges_restant" value="<?php echo $this->form_encode_input($jours_conges_restant); ?>"><span id="id_ajax_label_jours_conges_restant"><?php echo nl2br($jours_conges_restant); ?></span>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_montant_conges_line" id="hidden_field_data_montant_conges" style="<?php echo $sStyleHidden_montant_conges; ?>"> <span class="scFormLabelOddFormat scFormLabelAboveOddFormat css_montant_conges_label" style=""><span id="id_label_montant_conges"><?php echo $this->nm_new_label['montant_conges']; ?></span></span><br><input type="hidden" name="montant_conges" value="<?php echo $this->form_encode_input($montant_conges); ?>"><span id="id_ajax_label_montant_conges"><?php echo nl2br($montant_conges); ?></span>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("frm_control_preavis_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("frm_control_preavis_mob");
 parent.scAjaxDetailHeight("frm_control_preavis_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
