...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_hire_date' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_hire_date_onblur('#id_sc_field_hire_date' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_frm_control_preavis_hire_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fire_date' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_fire_date_onblur('#id_sc_field_fire_date' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_frm_control_preavis_fire_date_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_name_onblur('#id_sc_field_name' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_frm_control_preavis_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_net_earnings' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_net_earnings_onblur('#id_sc_field_net_earnings' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_frm_control_preavis_net_earnings_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_duration' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_duration_onblur('#id_sc_field_duration' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_frm_control_preavis_duration_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_serv_month' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_serv_month_onblur('#id_sc_field_serv_month' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_frm_control_preavis_serv_month_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_type_preavis' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_type_preavis_onblur('#id_sc_field_type_preavis' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_frm_control_preavis_type_preavis_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_preavis_net' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_preavis_net_onblur('#id_sc_field_preavis_net' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_frm_control_preavis_preavis_net_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_jours_conges_pris' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_jours_conges_pris_onblur('#id_sc_field_jours_conges_pris' + iSeqRow, iSeqRow) })
                                               .bind('change', function() { sc_frm_control_preavis_jours_conges_pris_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_jours_conges_acquis' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_jours_conges_acquis_onblur('#id_sc_field_jours_conges_acquis' + iSeqRow, iSeqRow) })
                                                 .bind('change', function() { sc_frm_control_preavis_jours_conges_acquis_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_jours_conges_restant' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_jours_conges_restant_onblur('#id_sc_field_jours_conges_restant' + iSeqRow, iSeqRow) })
                                                  .bind('change', function() { sc_frm_control_preavis_jours_conges_restant_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_montant_conges' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_montant_conges_onblur('#id_sc_field_montant_conges' + iSeqRow, iSeqRow) })
                                            .bind('change', function() { sc_frm_control_preavis_montant_conges_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_total_onblur('#id_sc_field_total' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_frm_control_preavis_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_employe_id' + iSeqRow).bind('blur', function() { sc_frm_control_preavis_employe_id_onblur('#id_sc_field_employe_id' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_frm_control_preavis_employe_id_onchange(this, iSeqRow) })
...
function sc_frm_control_preavis_hire_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_fire_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_net_earnings_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_duration_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_serv_month_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_type_preavis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_preavis_net_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_jours_conges_pris_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_jours_conges_acquis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_jours_conges_restant_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_montant_conges_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_frm_control_preavis_employe_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_frm_control_preavis_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'frm_control_preavis')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
