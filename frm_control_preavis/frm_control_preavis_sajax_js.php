  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_control_preavis" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_frm_control_preavis_form();
        }
...
?>
  ...
  // ---------- Validate employe_id
  function do_ajax_frm_control_preavis_validate_employe_id()
  {
    var nomeCampo_employe_id = "employe_id";
    var var_employe_id = scAjaxGetFieldText(nomeCampo_employe_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_employe_id(var_employe_id, var_script_case_init, do_ajax_frm_control_preavis_validate_employe_id_cb);
  } // do_ajax_frm_control_preavis_validate_employe_id

  function do_ajax_frm_control_preavis_validate_employe_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_employe_id_cb

  // ---------- Validate name
  function do_ajax_frm_control_preavis_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldHidden(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_name(var_name, var_script_case_init, do_ajax_frm_control_preavis_validate_name_cb);
  } // do_ajax_frm_control_preavis_validate_name

  function do_ajax_frm_control_preavis_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_name_cb

  // ---------- Validate hire_date
  function do_ajax_frm_control_preavis_validate_hire_date()
  {
    var nomeCampo_hire_date = "hire_date";
    var var_hire_date = scAjaxGetFieldHidden(nomeCampo_hire_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_hire_date(var_hire_date, var_script_case_init, do_ajax_frm_control_preavis_validate_hire_date_cb);
  } // do_ajax_frm_control_preavis_validate_hire_date

  function do_ajax_frm_control_preavis_validate_hire_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_hire_date_cb

  // ---------- Validate fire_date
  function do_ajax_frm_control_preavis_validate_fire_date()
  {
    var nomeCampo_fire_date = "fire_date";
    var var_fire_date = scAjaxGetFieldHidden(nomeCampo_fire_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_fire_date(var_fire_date, var_script_case_init, do_ajax_frm_control_preavis_validate_fire_date_cb);
  } // do_ajax_frm_control_preavis_validate_fire_date

  function do_ajax_frm_control_preavis_validate_fire_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_fire_date_cb

  // ---------- Validate net_earnings
  function do_ajax_frm_control_preavis_validate_net_earnings()
  {
    var nomeCampo_net_earnings = "net_earnings";
    var var_net_earnings = scAjaxGetFieldHidden(nomeCampo_net_earnings);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_net_earnings(var_net_earnings, var_script_case_init, do_ajax_frm_control_preavis_validate_net_earnings_cb);
  } // do_ajax_frm_control_preavis_validate_net_earnings

  function do_ajax_frm_control_preavis_validate_net_earnings_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_net_earnings_cb

  // ---------- Validate duration
  function do_ajax_frm_control_preavis_validate_duration()
  {
    var nomeCampo_duration = "duration";
    var var_duration = scAjaxGetFieldHidden(nomeCampo_duration);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_duration(var_duration, var_script_case_init, do_ajax_frm_control_preavis_validate_duration_cb);
  } // do_ajax_frm_control_preavis_validate_duration

  function do_ajax_frm_control_preavis_validate_duration_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_duration_cb

  // ---------- Validate serv_month
  function do_ajax_frm_control_preavis_validate_serv_month()
  {
    var nomeCampo_serv_month = "serv_month";
    var var_serv_month = scAjaxGetFieldHidden(nomeCampo_serv_month);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_serv_month(var_serv_month, var_script_case_init, do_ajax_frm_control_preavis_validate_serv_month_cb);
  } // do_ajax_frm_control_preavis_validate_serv_month

  function do_ajax_frm_control_preavis_validate_serv_month_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_serv_month_cb

  // ---------- Validate type_preavis
  function do_ajax_frm_control_preavis_validate_type_preavis()
  {
    var nomeCampo_type_preavis = "type_preavis";
    var var_type_preavis = scAjaxGetFieldHidden(nomeCampo_type_preavis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_type_preavis(var_type_preavis, var_script_case_init, do_ajax_frm_control_preavis_validate_type_preavis_cb);
  } // do_ajax_frm_control_preavis_validate_type_preavis

  function do_ajax_frm_control_preavis_validate_type_preavis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_type_preavis_cb

  // ---------- Validate preavis_net
  function do_ajax_frm_control_preavis_validate_preavis_net()
  {
    var nomeCampo_preavis_net = "preavis_net";
    var var_preavis_net = scAjaxGetFieldHidden(nomeCampo_preavis_net);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_preavis_net(var_preavis_net, var_script_case_init, do_ajax_frm_control_preavis_validate_preavis_net_cb);
  } // do_ajax_frm_control_preavis_validate_preavis_net

  function do_ajax_frm_control_preavis_validate_preavis_net_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_preavis_net_cb

  // ---------- Validate jours_conges_pris
  function do_ajax_frm_control_preavis_validate_jours_conges_pris()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_jours_conges_pris(var_jours_conges_pris, var_script_case_init, do_ajax_frm_control_preavis_validate_jours_conges_pris_cb);
  } // do_ajax_frm_control_preavis_validate_jours_conges_pris

  function do_ajax_frm_control_preavis_validate_jours_conges_pris_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_jours_conges_pris_cb

  // ---------- Validate jours_conges_acquis
  function do_ajax_frm_control_preavis_validate_jours_conges_acquis()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_jours_conges_acquis(var_jours_conges_acquis, var_script_case_init, do_ajax_frm_control_preavis_validate_jours_conges_acquis_cb);
  } // do_ajax_frm_control_preavis_validate_jours_conges_acquis

  function do_ajax_frm_control_preavis_validate_jours_conges_acquis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_jours_conges_acquis_cb

  // ---------- Validate jours_conges_restant
  function do_ajax_frm_control_preavis_validate_jours_conges_restant()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_jours_conges_restant(var_jours_conges_restant, var_script_case_init, do_ajax_frm_control_preavis_validate_jours_conges_restant_cb);
  } // do_ajax_frm_control_preavis_validate_jours_conges_restant

  function do_ajax_frm_control_preavis_validate_jours_conges_restant_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_jours_conges_restant_cb

  // ---------- Validate montant_conges
  function do_ajax_frm_control_preavis_validate_montant_conges()
  {
    var nomeCampo_montant_conges = "montant_conges";
    var var_montant_conges = scAjaxGetFieldHidden(nomeCampo_montant_conges);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_montant_conges(var_montant_conges, var_script_case_init, do_ajax_frm_control_preavis_validate_montant_conges_cb);
  } // do_ajax_frm_control_preavis_validate_montant_conges

  function do_ajax_frm_control_preavis_validate_montant_conges_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_montant_conges_cb

  // ---------- Validate total
  function do_ajax_frm_control_preavis_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_validate_total(var_total, var_script_case_init, do_ajax_frm_control_preavis_validate_total_cb);
  } // do_ajax_frm_control_preavis_validate_total

  function do_ajax_frm_control_preavis_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_validate_total_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_frm_control_preavis_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_frm_control_preavis_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_frm_control_preavis_submit_form(var_employe_id, var_name, var_hire_date, var_fire_date, var_net_earnings, var_duration, var_serv_month, var_type_preavis, var_preavis_net, var_jours_conges_pris, var_jours_conges_acquis, var_jours_conges_restant, var_montant_conges, var_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_control_preavis_submit_form_cb);
  } // do_ajax_frm_control_preavis_submit_form

  function do_ajax_frm_control_preavis_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_frm_control_preavis_submit_form_cb_after_alert);
  } // do_ajax_frm_control_preavis_submit_form_cb
  function do_ajax_frm_control_preavis_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_control_preavis_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_control_preavis_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_control_preavis_navigate_form, function() {});
    } else {
      perform_ajax_frm_control_preavis_navigate_form();
    }
  }

  function perform_ajax_frm_control_preavis_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_frm_control_preavis_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_control_preavis_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_control_preavis_navigate_form_cb_after_alert);
  } // do_ajax_frm_control_preavis_navigate_form_cb
  function do_ajax_frm_control_preavis_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_frm_control_preavis_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_frm_control_preavis_navigate_form_cb_after_alert

  function sc_hide_frm_control_preavis_form()
  {
