  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_control_preavis_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_frm_control_preavis_mob_form();
        }
...
?>
  ...
  // ---------- Validate employe_id
  function do_ajax_frm_control_preavis_mob_validate_employe_id()
  {
    var nomeCampo_employe_id = "employe_id";
    var var_employe_id = scAjaxGetFieldText(nomeCampo_employe_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_employe_id(var_employe_id, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_employe_id_cb);
  } // do_ajax_frm_control_preavis_mob_validate_employe_id

  function do_ajax_frm_control_preavis_mob_validate_employe_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "employe_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_employe_id_cb

  // ---------- Validate name
  function do_ajax_frm_control_preavis_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldHidden(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_name(var_name, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_name_cb);
  } // do_ajax_frm_control_preavis_mob_validate_name

  function do_ajax_frm_control_preavis_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_name_cb

  // ---------- Validate hire_date
  function do_ajax_frm_control_preavis_mob_validate_hire_date()
  {
    var nomeCampo_hire_date = "hire_date";
    var var_hire_date = scAjaxGetFieldHidden(nomeCampo_hire_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_hire_date(var_hire_date, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_hire_date_cb);
  } // do_ajax_frm_control_preavis_mob_validate_hire_date

  function do_ajax_frm_control_preavis_mob_validate_hire_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hire_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_hire_date_cb

  // ---------- Validate fire_date
  function do_ajax_frm_control_preavis_mob_validate_fire_date()
  {
    var nomeCampo_fire_date = "fire_date";
    var var_fire_date = scAjaxGetFieldHidden(nomeCampo_fire_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_fire_date(var_fire_date, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_fire_date_cb);
  } // do_ajax_frm_control_preavis_mob_validate_fire_date

  function do_ajax_frm_control_preavis_mob_validate_fire_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fire_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_fire_date_cb

  // ---------- Validate net_earnings
  function do_ajax_frm_control_preavis_mob_validate_net_earnings()
  {
    var nomeCampo_net_earnings = "net_earnings";
    var var_net_earnings = scAjaxGetFieldHidden(nomeCampo_net_earnings);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_net_earnings(var_net_earnings, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_net_earnings_cb);
  } // do_ajax_frm_control_preavis_mob_validate_net_earnings

  function do_ajax_frm_control_preavis_mob_validate_net_earnings_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "net_earnings";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_net_earnings_cb

  // ---------- Validate duration
  function do_ajax_frm_control_preavis_mob_validate_duration()
  {
    var nomeCampo_duration = "duration";
    var var_duration = scAjaxGetFieldHidden(nomeCampo_duration);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_duration(var_duration, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_duration_cb);
  } // do_ajax_frm_control_preavis_mob_validate_duration

  function do_ajax_frm_control_preavis_mob_validate_duration_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "duration";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_duration_cb

  // ---------- Validate serv_month
  function do_ajax_frm_control_preavis_mob_validate_serv_month()
  {
    var nomeCampo_serv_month = "serv_month";
    var var_serv_month = scAjaxGetFieldHidden(nomeCampo_serv_month);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_serv_month(var_serv_month, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_serv_month_cb);
  } // do_ajax_frm_control_preavis_mob_validate_serv_month

  function do_ajax_frm_control_preavis_mob_validate_serv_month_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serv_month";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_serv_month_cb

  // ---------- Validate type_preavis
  function do_ajax_frm_control_preavis_mob_validate_type_preavis()
  {
    var nomeCampo_type_preavis = "type_preavis";
    var var_type_preavis = scAjaxGetFieldHidden(nomeCampo_type_preavis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_type_preavis(var_type_preavis, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_type_preavis_cb);
  } // do_ajax_frm_control_preavis_mob_validate_type_preavis

  function do_ajax_frm_control_preavis_mob_validate_type_preavis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type_preavis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_type_preavis_cb

  // ---------- Validate preavis_net
  function do_ajax_frm_control_preavis_mob_validate_preavis_net()
  {
    var nomeCampo_preavis_net = "preavis_net";
    var var_preavis_net = scAjaxGetFieldHidden(nomeCampo_preavis_net);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_preavis_net(var_preavis_net, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_preavis_net_cb);
  } // do_ajax_frm_control_preavis_mob_validate_preavis_net

  function do_ajax_frm_control_preavis_mob_validate_preavis_net_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "preavis_net";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_preavis_net_cb

  // ---------- Validate jours_conges_pris
  function do_ajax_frm_control_preavis_mob_validate_jours_conges_pris()
  {
    var nomeCampo_jours_conges_pris = "jours_conges_pris";
    var var_jours_conges_pris = scAjaxGetFieldHidden(nomeCampo_jours_conges_pris);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_jours_conges_pris(var_jours_conges_pris, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_jours_conges_pris_cb);
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_pris

  function do_ajax_frm_control_preavis_mob_validate_jours_conges_pris_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jours_conges_pris";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_pris_cb

  // ---------- Validate jours_conges_acquis
  function do_ajax_frm_control_preavis_mob_validate_jours_conges_acquis()
  {
    var nomeCampo_jours_conges_acquis = "jours_conges_acquis";
    var var_jours_conges_acquis = scAjaxGetFieldHidden(nomeCampo_jours_conges_acquis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_jours_conges_acquis(var_jours_conges_acquis, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_jours_conges_acquis_cb);
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_acquis

  function do_ajax_frm_control_preavis_mob_validate_jours_conges_acquis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jours_conges_acquis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_acquis_cb

  // ---------- Validate jours_conges_restant
  function do_ajax_frm_control_preavis_mob_validate_jours_conges_restant()
  {
    var nomeCampo_jours_conges_restant = "jours_conges_restant";
    var var_jours_conges_restant = scAjaxGetFieldHidden(nomeCampo_jours_conges_restant);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_jours_conges_restant(var_jours_conges_restant, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_jours_conges_restant_cb);
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_restant

  function do_ajax_frm_control_preavis_mob_validate_jours_conges_restant_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jours_conges_restant";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_jours_conges_restant_cb

  // ---------- Validate montant_conges
  function do_ajax_frm_control_preavis_mob_validate_montant_conges()
  {
    var nomeCampo_montant_conges = "montant_conges";
    var var_montant_conges = scAjaxGetFieldHidden(nomeCampo_montant_conges);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_montant_conges(var_montant_conges, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_montant_conges_cb);
  } // do_ajax_frm_control_preavis_mob_validate_montant_conges

  function do_ajax_frm_control_preavis_mob_validate_montant_conges_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "montant_conges";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_montant_conges_cb

  // ---------- Validate total
  function do_ajax_frm_control_preavis_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_control_preavis_mob_validate_total(var_total, var_script_case_init, do_ajax_frm_control_preavis_mob_validate_total_cb);
  } // do_ajax_frm_control_preavis_mob_validate_total

  function do_ajax_frm_control_preavis_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_control_preavis_mob_validate_total_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_frm_control_preavis_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_frm_control_preavis_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_employe_id = scAjaxGetFieldText("employe_id");
    var var_name = scAjaxGetFieldHidden("name");
    var var_hire_date = scAjaxGetFieldHidden("hire_date");
    var var_fire_date = scAjaxGetFieldHidden("fire_date");
    var var_net_earnings = scAjaxGetFieldHidden("net_earnings");
    var var_duration = scAjaxGetFieldHidden("duration");
    var var_serv_month = scAjaxGetFieldHidden("serv_month");
    var var_type_preavis = scAjaxGetFieldHidden("type_preavis");
    var var_preavis_net = scAjaxGetFieldHidden("preavis_net");
    var var_jours_conges_pris = scAjaxGetFieldHidden("jours_conges_pris");
    var var_jours_conges_acquis = scAjaxGetFieldHidden("jours_conges_acquis");
    var var_jours_conges_restant = scAjaxGetFieldHidden("jours_conges_restant");
    var var_montant_conges = scAjaxGetFieldHidden("montant_conges");
    ...
    scAjaxProcOn();
    x_ajax_frm_control_preavis_mob_submit_form(var_employe_id, var_name, var_hire_date, var_fire_date, var_net_earnings, var_duration, var_serv_month, var_type_preavis, var_preavis_net, var_jours_conges_pris, var_jours_conges_acquis, var_jours_conges_restant, var_montant_conges, var_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_control_preavis_mob_submit_form_cb);
  } // do_ajax_frm_control_preavis_mob_submit_form

  function do_ajax_frm_control_preavis_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_frm_control_preavis_mob_submit_form_cb_after_alert);
  } // do_ajax_frm_control_preavis_mob_submit_form_cb
  function do_ajax_frm_control_preavis_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_control_preavis_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_control_preavis_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_control_preavis_mob_navigate_form, function() {});
    } else {
      perform_ajax_frm_control_preavis_mob_navigate_form();
    }
  }

  function perform_ajax_frm_control_preavis_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_frm_control_preavis_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_control_preavis_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_control_preavis_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_control_preavis_mob_navigate_form_cb_after_alert);
  } // do_ajax_frm_control_preavis_mob_navigate_form_cb
  function do_ajax_frm_control_preavis_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_frm_control_preavis_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_frm_control_preavis_mob_navigate_form_cb_after_alert

  function sc_hide_frm_control_preavis_mob_form()
  {
  ...
  ajax_field_list[0] = "employe_id";
  ajax_field_list[1] = "name";
  ajax_field_list[2] = "hire_date";
  ajax_field_list[3] = "fire_date";
  ajax_field_list[4] = "net_earnings";
  ajax_field_list[5] = "duration";
  ajax_field_list[6] = "serv_month";
  ajax_field_list[7] = "type_preavis";
  ajax_field_list[8] = "preavis_net";
  ajax_field_list[9] = "jours_conges_pris";
  ajax_field_list[10] = "jours_conges_acquis";
  ajax_field_list[11] = "jours_conges_restant";
  ajax_field_list[12] = "montant_conges";
  ajax_field_list[13] = "total";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "employe_id": {"label": "Employee ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "name": {"label": "Employee Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "hire_date": {"label": "Hire Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fire_date": {"label": "End of contract", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "net_earnings": {"label": "Net Salary", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "duration": {"label": "Service Duration", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "serv_month": {"label": "Service Months", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "type_preavis": {"label": "Notice Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "preavis_net": {"label": "Notice Amount", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "jours_conges_pris": {"label": "Leave Days Taken", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "jours_conges_acquis": {"label": "Leave Days Earned", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "jours_conges_restant": {"label": "Leave Days Remaining", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "montant_conges": {"label": "Leave Amount", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    "employe_id": new Array(),
    "name": new Array(),
    "hire_date": new Array(),
    "fire_date": new Array(),
    "net_earnings": new Array(),
    "duration": new Array(),
    "serv_month": new Array(),
    "type_preavis": new Array(),
    "preavis_net": new Array(),
    "jours_conges_pris": new Array(),
    "jours_conges_acquis": new Array(),
    "jours_conges_restant": new Array(),
    "montant_conges": new Array(),
    "total": new Array()
  };
  ajax_field_mult["employe_id"][1] = "employe_id";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["hire_date"][1] = "hire_date";
  ajax_field_mult["fire_date"][1] = "fire_date";
  ajax_field_mult["net_earnings"][1] = "net_earnings";
  ajax_field_mult["duration"][1] = "duration";
  ajax_field_mult["serv_month"][1] = "serv_month";
  ajax_field_mult["type_preavis"][1] = "type_preavis";
  ajax_field_mult["preavis_net"][1] = "preavis_net";
  ajax_field_mult["jours_conges_pris"][1] = "jours_conges_pris";
  ajax_field_mult["jours_conges_acquis"][1] = "jours_conges_acquis";
  ajax_field_mult["jours_conges_restant"][1] = "jours_conges_restant";
  ajax_field_mult["montant_conges"][1] = "montant_conges";
  ajax_field_mult["total"][1] = "total";

  var ajax_field_id = {
    "employe_id": new Array("hidden_field_label_employe_id", "hidden_field_data_employe_id"),
    "name": new Array("hidden_field_label_name", "hidden_field_data_name"),
    "hire_date": new Array("hidden_field_label_hire_date", "hidden_field_data_hire_date"),
    "fire_date": new Array("hidden_field_label_fire_date", "hidden_field_data_fire_date"),
    "net_earnings": new Array("hidden_field_label_net_earnings", "hidden_field_data_net_earnings"),
    "duration": new Array("hidden_field_label_duration", "hidden_field_data_duration"),
    "serv_month": new Array("hidden_field_label_serv_month", "hidden_field_data_serv_month"),
    "type_preavis": new Array("hidden_field_label_type_preavis", "hidden_field_data_type_preavis"),
    "preavis_net": new Array("hidden_field_label_preavis_net", "hidden_field_data_preavis_net"),
    "jours_conges_pris": new Array("hidden_field_label_jours_conges_pris", "hidden_field_data_jours_conges_pris"),
    "jours_conges_acquis": new Array("hidden_field_label_jours_conges_acquis", "hidden_field_data_jours_conges_acquis"),
    "jours_conges_restant": new Array("hidden_field_label_jours_conges_restant", "hidden_field_data_jours_conges_restant"),
    "montant_conges": new Array("hidden_field_label_montant_conges", "hidden_field_data_montant_conges"),
  ...
  var ajax_read_only = {
    ...
    "type_preavis": "off",
    "preavis_net": "off",
    "jours_conges_pris": "off",
    "jours_conges_acquis": "off",
    "jours_conges_restant": "off",
    "montant_conges": "off",
    "total": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("jours_conges_restant" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
