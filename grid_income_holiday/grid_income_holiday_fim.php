...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_holiday"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_holiday"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_income_holiday</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_income_holiday']['embutida_filho'] as $ind => $sc_init)
          {
