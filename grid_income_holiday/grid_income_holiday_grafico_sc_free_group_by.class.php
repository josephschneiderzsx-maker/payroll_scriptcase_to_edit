...
class grid_income_holiday_grafico
{
...
SCEOT;
        ...
        $this->SC_APP_info = [
            'chart' => [
                ...
                'json_filename' => "sc_fc_grid_income_holiday_{$chartMd5}.json",
    ...
    function info_loadMd5Info($chartMd5)
    {
        ...
        $this->SC_APP_data['md5_data'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] [$chartInfo] [$chartMd5];
    ...
    {
        $this->SC_APP_data['type'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'];
        $this->SC_APP_data['data_mode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['graf_opc_atual'];

        $this->SC_APP_data['width'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_larg'];
        $this->SC_APP_data['height'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_alt'];

        $this->SC_APP_data['order'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['graf_order'];

        $this->SC_APP_info['types'] ['area'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_forma'];
        $this->SC_APP_info['types'] ['area'] ['stacking'] = 'Off' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_empil'];
        $this->SC_APP_info['types'] ['area'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_is_scroll'];

        $this->SC_APP_info['types'] ['bar'] ['orientation'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_orien'];
        $this->SC_APP_info['types'] ['bar'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'];
        $this->SC_APP_info['types'] ['bar'] ['stacking'] = 'Off' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'];
        $this->SC_APP_info['types'] ['bar'] ['stack100Percent'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] ? '1' : '0';
        $this->SC_APP_info['types'] ['bar'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_agrup'];
        $this->SC_APP_info['types'] ['bar'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'];
        $this->SC_APP_info['types'] ['bar'] ['isOverlapped'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'];

        $this->SC_APP_info['types'] ['funnel'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_funil_dimen'];

        $this->SC_APP_info['types'] ['gauge'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_gauge_forma'];

        $this->SC_APP_info['types'] ['line'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_forma'];
        $this->SC_APP_info['types'] ['line'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_agrup'];
        $this->SC_APP_info['types'] ['line'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'];
        $this->SC_APP_info['types'] ['line'] ['isZoom'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'];

        $this->SC_APP_info['types'] ['pie'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_forma'];
        $this->SC_APP_info['types'] ['pie'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_dimen'];
        $this->SC_APP_info['types'] ['pie'] ['order'] = strtolower($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_orden']);
        $this->SC_APP_info['types'] ['pie'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_valor'];

        $this->SC_APP_info['types'] ['pyramid'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pyram_dimen'];
        $this->SC_APP_info['types'] ['pyramid'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pyram_valor'];
        $this->SC_APP_info['types'] ['pyramid'] ['isSliced'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pyram_forma'];

        $this->SC_APP_info['types'] ['combination'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_combi_dimen'];

        if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_has_enable_scroll']) {
            $this->SC_APP_info['types'] ['area'] ['isScroll'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_enable_scroll'];
            $this->SC_APP_info['types'] ['bar'] ['isScroll'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_enable_scroll'];
            $this->SC_APP_info['types'] ['line'] ['isScroll'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_enable_scroll'];
        } else {
    ...
    {
        if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['has_limit_chart_items']) {
            if ('' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['limit_chart_items'] && '0' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['limit_chart_items']) {
                $this->SC_APP_data['limit_chart_items'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['limit_chart_items'];
    ...
    function info_createFusionChartsData_json_data_singleSeries()
    {
        ...
        $displayValues = [];
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_display_values'] as $thisDisplayValue) {
    ...
    function info_createFusionChartsData_json_data_combinationSeries()
    {
        ...
        $renderAs = [];
        $displayValues = [];
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['comb_field_display_type'] as $thisRenderAs) {
    ...
    function display_chartApp_type($chartMd5, $chartType, $chartTitle)
    {
        ...
        $ajaxResponse = [
            ...
            'chartUrl' => "{$this->SC_APP_info['chart'] ['json_base_url']}sc_fc_grid_income_holiday_{$chartMd5}.json",
            'chartMd5' => $chartMd5,
...
SCEOT;
    ...
    function display_summaryChart_inline_initialAjaxResponse($chartMd5)
    {
        ...
        if ('' != $chartMd5 && isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_info'] [$chartMd5])) {
    ...
    function display_summaryChart_data($chartMd5)
    {
        ...
        $chartFile = "{$this->SC_APP_info['chart'] ['json_base_dir']}sc_fc_grid_income_holiday_{$chartMd5}.json";
...
SCEOT;
    ...
    {
        $scPage = NM_encode_input($this->Ini->sc_page);
        $ajaxUrl = "{$this->Ini->path_link}grid_income_holiday/grid_income_holiday_config_graf_flash.php?nome_apl=grid_income_holiday&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us";
        $ajaxUrlDrillDown = "{$this->Ini->path_link}grid_income_holiday/index.php";
...
SCEOT;
    ...
    function aux_getChartErrorMessage()
    {
        ...
        //return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] . ' - ' . $dimensionCount . ' - ' . $metricCount;
        ...
        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo']) {
            ...
            case 'Treemap':
                ...
                break;
            default:
                //return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'];
                break;
        }
    ...
    {
        return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['responsive_chart'] ['active'];
    }
    ...
    {
        $this->tempSortField = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_combination_order_field'];
        $this->tempSortRule = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['chart_combination_order_rule'];
    ...
    function aux_setChartType($chartType)
    {
        switch ($chartType) {
            ...
            case 'bar2d':
            case 'msbar2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Bar';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'msbar3d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Bar';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'] = '3d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'mscolumn2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Bar';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_orien'] = 'Vertical';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
            ...
            case 'stackedbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'On';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'scrollbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'overlappedbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_barra_is_overlapped'] = true;
                break;
            ...
            case 'line':
            case 'msline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_forma'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;

            case 'spline':
            case 'msspline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_forma'] = 'Spline';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'msstepline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_forma'] = 'Step';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'scrollline2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'zoomline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_linha_is_zoom'] = true;
                break;
            ...
            case 'area2d':
            case 'msarea':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_forma'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_is_scroll'] = false;
                break;

            case 'splinearea':
            case 'mssplinearea':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_forma'] = 'Spline';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_is_scroll'] = false;
                break;
            ...
            case 'scrollarea2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_forma'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_is_scroll'] = true;
                break;
            ...
            case 'stackedarea2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_forma'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_empil'] = 'On';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_area_is_scroll'] = false;
                break;

            // pie
            case 'pie2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_forma'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_dimen'] = '2d';
                break;

            case 'pie3d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_forma'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_dimen'] = '3d';
                break;

            case 'doughnut2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_forma'] = 'Donut';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pizza_dimen'] = '2d';
                break;
            ...
            // gauge
            case 'angulargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_gauge_forma'] = 'Circular';
                break;

            case 'semicirculargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_gauge_forma'] = 'Semicircular';
                break;

            case 'hlineargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_gauge_forma'] = 'LinearGauge';
                break;

            // heatmap
            case 'heatmap':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Heatmap';
                break;

            // treemap
            case 'treemap':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Treemap';
                break;

            // chord
            case 'chord':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Chord';
                break;

            // sankey
            case 'sankey':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Sankey';
                break;

            // sunburst
            case 'sunburst':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Sunburst';
                break;

            // pyramid
            case 'pyramid':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Pyramid';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pyram_dimen'] = '3d';
                break;

            case 'pyramid2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Pyramid';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_pyram_dimen'] = '2d';
                break;

            // funnel
            case 'funnel':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Funnel';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_funil_dimen'] = '3d';
                break;

            case 'funnel2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Funnel';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_funil_dimen'] = '2d';
                break;

            // radar
            case 'radar':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Radar';
                break;

            // scatter
            case 'scatter':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Scatter';
                break;

            // bubble
            case 'bubble':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Bubble';
                break;

            // combination
            case 'mscombidy2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Combination';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_combi_dimen'] = '2d';
                break;

            case 'mscolumn3dlinedy':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_tipo'] = 'Combination';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_income_holiday'] ['cfg_graf'] ['graf_combi_dimen'] = '3d';
                break;
        }
    }
   ...
   function monta_grafico($chart_key = '', $operation = 'chart', $graf_col = false)
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']               = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday'][$field];
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_order'];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export'], ''), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['cfg_graf']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_full']);
           }
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
      ...
      $this->NM_tit_val[3]     = strip_tags("Income Holiday (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")");
      $this->NM_ind_val[3]     = 3;
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['del_graph_col'][$tst_ind]))
              {
   ...
   {
       $Ind_groupby = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['SC_Ind_Groupby'];
       if ($bComb)
       {
           $tmp_count = 0;
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['summarizing_fields_order'][$Ind_groupby] as $i_sum)
           {
               if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['summarizing_fields_display'][$Ind_groupby][$i_sum]))
               {
                   $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['summarizing_fields_display'][$Ind_groupby][$i_sum];
                   if ($d_sum['display'])
                   {
                       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['summarizing_fields_control'][$Ind_groupby] as $l_field => $d_field)
                       {
           ...
           switch ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['chart_combination_type']) {
               case 'angulargauge':
       ...
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_barra_dimen']  ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_tipo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_holiday']['parms_graf']['graf_tipo'] : "";
       }
       switch ($sChartType)
       {
           case 'Bar':
