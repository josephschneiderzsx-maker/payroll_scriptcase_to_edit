<?php
@session_start() ;
$_SESSION['scriptcase']['grid_income_holiday']['sc_process_barr'] = true;
require_once('../grid_income_holiday/index.php');
unset($_SESSION['scriptcase']['grid_income_holiday']['sc_process_barr']);
$ExportCtrl = new grid_income_holiday_export_control;
$ExportCtrl->Export_barr();

class grid_income_holiday_export_control
{
