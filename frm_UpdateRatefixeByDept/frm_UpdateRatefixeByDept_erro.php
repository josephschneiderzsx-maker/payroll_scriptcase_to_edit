...
$old_error_handler = set_error_handler("frm_UpdateRatefixeByDept_scriptcase_error_handler");

function frm_UpdateRatefixeByDept_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frm_UpdateRatefixeByDept']['contr_erro']) && $_SESSION['scriptcase']['frm_UpdateRatefixeByDept']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frm_UpdateRatefixeByDept->contr_frm_UpdateRatefixeByDept->Apl_com_erro = true;
            if ($inicial_frm_UpdateRatefixeByDept->contr_frm_UpdateRatefixeByDept->NM_ajax_flag)
            {
                $inicial_frm_UpdateRatefixeByDept->contr_frm_UpdateRatefixeByDept->NM_ajax_info['errList']['geral_frm_UpdateRatefixeByDept'][] = $msg;
                return;
            }
            frm_UpdateRatefixeByDept_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frm_UpdateRatefixeByDept_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frm_UpdateRatefixeByDept'])  && '' != $_SESSION['scriptcase']['error_icon']['frm_UpdateRatefixeByDept'])  ? $_SESSION['scriptcase']['error_icon']['frm_UpdateRatefixeByDept']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frm_UpdateRatefixeByDept']) && '' != $_SESSION['scriptcase']['error_span_title']['frm_UpdateRatefixeByDept']) ? $_SESSION['scriptcase']['error_span_title']['frm_UpdateRatefixeByDept'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frm_UpdateRatefixeByDept']) && '' != $_SESSION['scriptcase']['error_icon_title']['frm_UpdateRatefixeByDept']) ? $_SESSION['scriptcase']['error_icon_title']['frm_UpdateRatefixeByDept'] : '';
?>
