  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_employee_setting" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_employee_setting_form();
        }
...
?>
  ...
  function do_ajax_form_employee_setting_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_userid_int__cb);
  } // do_ajax_form_employee_setting_validate_userid_int_

  function do_ajax_form_employee_setting_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_form_employee_setting_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_employee_name__cb);
  } // do_ajax_form_employee_setting_validate_employee_name_

  function do_ajax_form_employee_setting_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_employee_name__cb

  // ---------- Validate designation_
  function do_ajax_form_employee_setting_validate_designation_(iNumLinha)
  {
    var nomeCampo_designation_ = "designation_" + iNumLinha;
    var var_designation_ = scAjaxGetFieldHidden(nomeCampo_designation_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_designation_(var_designation_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_designation__cb);
  } // do_ajax_form_employee_setting_validate_designation_

  function do_ajax_form_employee_setting_validate_designation__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "designation_" + iLineNumber;
    }
    else
    {
      sFieldValid = "designation_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "designation_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "designation_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_designation__cb

  // ---------- Validate dept_
  function do_ajax_form_employee_setting_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_dept__cb);
  } // do_ajax_form_employee_setting_validate_dept_

  function do_ajax_form_employee_setting_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_dept__cb

  // ---------- Validate rate_ot_factor_
  function do_ajax_form_employee_setting_validate_rate_ot_factor_(iNumLinha)
  {
    var nomeCampo_rate_ot_factor_ = "rate_ot_factor_" + iNumLinha;
    var var_rate_ot_factor_ = scAjaxGetFieldText(nomeCampo_rate_ot_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_rate_ot_factor_(var_rate_ot_factor_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_rate_ot_factor__cb);
  } // do_ajax_form_employee_setting_validate_rate_ot_factor_

  function do_ajax_form_employee_setting_validate_rate_ot_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_ot_factor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_ot_factor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_ot_factor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_ot_factor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_rate_ot_factor__cb

  // ---------- Validate rate_ot_holiday_factor_
  function do_ajax_form_employee_setting_validate_rate_ot_holiday_factor_(iNumLinha)
  {
    var nomeCampo_rate_ot_holiday_factor_ = "rate_ot_holiday_factor_" + iNumLinha;
    var var_rate_ot_holiday_factor_ = scAjaxGetFieldText(nomeCampo_rate_ot_holiday_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_rate_ot_holiday_factor_(var_rate_ot_holiday_factor_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_rate_ot_holiday_factor__cb);
  } // do_ajax_form_employee_setting_validate_rate_ot_holiday_factor_

  function do_ajax_form_employee_setting_validate_rate_ot_holiday_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_ot_holiday_factor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_ot_holiday_factor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_ot_holiday_factor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_ot_holiday_factor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_rate_ot_holiday_factor__cb

  // ---------- Validate rate_ot_offday_factor_
  function do_ajax_form_employee_setting_validate_rate_ot_offday_factor_(iNumLinha)
  {
    var nomeCampo_rate_ot_offday_factor_ = "rate_ot_offday_factor_" + iNumLinha;
    var var_rate_ot_offday_factor_ = scAjaxGetFieldText(nomeCampo_rate_ot_offday_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_rate_ot_offday_factor_(var_rate_ot_offday_factor_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_rate_ot_offday_factor__cb);
  } // do_ajax_form_employee_setting_validate_rate_ot_offday_factor_

  function do_ajax_form_employee_setting_validate_rate_ot_offday_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_ot_offday_factor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_ot_offday_factor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_ot_offday_factor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_ot_offday_factor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_rate_ot_offday_factor__cb

  // ---------- Validate rate_ot_restday_factor_
  function do_ajax_form_employee_setting_validate_rate_ot_restday_factor_(iNumLinha)
  {
    var nomeCampo_rate_ot_restday_factor_ = "rate_ot_restday_factor_" + iNumLinha;
    var var_rate_ot_restday_factor_ = scAjaxGetFieldText(nomeCampo_rate_ot_restday_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_rate_ot_restday_factor_(var_rate_ot_restday_factor_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_rate_ot_restday_factor__cb);
  } // do_ajax_form_employee_setting_validate_rate_ot_restday_factor_

  function do_ajax_form_employee_setting_validate_rate_ot_restday_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_ot_restday_factor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_ot_restday_factor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_ot_restday_factor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_ot_restday_factor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_rate_ot_restday_factor__cb

  // ---------- Validate probation_period_
  function do_ajax_form_employee_setting_validate_probation_period_(iNumLinha)
  {
    var nomeCampo_probation_period_ = "probation_period_" + iNumLinha;
    var var_probation_period_ = scAjaxGetFieldText(nomeCampo_probation_period_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_probation_period_(var_probation_period_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_probation_period__cb);
  } // do_ajax_form_employee_setting_validate_probation_period_

  function do_ajax_form_employee_setting_validate_probation_period__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "probation_period_" + iLineNumber;
    }
    else
    {
      sFieldValid = "probation_period_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "probation_period_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "probation_period_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_probation_period__cb

  // ---------- Validate payperiod_
  function do_ajax_form_employee_setting_validate_payperiod_(iNumLinha)
  {
    var nomeCampo_payperiod_ = "payperiod_" + iNumLinha;
    var var_payperiod_ = scAjaxGetFieldSelect(nomeCampo_payperiod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_validate_payperiod_(var_payperiod_, iNumLinha, var_script_case_init, do_ajax_form_employee_setting_validate_payperiod__cb);
  } // do_ajax_form_employee_setting_validate_payperiod_

  function do_ajax_form_employee_setting_validate_payperiod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_employee_setting_validate_payperiod__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_employee_setting_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_employee_setting_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_employee_setting_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_employee_setting_add_new_line_cb);
  } // do_ajax_form_employee_setting_add_new_line

  function do_ajax_form_employee_setting_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("payperiod_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_employee_setting_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_employee_setting_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_employee_setting_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_employee_setting_backup_line_cb);
  } // do_ajax_form_employee_setting_backup_line

  function do_ajax_form_employee_setting_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_employee_setting_backup_line_cb

  function do_ajax_form_employee_setting_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_employee_setting_cancel_insert

  function do_ajax_form_employee_setting_cancel_update(iSeqVert)
  {
    do_ajax_form_employee_setting_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_employee_setting_cancel_update

  function do_ajax_form_employee_setting_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_employee_setting_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_employee_setting_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_employee_setting_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_employee_setting_table_refresh_cb);
  } //  do_ajax_form_employee_setting_table_refresh

  function do_ajax_form_employee_setting_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_employee_setting_table_refresh_cb_after_alert);
  } // do_ajax_form_employee_setting_table_refresh_cb
  function do_ajax_form_employee_setting_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_employee_setting_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_employee_setting_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_employee_setting_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_designation_ = scAjaxGetFieldHidden("designation_" + iNumLinha);
    var var_dept_ = scAjaxGetFieldHidden("dept_" + iNumLinha);
    var var_rate_ot_factor_ = scAjaxGetFieldText("rate_ot_factor_" + iNumLinha);
    var var_rate_ot_holiday_factor_ = scAjaxGetFieldText("rate_ot_holiday_factor_" + iNumLinha);
    var var_rate_ot_offday_factor_ = scAjaxGetFieldText("rate_ot_offday_factor_" + iNumLinha);
    var var_rate_ot_restday_factor_ = scAjaxGetFieldText("rate_ot_restday_factor_" + iNumLinha);
    var var_probation_period_ = scAjaxGetFieldText("probation_period_" + iNumLinha);
    var var_payperiod_ = scAjaxGetFieldSelect("payperiod_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_employee_setting_submit_form(var_userid_int_, var_employee_name_, var_designation_, var_dept_, var_rate_ot_factor_, var_rate_ot_holiday_factor_, var_rate_ot_offday_factor_, var_rate_ot_restday_factor_, var_probation_period_, var_payperiod_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_employee_setting_submit_form_cb);
  } // do_ajax_form_employee_setting_submit_form

  function do_ajax_form_employee_setting_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("designation_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dept_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_ot_factor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_ot_holiday_factor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_ot_offday_factor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_ot_restday_factor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("probation_period_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_employee_setting_submit_form_cb_after_alert);
  } // do_ajax_form_employee_setting_submit_form_cb
  function do_ajax_form_employee_setting_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_employee_setting_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_employee_setting_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_employee_setting_navigate_form, function() {});
    } else {
      perform_ajax_form_employee_setting_navigate_form();
    }
  }

  function perform_ajax_form_employee_setting_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("designation_" + iNavForm);
      scAjaxHideErrorDisplay("dept_" + iNavForm);
      scAjaxHideErrorDisplay("rate_ot_factor_" + iNavForm);
      scAjaxHideErrorDisplay("rate_ot_holiday_factor_" + iNavForm);
      scAjaxHideErrorDisplay("rate_ot_offday_factor_" + iNavForm);
      scAjaxHideErrorDisplay("rate_ot_restday_factor_" + iNavForm);
      scAjaxHideErrorDisplay("probation_period_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_employee_setting_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_employee_setting_navigate_form_cb);
  } // do_ajax_form_employee_setting_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_employee_setting']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_employee_setting_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_employee_setting_navigate_form_cb_after_alert);
  } // do_ajax_form_employee_setting_navigate_form_cb
  function do_ajax_form_employee_setting_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_form_employee_setting_navigate_form_cb_after_alert

    function sc_form_employee_setting_get_last_line_number()
    {
    ...
    } //sc_form_employee_setting_get_last_line_number

  function sc_hide_form_employee_setting_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "designation_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dept_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_ot_factor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_ot_holiday_factor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_ot_offday_factor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_ot_restday_factor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "probation_period_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["designation_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_designation'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["rate_ot_factor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ot_factot'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_ot_holiday_factor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_holiday_factor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_ot_offday_factor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_offday_factor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_ot_restday_factor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_restday_factor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["probation_period_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_probation_period'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["payperiod_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pay_period'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["designation_"][iNumLinha] = "designation_" + iNumLinha;
    ajax_field_mult["dept_"][iNumLinha] = "dept_" + iNumLinha;
    ajax_field_mult["rate_ot_factor_"][iNumLinha] = "rate_ot_factor_" + iNumLinha;
    ajax_field_mult["rate_ot_holiday_factor_"][iNumLinha] = "rate_ot_holiday_factor_" + iNumLinha;
    ajax_field_mult["rate_ot_offday_factor_"][iNumLinha] = "rate_ot_offday_factor_" + iNumLinha;
    ajax_field_mult["rate_ot_restday_factor_"][iNumLinha] = "rate_ot_restday_factor_" + iNumLinha;
    ajax_field_mult["probation_period_"][iNumLinha] = "probation_period_" + iNumLinha;
    ...
    ajax_field_id["designation_" + iNumLinha] = new Array("hidden_field_label_designation_", "hidden_field_data_designation_" + iNumLinha);
    ajax_field_id["dept_" + iNumLinha] = new Array("hidden_field_label_dept_", "hidden_field_data_dept_" + iNumLinha);
    ajax_field_id["rate_ot_factor_" + iNumLinha] = new Array("hidden_field_label_rate_ot_factor_", "hidden_field_data_rate_ot_factor_" + iNumLinha);
    ajax_field_id["rate_ot_holiday_factor_" + iNumLinha] = new Array("hidden_field_label_rate_ot_holiday_factor_", "hidden_field_data_rate_ot_holiday_factor_" + iNumLinha);
    ajax_field_id["rate_ot_offday_factor_" + iNumLinha] = new Array("hidden_field_label_rate_ot_offday_factor_", "hidden_field_data_rate_ot_offday_factor_" + iNumLinha);
    ajax_field_id["rate_ot_restday_factor_" + iNumLinha] = new Array("hidden_field_label_rate_ot_restday_factor_", "hidden_field_data_rate_ot_restday_factor_" + iNumLinha);
    ajax_field_id["probation_period_" + iNumLinha] = new Array("hidden_field_label_probation_period_", "hidden_field_data_probation_period_" + iNumLinha);
    ajax_field_id["payperiod_" + iNumLinha] = new Array("hidden_field_label_payperiod_", "hidden_field_data_payperiod_" + iNumLinha);
    ajax_error_count["userid_int_" + iNumLinha] = "off";
    ajax_error_count["employee_name_" + iNumLinha] = "off";
    ajax_error_count["designation_" + iNumLinha] = "off";
    ajax_error_count["dept_" + iNumLinha] = "off";
    ajax_error_count["rate_ot_factor_" + iNumLinha] = "off";
    ajax_error_count["rate_ot_holiday_factor_" + iNumLinha] = "off";
    ajax_error_count["rate_ot_offday_factor_" + iNumLinha] = "off";
    ajax_error_count["rate_ot_restday_factor_" + iNumLinha] = "off";
    ajax_error_count["probation_period_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["designation_" + iNumLinha] = "off";
    ajax_read_only["dept_" + iNumLinha] = "off";
    ajax_read_only["rate_ot_factor_" + iNumLinha] = "off";
    ajax_read_only["rate_ot_holiday_factor_" + iNumLinha] = "off";
    ajax_read_only["rate_ot_offday_factor_" + iNumLinha] = "off";
    ajax_read_only["rate_ot_restday_factor_" + iNumLinha] = "off";
    ajax_read_only["probation_period_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["designation_" + iNumLinha] = "on";
    ajax_read_only["dept_" + iNumLinha] = "on";
    ajax_read_only["rate_ot_factor_" + iNumLinha] = "on";
    ajax_read_only["rate_ot_holiday_factor_" + iNumLinha] = "on";
    ajax_read_only["rate_ot_offday_factor_" + iNumLinha] = "on";
    ajax_read_only["rate_ot_restday_factor_" + iNumLinha] = "on";
    ajax_read_only["probation_period_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["designation_" + iNumLinha] = null;
    ajax_error_list["dept_" + iNumLinha] = null;
    ajax_error_list["rate_ot_factor_" + iNumLinha] = null;
    ajax_error_list["rate_ot_holiday_factor_" + iNumLinha] = null;
    ajax_error_list["rate_ot_offday_factor_" + iNumLinha] = null;
    ajax_error_list["rate_ot_restday_factor_" + iNumLinha] = null;
    ajax_error_list["probation_period_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "designation_": new Array(),
    "dept_": new Array(),
    "rate_ot_factor_": new Array(),
    "rate_ot_holiday_factor_": new Array(),
    "rate_ot_offday_factor_": new Array(),
    "rate_ot_restday_factor_": new Array(),
    "probation_period_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["designation_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["designation_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["designation_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["designation_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["designation_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["rate_ot_factor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_ot_factor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_ot_factor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_ot_factor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_ot_factor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_ot_holiday_factor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_ot_holiday_factor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_ot_holiday_factor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_ot_holiday_factor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_ot_holiday_factor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_ot_offday_factor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_ot_offday_factor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_ot_offday_factor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_ot_offday_factor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_ot_offday_factor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_ot_restday_factor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_ot_restday_factor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_ot_restday_factor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_ot_restday_factor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_ot_restday_factor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["probation_period_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["probation_period_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["probation_period_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["probation_period_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["probation_period_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['designation_'])) ? $this->nmgp_cmp_readonly['designation_'] : 'off';
?>
    scAjaxFieldRead("designation_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_ot_factor_'])) ? $this->nmgp_cmp_readonly['rate_ot_factor_'] : 'off';
?>
    scAjaxFieldRead("rate_ot_factor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_ot_holiday_factor_'])) ? $this->nmgp_cmp_readonly['rate_ot_holiday_factor_'] : 'off';
?>
    scAjaxFieldRead("rate_ot_holiday_factor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_ot_offday_factor_'])) ? $this->nmgp_cmp_readonly['rate_ot_offday_factor_'] : 'off';
?>
    scAjaxFieldRead("rate_ot_offday_factor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_ot_restday_factor_'])) ? $this->nmgp_cmp_readonly['rate_ot_restday_factor_'] : 'off';
?>
    scAjaxFieldRead("rate_ot_restday_factor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['probation_period_'])) ? $this->nmgp_cmp_readonly['probation_period_'] : 'off';
?>
    scAjaxFieldRead("probation_period_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("designation_" + iSeq, "on");
    scAjaxFieldRead("dept_" + iSeq, "on");
    scAjaxFieldRead("rate_ot_factor_" + iSeq, "on");
    scAjaxFieldRead("rate_ot_holiday_factor_" + iSeq, "on");
    scAjaxFieldRead("rate_ot_offday_factor_" + iSeq, "on");
    scAjaxFieldRead("rate_ot_restday_factor_" + iSeq, "on");
    scAjaxFieldRead("probation_period_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["designation_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["rate_ot_factor_" + iRow] || "on" == ajax_error_count["rate_ot_holiday_factor_" + iRow] || "on" == ajax_error_count["rate_ot_offday_factor_" + iRow] || "on" == ajax_error_count["rate_ot_restday_factor_" + iRow] || "on" == ajax_error_count["probation_period_" + iRow] || "on" == ajax_error_count["payperiod_" + iRow]))
    {
      ...
      $("#hidden_field_data_designation_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dept_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_factor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_holiday_factor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_offday_factor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_restday_factor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_probation_period_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["designation_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["rate_ot_factor_" + iRow] && "off" == ajax_error_count["rate_ot_holiday_factor_" + iRow] && "off" == ajax_error_count["rate_ot_offday_factor_" + iRow] && "off" == ajax_error_count["rate_ot_restday_factor_" + iRow] && "off" == ajax_error_count["probation_period_" + iRow] && "off" == ajax_error_count["payperiod_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["userid_int_" + iRow] = "off";
        ajax_error_count["employee_name_" + iRow] = "off";
        ajax_error_count["designation_" + iRow] = "off";
        ajax_error_count["dept_" + iRow] = "off";
        ajax_error_count["rate_ot_factor_" + iRow] = "off";
        ajax_error_count["rate_ot_holiday_factor_" + iRow] = "off";
        ajax_error_count["rate_ot_offday_factor_" + iRow] = "off";
        ajax_error_count["rate_ot_restday_factor_" + iRow] = "off";
        ajax_error_count["probation_period_" + iRow] = "off";
      ...
      $("#hidden_field_data_designation_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dept_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_factor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_holiday_factor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_offday_factor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_ot_restday_factor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_probation_period_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("rate_ot_holiday_factor_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("rate_ot_offday_factor_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("rate_ot_restday_factor_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
