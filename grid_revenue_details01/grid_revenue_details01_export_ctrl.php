<?php
@session_start() ;
$_SESSION['scriptcase']['grid_revenue_details01']['sc_process_barr'] = true;
require_once('../grid_revenue_details01/index.php');
unset($_SESSION['scriptcase']['grid_revenue_details01']['sc_process_barr']);
$ExportCtrl = new grid_revenue_details01_export_control;
$ExportCtrl->Export_barr();

class grid_revenue_details01_export_control
{
