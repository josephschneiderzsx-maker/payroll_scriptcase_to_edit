...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cfgdct"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_cfgdct"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_deduction_cfgdct</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_deduction_cfgdct']['embutida_filho'] as $ind => $sc_init)
          {
