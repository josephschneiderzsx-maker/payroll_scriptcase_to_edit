...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_boni_resume02/grid_boni_resume02_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_boni_resume02_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_boni_resume02.zip";
          $this->Arquivo   .= "_grid_boni_resume02" . $this->Xls_tp;
          $this->Tit_doc    = "grid_boni_resume02" . $this->Xls_tp;
          $this->Tit_zip    = "grid_boni_resume02.zip";
      ...
      {
          $this->dct_userid_int = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][2];
          $this->sum_boni_value = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][3];
          $this->sum_tax_iric = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][4];
          $this->sum_boni_net = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][5];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          $this->sum_boni_value = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][2];
          $this->sum_tax_iric = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][3];
          $this->sum_boni_net = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][4];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['nolabel'])
       {
 ...
 function quebra_dept_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_dept_sc_free_group_by_bot()
   {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['userid_int'][$Tipo_Sum]) && $Cada_cmp == "userid_int" && (!isset($this->NM_cmp_hidden['userid_int']) || $this->NM_cmp_hidden['userid_int'] != "off"))
           {
               $Format_Num = "#,##0";
           ...
           elseif (isset($NM_cmp_tot['boni_net'][$Tipo_Sum]) && $Cada_cmp == "boni_net" && (!isset($this->NM_cmp_hidden['boni_net']) || $this->NM_cmp_hidden['boni_net'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
               ...
               $Prep_Tot = $NM_cmp_tot['boni_net'][$Tipo_Sum] . "dept_boni_net";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida']) {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '', 'D' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_dct'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][$NM_cmp_tot['userid_int'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['boni_value'][$Tipo_Sum]) && $Cada_cmp == "boni_value" && (!isset($this->NM_cmp_hidden['boni_value']) || $this->NM_cmp_hidden['boni_value'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][$NM_cmp_tot['boni_value'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['tax_iric'][$Tipo_Sum]) && $Cada_cmp == "tax_iric" && (!isset($this->NM_cmp_hidden['tax_iric']) || $this->NM_cmp_hidden['tax_iric'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][$NM_cmp_tot['tax_iric'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['boni_net'][$Tipo_Sum]) && $Cada_cmp == "boni_net" && (!isset($this->NM_cmp_hidden['boni_net']) || $this->NM_cmp_hidden['boni_net'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['tot_geral'][$NM_cmp_tot['boni_net'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   function quebra_geral__NM_SC__bot()
   {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['boni_value'][$Tipo_Sum]) && $Cada_cmp == "boni_value" && (!isset($this->NM_cmp_hidden['boni_value']) || $this->NM_cmp_hidden['boni_value'] != "off"))
           {
               if ($Tipo_Sum == "C" || $Tipo_Sum == "D") {
                   $Format_Num = "#,##0";
               }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_boni_resume02']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
