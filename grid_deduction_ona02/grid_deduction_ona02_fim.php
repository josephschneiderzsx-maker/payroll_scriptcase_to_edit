...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_ona02"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_deduction_ona02"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_deduction_ona02</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_deduction_ona02']['embutida_filho'] as $ind => $sc_init)
          {
