  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_other_loan" == sTestField)
        {
...
?>
  ...
  function do_ajax_frm_other_loan_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_userid_int__cb);
  } // do_ajax_frm_other_loan_validate_userid_int_

  function do_ajax_frm_other_loan_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_frm_other_loan_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_employee_name__cb);
  } // do_ajax_frm_other_loan_validate_employee_name_

  function do_ajax_frm_other_loan_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_employee_name__cb

  // ---------- Validate dept_
  function do_ajax_frm_other_loan_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_dept__cb);
  } // do_ajax_frm_other_loan_validate_dept_

  function do_ajax_frm_other_loan_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_dept__cb

  // ---------- Validate other_loan_
  function do_ajax_frm_other_loan_validate_other_loan_(iNumLinha)
  {
    var nomeCampo_other_loan_ = "other_loan_" + iNumLinha;
    var var_other_loan_ = scAjaxGetFieldText(nomeCampo_other_loan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_other_loan_(var_other_loan_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_other_loan__cb);
  } // do_ajax_frm_other_loan_validate_other_loan_

  function do_ajax_frm_other_loan_validate_other_loan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "other_loan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "other_loan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "other_loan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "other_loan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_other_loan__cb

  // ---------- Validate date_other_loan_
  function do_ajax_frm_other_loan_validate_date_other_loan_(iNumLinha)
  {
    var nomeCampo_date_other_loan_ = "date_other_loan_" + iNumLinha;
    var var_date_other_loan_ = scAjaxGetFieldText(nomeCampo_date_other_loan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_date_other_loan_(var_date_other_loan_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_date_other_loan__cb);
  } // do_ajax_frm_other_loan_validate_date_other_loan_

  function do_ajax_frm_other_loan_validate_date_other_loan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "date_other_loan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "date_other_loan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "date_other_loan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "date_other_loan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_date_other_loan__cb

  // ---------- Validate other_loan_deduction_
  function do_ajax_frm_other_loan_validate_other_loan_deduction_(iNumLinha)
  {
    var nomeCampo_other_loan_deduction_ = "other_loan_deduction_" + iNumLinha;
    var var_other_loan_deduction_ = scAjaxGetFieldText(nomeCampo_other_loan_deduction_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_other_loan_deduction_(var_other_loan_deduction_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_other_loan_deduction__cb);
  } // do_ajax_frm_other_loan_validate_other_loan_deduction_

  function do_ajax_frm_other_loan_validate_other_loan_deduction__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "other_loan_deduction_" + iLineNumber;
    }
    else
    {
      sFieldValid = "other_loan_deduction_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "other_loan_deduction_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "other_loan_deduction_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_other_loan_deduction__cb

  // ---------- Validate other_loan_start_deduct_
  function do_ajax_frm_other_loan_validate_other_loan_start_deduct_(iNumLinha)
  {
    var nomeCampo_other_loan_start_deduct_ = "other_loan_start_deduct_" + iNumLinha;
    var var_other_loan_start_deduct_ = scAjaxGetFieldText(nomeCampo_other_loan_start_deduct_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_other_loan_start_deduct_(var_other_loan_start_deduct_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_other_loan_start_deduct__cb);
  } // do_ajax_frm_other_loan_validate_other_loan_start_deduct_

  function do_ajax_frm_other_loan_validate_other_loan_start_deduct__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "other_loan_start_deduct_" + iLineNumber;
    }
    else
    {
      sFieldValid = "other_loan_start_deduct_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "other_loan_start_deduct_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "other_loan_start_deduct_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_other_loan_start_deduct__cb

  // ---------- Validate other_loan_end_deduct_
  function do_ajax_frm_other_loan_validate_other_loan_end_deduct_(iNumLinha)
  {
    var nomeCampo_other_loan_end_deduct_ = "other_loan_end_deduct_" + iNumLinha;
    var var_other_loan_end_deduct_ = scAjaxGetFieldText(nomeCampo_other_loan_end_deduct_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_other_loan_end_deduct_(var_other_loan_end_deduct_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_other_loan_end_deduct__cb);
  } // do_ajax_frm_other_loan_validate_other_loan_end_deduct_

  function do_ajax_frm_other_loan_validate_other_loan_end_deduct__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "other_loan_end_deduct_" + iLineNumber;
    }
    else
    {
      sFieldValid = "other_loan_end_deduct_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "other_loan_end_deduct_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "other_loan_end_deduct_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_other_loan_end_deduct__cb

  // ---------- Validate apply_other_loan_deduction_
  function do_ajax_frm_other_loan_validate_apply_other_loan_deduction_(iNumLinha)
  {
    var nomeCampo_apply_other_loan_deduction_ = "apply_other_loan_deduction_" + iNumLinha;
    var var_apply_other_loan_deduction_ = scAjaxGetFieldSelect(nomeCampo_apply_other_loan_deduction_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_validate_apply_other_loan_deduction_(var_apply_other_loan_deduction_, iNumLinha, var_script_case_init, do_ajax_frm_other_loan_validate_apply_other_loan_deduction__cb);
  } // do_ajax_frm_other_loan_validate_apply_other_loan_deduction_

  function do_ajax_frm_other_loan_validate_apply_other_loan_deduction__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "apply_other_loan_deduction_" + iLineNumber;
    }
    else
    {
      sFieldValid = "apply_other_loan_deduction_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "apply_other_loan_deduction_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "apply_other_loan_deduction_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_other_loan_validate_apply_other_loan_deduction__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_frm_other_loan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_frm_other_loan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_frm_other_loan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_frm_other_loan_add_new_line_cb);
  } // do_ajax_frm_other_loan_add_new_line

  function do_ajax_frm_other_loan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_frm_other_loan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_frm_other_loan_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_other_loan_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_frm_other_loan_backup_line_cb);
  } // do_ajax_frm_other_loan_backup_line

  function do_ajax_frm_other_loan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_frm_other_loan_backup_line_cb

  function do_ajax_frm_other_loan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_frm_other_loan_cancel_insert

  function do_ajax_frm_other_loan_cancel_update(iSeqVert)
  {
    do_ajax_frm_other_loan_backup_line(iSeqVert);
...
?>
  } // do_ajax_frm_other_loan_cancel_update

  function do_ajax_frm_other_loan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_frm_other_loan_restore_buttons

  // ---------- table_refresh
  function do_ajax_frm_other_loan_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_frm_other_loan_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_other_loan_table_refresh_cb);
  } //  do_ajax_frm_other_loan_table_refresh

  function do_ajax_frm_other_loan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_frm_other_loan_table_refresh_cb_after_alert);
  } // do_ajax_frm_other_loan_table_refresh_cb
  function do_ajax_frm_other_loan_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_frm_other_loan_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_frm_other_loan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_frm_other_loan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_other_loan_ = scAjaxGetFieldText("other_loan_" + iNumLinha);
    var var_date_other_loan_ = scAjaxGetFieldText("date_other_loan_" + iNumLinha);
    var var_other_loan_deduction_ = scAjaxGetFieldText("other_loan_deduction_" + iNumLinha);
    var var_other_loan_start_deduct_ = scAjaxGetFieldText("other_loan_start_deduct_" + iNumLinha);
    var var_other_loan_end_deduct_ = scAjaxGetFieldText("other_loan_end_deduct_" + iNumLinha);
    var var_apply_other_loan_deduction_ = scAjaxGetFieldSelect("apply_other_loan_deduction_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_frm_other_loan_submit_form(var_userid_int_, var_employee_name_, var_dept_, var_other_loan_, var_date_other_loan_, var_other_loan_deduction_, var_other_loan_start_deduct_, var_other_loan_end_deduct_, var_apply_other_loan_deduction_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_other_loan_submit_form_cb);
  } // do_ajax_frm_other_loan_submit_form

  function do_ajax_frm_other_loan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("other_loan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("date_other_loan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("other_loan_deduction_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("other_loan_start_deduct_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("other_loan_end_deduct_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("apply_other_loan_deduction_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_frm_other_loan_submit_form_cb_after_alert);
  } // do_ajax_frm_other_loan_submit_form_cb
  function do_ajax_frm_other_loan_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_other_loan_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_other_loan_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_other_loan_navigate_form, function() {});
    } else {
      perform_ajax_frm_other_loan_navigate_form();
    }
  }

  function perform_ajax_frm_other_loan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("other_loan_" + iNavForm);
      scAjaxHideErrorDisplay("date_other_loan_" + iNavForm);
      scAjaxHideErrorDisplay("other_loan_deduction_" + iNavForm);
      scAjaxHideErrorDisplay("other_loan_start_deduct_" + iNavForm);
      scAjaxHideErrorDisplay("other_loan_end_deduct_" + iNavForm);
      scAjaxHideErrorDisplay("apply_other_loan_deduction_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_frm_other_loan_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_other_loan_navigate_form_cb);
  } // do_ajax_frm_other_loan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_other_loan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_other_loan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_other_loan_navigate_form_cb_after_alert);
  } // do_ajax_frm_other_loan_navigate_form_cb
  function do_ajax_frm_other_loan_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_frm_other_loan_navigate_form_cb_after_alert

    function sc_frm_other_loan_get_last_line_number()
    {
    ...
    } //sc_frm_other_loan_get_last_line_number

  function sc_hide_frm_other_loan_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "other_loan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "date_other_loan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "other_loan_deduction_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "other_loan_start_deduct_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "other_loan_end_deduct_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "apply_other_loan_deduction_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["employee_name_" + iNumLinha] = {"label": "Employee Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dept_" + iNumLinha] = {"label": "Department<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["other_loan_" + iNumLinha] = {"label": "Other Loan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["date_other_loan_" + iNumLinha] = {"label": "Loan Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["other_loan_deduction_" + iNumLinha] = {"label": "Deduction<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["other_loan_start_deduct_" + iNumLinha] = {"label": "Deduct Start Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["other_loan_end_deduct_" + iNumLinha] = {"label": "Deduct. End Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["apply_other_loan_deduction_" + iNumLinha] = {"label": "Enable<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["other_loan_"][iNumLinha] = "other_loan_" + iNumLinha;
    ajax_field_mult["date_other_loan_"][iNumLinha] = "date_other_loan_" + iNumLinha;
    ajax_field_mult["other_loan_deduction_"][iNumLinha] = "other_loan_deduction_" + iNumLinha;
    ajax_field_mult["other_loan_start_deduct_"][iNumLinha] = "other_loan_start_deduct_" + iNumLinha;
    ajax_field_mult["other_loan_end_deduct_"][iNumLinha] = "other_loan_end_deduct_" + iNumLinha;
    ajax_field_mult["apply_other_loan_deduction_"][iNumLinha] = "apply_other_loan_deduction_" + iNumLinha;
    ...
    ajax_field_id["other_loan_" + iNumLinha] = new Array("hidden_field_label_other_loan_", "hidden_field_data_other_loan_" + iNumLinha);
    ajax_field_id["date_other_loan_" + iNumLinha] = new Array("hidden_field_label_date_other_loan_", "hidden_field_data_date_other_loan_" + iNumLinha);
    ajax_field_id["other_loan_deduction_" + iNumLinha] = new Array("hidden_field_label_other_loan_deduction_", "hidden_field_data_other_loan_deduction_" + iNumLinha);
    ajax_field_id["other_loan_start_deduct_" + iNumLinha] = new Array("hidden_field_label_other_loan_start_deduct_", "hidden_field_data_other_loan_start_deduct_" + iNumLinha);
    ajax_field_id["other_loan_end_deduct_" + iNumLinha] = new Array("hidden_field_label_other_loan_end_deduct_", "hidden_field_data_other_loan_end_deduct_" + iNumLinha);
    ajax_field_id["apply_other_loan_deduction_" + iNumLinha] = new Array("hidden_field_label_apply_other_loan_deduction_", "hidden_field_data_apply_other_loan_deduction_" + iNumLinha);
    ...
    ajax_error_count["other_loan_" + iNumLinha] = "off";
    ajax_error_count["date_other_loan_" + iNumLinha] = "off";
    ajax_error_count["other_loan_deduction_" + iNumLinha] = "off";
    ajax_error_count["other_loan_start_deduct_" + iNumLinha] = "off";
    ajax_error_count["other_loan_end_deduct_" + iNumLinha] = "off";
    ajax_error_count["apply_other_loan_deduction_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["other_loan_" + iNumLinha] = "off";
    ajax_read_only["date_other_loan_" + iNumLinha] = "off";
    ajax_read_only["other_loan_deduction_" + iNumLinha] = "off";
    ajax_read_only["other_loan_start_deduct_" + iNumLinha] = "off";
    ajax_read_only["other_loan_end_deduct_" + iNumLinha] = "off";
    ajax_read_only["apply_other_loan_deduction_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["other_loan_" + iNumLinha] = "on";
    ajax_read_only["date_other_loan_" + iNumLinha] = "on";
    ajax_read_only["other_loan_deduction_" + iNumLinha] = "on";
    ajax_read_only["other_loan_start_deduct_" + iNumLinha] = "on";
    ajax_read_only["other_loan_end_deduct_" + iNumLinha] = "on";
    ajax_read_only["apply_other_loan_deduction_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["other_loan_" + iNumLinha] = null;
    ajax_error_list["date_other_loan_" + iNumLinha] = null;
    ajax_error_list["other_loan_deduction_" + iNumLinha] = null;
    ajax_error_list["other_loan_start_deduct_" + iNumLinha] = null;
    ajax_error_list["other_loan_end_deduct_" + iNumLinha] = null;
    ajax_error_list["apply_other_loan_deduction_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "other_loan_": new Array(),
    "date_other_loan_": new Array(),
    "other_loan_deduction_": new Array(),
    "other_loan_start_deduct_": new Array(),
    "other_loan_end_deduct_": new Array(),
    "apply_other_loan_deduction_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["other_loan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["other_loan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["other_loan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["other_loan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["other_loan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["date_other_loan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["date_other_loan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["date_other_loan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["date_other_loan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["date_other_loan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["other_loan_deduction_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["other_loan_deduction_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["other_loan_deduction_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["other_loan_deduction_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["other_loan_deduction_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["other_loan_start_deduct_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["other_loan_start_deduct_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["other_loan_start_deduct_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["other_loan_start_deduct_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["other_loan_start_deduct_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["other_loan_end_deduct_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["other_loan_end_deduct_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["other_loan_end_deduct_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["other_loan_end_deduct_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["other_loan_end_deduct_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["apply_other_loan_deduction_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["apply_other_loan_deduction_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["apply_other_loan_deduction_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["apply_other_loan_deduction_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["apply_other_loan_deduction_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['other_loan_'])) ? $this->nmgp_cmp_readonly['other_loan_'] : 'off';
?>
    scAjaxFieldRead("other_loan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['date_other_loan_'])) ? $this->nmgp_cmp_readonly['date_other_loan_'] : 'off';
?>
    scAjaxFieldRead("date_other_loan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['other_loan_deduction_'])) ? $this->nmgp_cmp_readonly['other_loan_deduction_'] : 'off';
?>
    scAjaxFieldRead("other_loan_deduction_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['other_loan_start_deduct_'])) ? $this->nmgp_cmp_readonly['other_loan_start_deduct_'] : 'off';
?>
    scAjaxFieldRead("other_loan_start_deduct_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['other_loan_end_deduct_'])) ? $this->nmgp_cmp_readonly['other_loan_end_deduct_'] : 'off';
?>
    scAjaxFieldRead("other_loan_end_deduct_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['apply_other_loan_deduction_'])) ? $this->nmgp_cmp_readonly['apply_other_loan_deduction_'] : 'off';
?>
    scAjaxFieldRead("apply_other_loan_deduction_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("other_loan_" + iSeq, "on");
    scAjaxFieldRead("date_other_loan_" + iSeq, "on");
    scAjaxFieldRead("other_loan_deduction_" + iSeq, "on");
    scAjaxFieldRead("other_loan_start_deduct_" + iSeq, "on");
    scAjaxFieldRead("other_loan_end_deduct_" + iSeq, "on");
    scAjaxFieldRead("apply_other_loan_deduction_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["other_loan_" + iRow] || "on" == ajax_error_count["date_other_loan_" + iRow] || "on" == ajax_error_count["other_loan_deduction_" + iRow] || "on" == ajax_error_count["other_loan_start_deduct_" + iRow] || "on" == ajax_error_count["other_loan_end_deduct_" + iRow] || "on" == ajax_error_count["apply_other_loan_deduction_" + iRow]))
    {
      ...
      $("#hidden_field_data_other_loan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_date_other_loan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_deduction_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_start_deduct_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_end_deduct_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_apply_other_loan_deduction_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["other_loan_" + iRow] && "off" == ajax_error_count["date_other_loan_" + iRow] && "off" == ajax_error_count["other_loan_deduction_" + iRow] && "off" == ajax_error_count["other_loan_start_deduct_" + iRow] && "off" == ajax_error_count["other_loan_end_deduct_" + iRow] && "off" == ajax_error_count["apply_other_loan_deduction_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["other_loan_" + iRow] = "off";
        ajax_error_count["date_other_loan_" + iRow] = "off";
        ajax_error_count["other_loan_deduction_" + iRow] = "off";
        ajax_error_count["other_loan_start_deduct_" + iRow] = "off";
        ajax_error_count["other_loan_end_deduct_" + iRow] = "off";
        ajax_error_count["apply_other_loan_deduction_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_other_loan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_date_other_loan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_deduction_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_start_deduct_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_other_loan_end_deduct_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_apply_other_loan_deduction_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("other_loan_deduction_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("other_loan_start_deduct_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("other_loan_end_deduct_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("apply_other_loan_deduction_" == sIndex)
    {
