...
function scHidePage(pageNo) {
        $("#id_frm_UpdatePayrollPeriode_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'frm_UpdatePayrollPeriode_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
