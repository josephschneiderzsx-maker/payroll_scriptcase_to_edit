...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_boni_details"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_qry_boni_details"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_qry_boni_details</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_qry_boni_details']['embutida_filho'] as $ind => $sc_init)
          {
