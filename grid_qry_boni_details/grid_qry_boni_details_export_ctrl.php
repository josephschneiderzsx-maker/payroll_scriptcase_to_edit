<?php
@session_start() ;
$_SESSION['scriptcase']['grid_qry_boni_details']['sc_process_barr'] = true;
require_once('../grid_qry_boni_details/index.php');
unset($_SESSION['scriptcase']['grid_qry_boni_details']['sc_process_barr']);
$ExportCtrl = new grid_qry_boni_details_export_control;
$ExportCtrl->Export_barr();

class grid_qry_boni_details_export_control
{
