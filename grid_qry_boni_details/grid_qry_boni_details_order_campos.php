...
<?php
   ...
   $Ord_Cmp = new grid_qry_boni_details_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_qry_boni_details_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["username"] : "Username";
   $tab_ger_campos['sal_brut_reg'] = "on";
   $tab_def_campos['sal_brut_reg'] = "sal_brut_reg";
   $tab_labels["sal_brut_reg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_brut_reg"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_brut_reg"] : "Sal Brut Reg";
   $tab_ger_campos['sal_suppl'] = "on";
   $tab_def_campos['sal_suppl'] = "sal_suppl";
   $tab_labels["sal_suppl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_suppl"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_suppl"] : "Sal Suppl";
   $tab_ger_campos['sal_holiday_worked_suppl'] = "on";
   $tab_def_campos['sal_holiday_worked_suppl'] = "sal_holiday_worked_suppl";
   $tab_labels["sal_holiday_worked_suppl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_holiday_worked_suppl"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_holiday_worked_suppl"] : "Sal Holiday Worked Suppl";
   $tab_ger_campos['sal_holiday_suppl'] = "on";
   $tab_def_campos['sal_holiday_suppl'] = "sal_holiday_suppl";
   $tab_labels["sal_holiday_suppl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_holiday_suppl"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["sal_holiday_suppl"] : "Sal Holiday Suppl";
   $tab_ger_campos['incentive'] = "on";
   $tab_def_campos['incentive'] = "incentive";
   $tab_labels["incentive"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["incentive"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["incentive"] : "Incentive";
   $tab_ger_campos['bank_number'] = "on";
   $tab_def_campos['bank_number'] = "bank_number";
   $tab_labels["bank_number"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["bank_number"])) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['labels']["bank_number"] : "Bank Number";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_qry_boni_details_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_qry_boni_details']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
