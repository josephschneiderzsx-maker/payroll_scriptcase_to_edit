...
class grid_qry_boni_details_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      { 
          ...
          require_once($this->Ini->path_aplicacao . "grid_qry_boni_details_res_csv.class.php");
          $this->Res = new grid_qry_boni_details_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_qry_boni_details']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_qry_boni_details']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_qry_boni_details']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_qry_boni_details']['csv_res_file']);
          }
          unlink($Arq_input);
