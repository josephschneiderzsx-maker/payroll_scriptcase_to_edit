...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_resume_deduction"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_resume_deduction"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_resume_deduction</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_resume_deduction']['embutida_filho'] as $ind => $sc_init)
          {
