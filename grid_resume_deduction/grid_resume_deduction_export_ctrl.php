<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resume_deduction']['sc_process_barr'] = true;
require_once('../grid_resume_deduction/index.php');
unset($_SESSION['scriptcase']['grid_resume_deduction']['sc_process_barr']);
$ExportCtrl = new grid_resume_deduction_export_control;
$ExportCtrl->Export_barr();

class grid_resume_deduction_export_control
{
