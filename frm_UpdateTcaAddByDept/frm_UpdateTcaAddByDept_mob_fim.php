...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_outra_jan'])
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['Refresh_aba_menu']) && !empty($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['Refresh_aba_menu'])) {
...
?>
       parent.del_aba_td('frm_UpdateTcaAddByDept_mob');
   } 
   else 
   { 
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['frm_UpdateTcaAddByDept_mob']['embutida_filho'] as $ind => $sc_init)
          {
