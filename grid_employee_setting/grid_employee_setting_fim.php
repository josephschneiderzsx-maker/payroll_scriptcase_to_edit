...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_employee_setting"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_employee_setting"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_employee_setting'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_employee_setting</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_employee_setting']['embutida_filho'] as $ind => $sc_init)
          {
