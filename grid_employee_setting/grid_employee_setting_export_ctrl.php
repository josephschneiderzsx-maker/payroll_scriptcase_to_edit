<?php
@session_start() ;
$_SESSION['scriptcase']['grid_employee_setting']['sc_process_barr'] = true;
require_once('../grid_employee_setting/index.php');
unset($_SESSION['scriptcase']['grid_employee_setting']['sc_process_barr']);
$ExportCtrl = new grid_employee_setting_export_control;
$ExportCtrl->Export_barr();

class grid_employee_setting_export_control
{
