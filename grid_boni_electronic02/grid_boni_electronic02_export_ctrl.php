<?php
@session_start() ;
$_SESSION['scriptcase']['grid_boni_electronic02']['sc_process_barr'] = true;
require_once('../grid_boni_electronic02/index.php');
unset($_SESSION['scriptcase']['grid_boni_electronic02']['sc_process_barr']);
$ExportCtrl = new grid_boni_electronic02_export_control;
$ExportCtrl->Export_barr();

class grid_boni_electronic02_export_control
{
