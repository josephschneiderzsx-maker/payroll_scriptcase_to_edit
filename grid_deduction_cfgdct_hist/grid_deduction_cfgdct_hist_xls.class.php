...
class grid_deduction_cfgdct_hist_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_deduction_cfgdct_hist/grid_deduction_cfgdct_hist_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_deduction_cfgdct_hist_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_deduction_cfgdct_hist.zip";
          $this->Arquivo   .= "_grid_deduction_cfgdct_hist" . $this->Xls_tp;
          $this->Tit_doc    = "grid_deduction_cfgdct_hist" . $this->Xls_tp;
          $this->Tit_zip    = "grid_deduction_cfgdct_hist.zip";
      ...
      {
          $this->sum_sal_brut_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][2];
          $this->sum_tax_cfgdct = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][3];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          $this->sum_sal_brut_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][2];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->hiring_duration = $rs->fields[8] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "hiring_duration" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   //----- hiring_duration
   function NM_export_hiring_duration()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->hiring_duration = NM_charset_to_utf8($this->hiring_duration);
         if (is_numeric($this->hiring_duration))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->hiring_duration);
         $this->Xls_col++;
   }
   //----- dept
   ...
   //----- hiring_duration
   function NM_sub_cons_hiring_duration()
   {
         $this->hiring_duration = NM_charset_to_utf8($this->hiring_duration);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->hiring_duration;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['nolabel'])
       {
 ...
 function quebra_dept_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['sal_brut_reg'][$Tipo_Sum]) && $Cada_cmp == "sal_brut_reg" && (!isset($this->NM_cmp_hidden['sal_brut_reg']) || $this->NM_cmp_hidden['sal_brut_reg'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][$NM_cmp_tot['sal_brut_reg'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['tax_cfgdct'][$Tipo_Sum]) && $Cada_cmp == "tax_cfgdct" && (!isset($this->NM_cmp_hidden['tax_cfgdct']) || $this->NM_cmp_hidden['tax_cfgdct'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['tot_geral'][$NM_cmp_tot['tax_cfgdct'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>DEDUCTION CFGDCT HISTORIZED :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_deduction_cfgdct_hist']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
