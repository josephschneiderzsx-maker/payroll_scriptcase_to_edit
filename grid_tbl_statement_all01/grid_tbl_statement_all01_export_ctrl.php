<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbl_statement_all01']['sc_process_barr'] = true;
require_once('../grid_tbl_statement_all01/index.php');
unset($_SESSION['scriptcase']['grid_tbl_statement_all01']['sc_process_barr']);
$ExportCtrl = new grid_tbl_statement_all01_export_control;
$ExportCtrl->Export_barr();

class grid_tbl_statement_all01_export_control
{
