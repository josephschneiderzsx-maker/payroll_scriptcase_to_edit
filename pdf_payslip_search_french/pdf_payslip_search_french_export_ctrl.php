<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_payslip_search_french']['sc_process_barr'] = true;
require_once('../pdf_payslip_search_french/index.php');
unset($_SESSION['scriptcase']['pdf_payslip_search_french']['sc_process_barr']);
$ExportCtrl = new pdf_payslip_search_french_export_control;
$ExportCtrl->Export_barr();

class pdf_payslip_search_french_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> tbl_salary</TITLE>
