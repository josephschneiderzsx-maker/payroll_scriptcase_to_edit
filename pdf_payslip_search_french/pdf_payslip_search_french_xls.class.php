...
class pdf_payslip_search_french_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   {
                       $_SESSION['sc_session'][$script_case_init]['pdf_payslip_search_french']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdf_payslip_search_french/pdf_payslip_search_french_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new pdf_payslip_search_french_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdf_payslip_search_french.zip";
          $this->Arquivo   .= "_pdf_payslip_search_french" . $this->Xls_tp;
          $this->Tit_doc    = "pdf_payslip_search_french" . $this->Xls_tp;
          $this->Tit_zip    = "pdf_payslip_search_french.zip";
      ...
      require_once($this->Ini->path_aplicacao . "pdf_payslip_search_french_total.class.php"); 
      $this->Tot = new pdf_payslip_search_french_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   function NM_export_rate_work()
   {
      ...
      {
             $conteudo = str_replace($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['decimal_db'], "", $conteudo); 
   ...
   function NM_export_rate_cons()
   {
         ...
         if (is_numeric($this->rate_cons))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->rate_cons);
         $this->Xls_col++;
   }
   ...
   function NM_export_sc_field_21()
   {
      ...
      if (!empty($this->sc_field_21))
      {
             if ($this->sc_field_21 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_21, "Jour régulier"); 
             } 
      }
   ...
   function NM_export_sc_field_22()
   {
      ...
      if (!empty($this->sc_field_22))
      {
             if ($this->sc_field_22 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_22, "Gain congés"); 
             } 
      }
   ...
   function NM_export_lbl_restday()
   {
      ...
      if (!empty($this->lbl_restday))
      {
             if ($this->lbl_restday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_restday, "Jour repos"); 
             } 
      }
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search_french']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
