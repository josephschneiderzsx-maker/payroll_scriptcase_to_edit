...
<?php
   ...
   $Ord_Cmp = new grid_tbl_batch_boni_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_batch_boni_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['boni_code'] = "boni_code";
   $tab_labels["boni_code"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["boni_code"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["boni_code"] : "Boni Code";
   $tab_ger_campos['boni_description'] = "on";
   $tab_def_campos['boni_description'] = "boni_description";
   $tab_labels["boni_description"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["boni_description"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["boni_description"] : "Boni Description";
   $tab_ger_campos['date_debut'] = "on";
   $tab_def_campos['date_debut'] = "date_debut";
   $tab_labels["date_debut"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["date_debut"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["date_debut"] : "Date Debut";
   $tab_ger_campos['date_fin'] = "on";
   $tab_def_campos['date_fin'] = "date_fin";
   $tab_labels["date_fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["date_fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['labels']["date_fin"] : "Date Fin";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbl_batch_boni_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbl_batch_boni']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
