...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_batch_boni"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_tbl_batch_boni"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_batch_boni02'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tbl_batch_boni</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_batch_boni']['embutida_filho'] as $ind => $sc_init)
          {
