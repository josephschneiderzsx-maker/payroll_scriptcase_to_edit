<?php
@session_start() ;
$_SESSION['scriptcase']['grid_boni_details03']['sc_process_barr'] = true;
require_once('../grid_boni_details03/index.php');
unset($_SESSION['scriptcase']['grid_boni_details03']['sc_process_barr']);
$ExportCtrl = new grid_boni_details03_export_control;
$ExportCtrl->Export_barr();

class grid_boni_details03_export_control
{
