...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_offday_Hist"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____grid_income_offday_Hist"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_income_offday_Hist</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_income_offday_Hist']['embutida_filho'] as $ind => $sc_init)
          {
