...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____pdf_boni_payslipsearch"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____pdf_boni_payslipsearch"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pdf_boni_payslipsearch</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['embutida_filho'] as $ind => $sc_init)
          {
