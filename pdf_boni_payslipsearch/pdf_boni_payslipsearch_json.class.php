...
class pdf_boni_payslipsearch_json
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "pdf_boni_payslipsearch/pdf_boni_payslipsearch_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_return']);
      ...
      $this->Arquivo     .= "_pdf_boni_payslipsearch";
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "pdf_boni_payslipsearch.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              $this->Res = new pdf_boni_payslipsearch_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_res_grid']);
          } 
      }
   ...
   function NM_export_lbl_payperiod()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_payperiod;
   }
   //----- lbl_amount01
   ...
   function NM_export_lbl_amount02()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_amount02;
   }
   //----- lbl_companyname
   ...
   function NM_export_lbl_designation()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_designation;
   }
   //----- lbl_earning
   ...
   function NM_export_lbl_hiredate()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_hiredate;
   }
   //----- lbl_id
   function NM_export_lbl_id()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_id;
   }
   //----- lbl_incentive
   function NM_export_lbl_incentive()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_incentive;
   }
   //----- lbl_line01
   ...
   function NM_export_lbl_otvalue()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->lbl_otvalue;
   }
   //----- lbl_payslip
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
