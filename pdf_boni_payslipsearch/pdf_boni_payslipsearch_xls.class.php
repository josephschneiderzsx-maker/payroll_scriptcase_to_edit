...
class pdf_boni_payslipsearch_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   {
                       $_SESSION['sc_session'][$script_case_init]['pdf_boni_payslipsearch']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdf_boni_payslipsearch/pdf_boni_payslipsearch_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new pdf_boni_payslipsearch_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdf_boni_payslipsearch.zip";
          $this->Arquivo   .= "_pdf_boni_payslipsearch" . $this->Xls_tp;
          $this->Tit_doc    = "pdf_boni_payslipsearch" . $this->Xls_tp;
          $this->Tit_zip    = "pdf_boni_payslipsearch.zip";
      ...
      require_once($this->Ini->path_aplicacao . "pdf_boni_payslipsearch_total.class.php"); 
      $this->Tot = new pdf_boni_payslipsearch_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['field_order'] as $Cada_cmp)
      {
      ...
      { 
          ...
          $this->boni_value = (isset($Busca_temp['boni_value'])) ? $Busca_temp['boni_value'] : ""; 
          $tmp_pos = (is_string($this->boni_value)) ? strpos($this->boni_value, "##@@") : false;
          if ($tmp_pos !== false && !is_array($this->boni_value))
          {
              $this->boni_value = substr($this->boni_value, 0, $tmp_pos);
          }
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   function NM_export_boni_value()
   {
         ...
         if (is_numeric($this->boni_value))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->boni_value);
         $this->Xls_col++;
   }
   //----- tax_iric
   ...
   function NM_export_boni_net()
   {
         ...
         if (is_numeric($this->boni_net))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->boni_net);
         $this->Xls_col++;
   }
   //----- lbl_payperiod
   function NM_export_lbl_payperiod()
   {
      ...
      if (!empty($this->lbl_payperiod))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_payperiod, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_payperiod, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_amount01
   ...
   function NM_export_lbl_amount02()
   {
      ...
      if (!empty($this->lbl_amount02))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_amount02, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_amount02, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_companyname
   ...
   function NM_export_lbl_designation()
   {
      ...
      if (!empty($this->lbl_designation))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_designation, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_designation, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_earning
   ...
   function NM_export_lbl_hiredate()
   {
      ...
      if (!empty($this->lbl_hiredate))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_hiredate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_hiredate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_id
   function NM_export_lbl_id()
   {
      ...
      if (!empty($this->lbl_id))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_id, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_id, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_incentive
   function NM_export_lbl_incentive()
   {
      ...
      if (!empty($this->lbl_incentive))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_incentive, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_incentive, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_line01
   ...
   function NM_export_lbl_otvalue()
   {
      ...
      if (!empty($this->lbl_otvalue))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_otvalue, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_otvalue, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_payslip
   function NM_export_lbl_payslip()
   {
      ...
      if (!empty($this->lbl_payslip))
      {
             ...
             if ($this->lbl_payslip !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_payslip, "BONI PAYSLIP REPRINT"); 
             } 
      }
   ...
   //----- boni_value
   function NM_sub_cons_boni_value()
   {
         $this->boni_value = NM_charset_to_utf8($this->boni_value);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->boni_value;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- boni_net
   function NM_sub_cons_boni_net()
   {
         $this->boni_net = NM_charset_to_utf8($this->boni_net);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->boni_net;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- lbl_payperiod
   function NM_sub_cons_lbl_payperiod()
   {
      if (!empty($this->lbl_payperiod))
      {
         if ($this->lbl_payperiod !== "&nbsp;") 
         ...
         $this->lbl_payperiod = html_entity_decode($this->lbl_payperiod, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_payperiod = NM_charset_to_utf8($this->lbl_payperiod);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_payperiod;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_amount02
   function NM_sub_cons_lbl_amount02()
   {
      if (!empty($this->lbl_amount02))
      {
         if ($this->lbl_amount02 !== "&nbsp;") 
         ...
         $this->lbl_amount02 = html_entity_decode($this->lbl_amount02, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_amount02 = NM_charset_to_utf8($this->lbl_amount02);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_amount02;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_designation
   function NM_sub_cons_lbl_designation()
   {
      if (!empty($this->lbl_designation))
      {
         if ($this->lbl_designation !== "&nbsp;") 
         ...
         $this->lbl_designation = html_entity_decode($this->lbl_designation, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_designation = NM_charset_to_utf8($this->lbl_designation);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_designation;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_hiredate
   function NM_sub_cons_lbl_hiredate()
   {
      if (!empty($this->lbl_hiredate))
      {
         if ($this->lbl_hiredate !== "&nbsp;") 
         ...
         $this->lbl_hiredate = html_entity_decode($this->lbl_hiredate, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_hiredate = NM_charset_to_utf8($this->lbl_hiredate);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_hiredate;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_lbl_id()
   {
      if (!empty($this->lbl_id))
      {
         ...
         $this->lbl_id = html_entity_decode($this->lbl_id, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_id = NM_charset_to_utf8($this->lbl_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_incentive
   function NM_sub_cons_lbl_incentive()
   {
      if (!empty($this->lbl_incentive))
      {
         if ($this->lbl_incentive !== "&nbsp;") 
         ...
         $this->lbl_incentive = html_entity_decode($this->lbl_incentive, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_incentive = NM_charset_to_utf8($this->lbl_incentive);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_incentive;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_otvalue
   function NM_sub_cons_lbl_otvalue()
   {
      if (!empty($this->lbl_otvalue))
      {
         if ($this->lbl_otvalue !== "&nbsp;") 
         ...
         $this->lbl_otvalue = html_entity_decode($this->lbl_otvalue, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_otvalue = NM_charset_to_utf8($this->lbl_otvalue);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_otvalue;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_boni_payslipsearch']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
