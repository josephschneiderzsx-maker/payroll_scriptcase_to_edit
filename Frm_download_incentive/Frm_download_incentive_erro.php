...
$old_error_handler = set_error_handler("Frm_download_incentive_scriptcase_error_handler");

function Frm_download_incentive_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['Frm_download_incentive']['contr_erro']) && $_SESSION['scriptcase']['Frm_download_incentive']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Frm_download_incentive->contr_Frm_download_incentive->Apl_com_erro = true;
            if ($inicial_Frm_download_incentive->contr_Frm_download_incentive->NM_ajax_flag)
            {
                $inicial_Frm_download_incentive->contr_Frm_download_incentive->NM_ajax_info['errList']['geral_Frm_download_incentive'][] = $msg;
                return;
            }
            Frm_download_incentive_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Frm_download_incentive_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Frm_download_incentive'])  && '' != $_SESSION['scriptcase']['error_icon']['Frm_download_incentive'])  ? $_SESSION['scriptcase']['error_icon']['Frm_download_incentive']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Frm_download_incentive']) && '' != $_SESSION['scriptcase']['error_close']['Frm_download_incentive']) ? $_SESSION['scriptcase']['error_close']['Frm_download_incentive'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Frm_download_incentive']) && '' != $_SESSION['scriptcase']['error_span_title']['Frm_download_incentive']) ? $_SESSION['scriptcase']['error_span_title']['Frm_download_incentive'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Frm_download_incentive']) && '' != $_SESSION['scriptcase']['error_icon_title']['Frm_download_incentive']) ? $_SESSION['scriptcase']['error_icon_title']['Frm_download_incentive'] : '';
?>
