<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tbl_ONA02']['sc_process_barr'] = true;
require_once('../grid_tbl_ONA02/index.php');
unset($_SESSION['scriptcase']['grid_tbl_ONA02']['sc_process_barr']);
$ExportCtrl = new grid_tbl_ONA02_export_control;
$ExportCtrl->Export_barr();

class grid_tbl_ONA02_export_control
{
