<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_tbl_ONA02']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_tbl_ONA02_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tbl_ONA02_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["userid_int"] : "ID";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["username"] : "Employee Name";
   $tab_ger_campos['pay_startdate'] = "on";
   $tab_def_campos['pay_startdate'] = "pay_startdate";
   $tab_labels["pay_startdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["pay_startdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["pay_startdate"] : "Start Date";
   $tab_ger_campos['pay_enddate'] = "on";
   $tab_def_campos['pay_enddate'] = "pay_enddate";
   $tab_labels["pay_enddate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["pay_enddate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["pay_enddate"] : "End Date";
   $tab_ger_campos['hiredate'] = "on";
   $tab_def_campos['hiredate'] = "hiredate";
   $tab_labels["hiredate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["hiredate"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["hiredate"] : "Hiredate";
   $tab_ger_campos['hiring_duration'] = "on";
   $tab_def_campos['hiring_duration'] = "hiring_duration";
   $tab_labels["hiring_duration"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["hiring_duration"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["hiring_duration"] : "Hiring (month)";
   $tab_ger_campos['sal_brut_reg'] = "on";
   $tab_def_campos['sal_brut_reg'] = "sal_brut_reg";
   $tab_labels["sal_brut_reg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["sal_brut_reg"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["sal_brut_reg"] : "Reg Gross Income";
   $tab_ger_campos['tax_ona'] = "on";
   $tab_def_campos['tax_ona'] = "tax_ona";
   $tab_labels["tax_ona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona"] : "ONA Employee";
   $tab_ger_campos['tax_ona_company'] = "on";
   $tab_def_campos['tax_ona_company'] = "tax_ona_company";
   $tab_labels["tax_ona_company"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona_company"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona_company"] : "ONA Company";
   $tab_ger_campos['tax_ona_cotisation'] = "on";
   $tab_def_campos['tax_ona_cotisation'] = "tax_ona_cotisation";
   $tab_labels["tax_ona_cotisation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona_cotisation"])) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['labels']["tax_ona_cotisation"] : "ONA Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tbl_ONA02_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tbl_ONA02']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
