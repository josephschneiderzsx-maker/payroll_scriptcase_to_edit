...
class pdf_attslip_all_res_csv
{
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".csv";
      $this->Tit_doc       = "pdf_attslip_all.csv";
      $this->Tit_zip       = "pdf_attslip_all.zip";
      $this->Label_CSV     = "N";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_name']);
      }
      $this->Res           = new pdf_attslip_all_resumo("out");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['pivot_tabular'];
      if (1 >= sizeof($this->comp_y_axys))
      {
        ...
        if ('S' == $this->Label_CSV) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['pdf_attslip_all'] ['export_info'] ['ordered_x_matrix'] as $rowNumber => $rowInfo) {
            }
        }

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['pdf_attslip_all'] ['export_data'] as $exportRowInfo) {
            $csvLine = [];
            ...
            for ($i = $dimensionCount; $i < $_SESSION['sc_session'] [$this->Ini->sc_page] ['pdf_attslip_all'] ['export_info'] ['dimension_count'] ['y']; $i++) {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_file'] = $this->Csv_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
