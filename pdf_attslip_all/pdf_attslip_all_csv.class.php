   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      { 
          ...
          $this->Res = new pdf_attslip_all_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_attslip_all']['csv_res_file']);
          }
          unlink($Arq_input);
