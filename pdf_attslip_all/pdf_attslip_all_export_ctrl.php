<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_attslip_all']['sc_process_barr'] = true;
require_once('../pdf_attslip_all/index.php');
unset($_SESSION['scriptcase']['pdf_attslip_all']['sc_process_barr']);
$ExportCtrl = new pdf_attslip_all_export_control;
$ExportCtrl->Export_barr();

class pdf_attslip_all_export_control
{
