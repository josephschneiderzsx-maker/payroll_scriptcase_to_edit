  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_payment_employee" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_frm_payment_employee_form();
        }
...
?>
  ...
  function do_ajax_frm_payment_employee_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_userid_int__cb);
  } // do_ajax_frm_payment_employee_validate_userid_int_

  function do_ajax_frm_payment_employee_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_frm_payment_employee_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_employee_name__cb);
  } // do_ajax_frm_payment_employee_validate_employee_name_

  function do_ajax_frm_payment_employee_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_employee_name__cb

  // ---------- Validate dept_
  function do_ajax_frm_payment_employee_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_dept__cb);
  } // do_ajax_frm_payment_employee_validate_dept_

  function do_ajax_frm_payment_employee_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_dept__cb

  // ---------- Validate date_payment_
  function do_ajax_frm_payment_employee_validate_date_payment_(iNumLinha)
  {
    var nomeCampo_date_payment_ = "date_payment_" + iNumLinha;
    var var_date_payment_ = scAjaxGetFieldText(nomeCampo_date_payment_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_date_payment_(var_date_payment_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_date_payment__cb);
  } // do_ajax_frm_payment_employee_validate_date_payment_

  function do_ajax_frm_payment_employee_validate_date_payment__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "date_payment_" + iLineNumber;
    }
    else
    {
      sFieldValid = "date_payment_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "date_payment_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "date_payment_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_date_payment__cb

  // ---------- Validate payment_
  function do_ajax_frm_payment_employee_validate_payment_(iNumLinha)
  {
    var nomeCampo_payment_ = "payment_" + iNumLinha;
    var var_payment_ = scAjaxGetFieldText(nomeCampo_payment_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_payment_(var_payment_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_payment__cb);
  } // do_ajax_frm_payment_employee_validate_payment_

  function do_ajax_frm_payment_employee_validate_payment__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "payment_" + iLineNumber;
    }
    else
    {
      sFieldValid = "payment_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "payment_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "payment_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_payment__cb

  // ---------- Validate payment_receipt_
  function do_ajax_frm_payment_employee_validate_payment_receipt_(iNumLinha)
  {
    var nomeCampo_payment_receipt_ = "payment_receipt_" + iNumLinha;
    var var_payment_receipt_ = scAjaxGetFieldText(nomeCampo_payment_receipt_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_validate_payment_receipt_(var_payment_receipt_, iNumLinha, var_script_case_init, do_ajax_frm_payment_employee_validate_payment_receipt__cb);
  } // do_ajax_frm_payment_employee_validate_payment_receipt_

  function do_ajax_frm_payment_employee_validate_payment_receipt__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "payment_receipt_" + iLineNumber;
    }
    else
    {
      sFieldValid = "payment_receipt_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "payment_receipt_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "payment_receipt_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_payment_employee_validate_payment_receipt__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_frm_payment_employee_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_frm_payment_employee_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_frm_payment_employee_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_frm_payment_employee_add_new_line_cb);
  } // do_ajax_frm_payment_employee_add_new_line

  function do_ajax_frm_payment_employee_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_frm_payment_employee_add_new_line_cb

  // ---------- backup_line
  function do_ajax_frm_payment_employee_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_payment_employee_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_frm_payment_employee_backup_line_cb);
  } // do_ajax_frm_payment_employee_backup_line

  function do_ajax_frm_payment_employee_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_frm_payment_employee_backup_line_cb

  function do_ajax_frm_payment_employee_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_frm_payment_employee_cancel_insert

  function do_ajax_frm_payment_employee_cancel_update(iSeqVert)
  {
    do_ajax_frm_payment_employee_backup_line(iSeqVert);
...
?>
  } // do_ajax_frm_payment_employee_cancel_update

  function do_ajax_frm_payment_employee_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_frm_payment_employee_restore_buttons

  // ---------- table_refresh
  function do_ajax_frm_payment_employee_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_frm_payment_employee_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_payment_employee_table_refresh_cb);
  } //  do_ajax_frm_payment_employee_table_refresh

  function do_ajax_frm_payment_employee_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_frm_payment_employee_table_refresh_cb_after_alert);
  } // do_ajax_frm_payment_employee_table_refresh_cb
  function do_ajax_frm_payment_employee_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_frm_payment_employee_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_frm_payment_employee_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_frm_payment_employee_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_date_payment_ = scAjaxGetFieldText("date_payment_" + iNumLinha);
    var var_payment_ = scAjaxGetFieldText("payment_" + iNumLinha);
    var var_payment_receipt_ = scAjaxGetFieldText("payment_receipt_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_frm_payment_employee_submit_form(var_userid_int_, var_employee_name_, var_dept_, var_date_payment_, var_payment_, var_payment_receipt_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_payment_employee_submit_form_cb);
  } // do_ajax_frm_payment_employee_submit_form

  function do_ajax_frm_payment_employee_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("date_payment_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("payment_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("payment_receipt_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_frm_payment_employee_submit_form_cb_after_alert);
  } // do_ajax_frm_payment_employee_submit_form_cb
  function do_ajax_frm_payment_employee_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_payment_employee_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_payment_employee_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_payment_employee_navigate_form, function() {});
    } else {
      perform_ajax_frm_payment_employee_navigate_form();
    }
  }

  function perform_ajax_frm_payment_employee_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("date_payment_" + iNavForm);
      scAjaxHideErrorDisplay("payment_" + iNavForm);
      scAjaxHideErrorDisplay("payment_receipt_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_frm_payment_employee_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_frm_payment_employee_navigate_form_cb);
  } // do_ajax_frm_payment_employee_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_payment_employee']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_payment_employee_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_payment_employee_navigate_form_cb_after_alert);
  } // do_ajax_frm_payment_employee_navigate_form_cb
  function do_ajax_frm_payment_employee_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_frm_payment_employee_navigate_form_cb_after_alert

    function sc_frm_payment_employee_get_last_line_number()
    {
    ...
    } //sc_frm_payment_employee_get_last_line_number

  function sc_hide_frm_payment_employee_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "date_payment_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "payment_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "payment_receipt_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["date_payment_" + iNumLinha] = {"label": "Date Payment<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["payment_" + iNumLinha] = {"label": "Payment<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["payment_receipt_" + iNumLinha] = {"label": "Payment Receipt Number<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["date_payment_"][iNumLinha] = "date_payment_" + iNumLinha;
    ajax_field_mult["payment_"][iNumLinha] = "payment_" + iNumLinha;
    ajax_field_mult["payment_receipt_"][iNumLinha] = "payment_receipt_" + iNumLinha;
    ...
    ajax_field_id["date_payment_" + iNumLinha] = new Array("hidden_field_label_date_payment_", "hidden_field_data_date_payment_" + iNumLinha);
    ajax_field_id["payment_" + iNumLinha] = new Array("hidden_field_label_payment_", "hidden_field_data_payment_" + iNumLinha);
    ajax_field_id["payment_receipt_" + iNumLinha] = new Array("hidden_field_label_payment_receipt_", "hidden_field_data_payment_receipt_" + iNumLinha);
    ...
    ajax_error_count["date_payment_" + iNumLinha] = "off";
    ajax_error_count["payment_" + iNumLinha] = "off";
    ajax_error_count["payment_receipt_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["date_payment_" + iNumLinha] = "off";
    ajax_read_only["payment_" + iNumLinha] = "off";
    ajax_read_only["payment_receipt_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["date_payment_" + iNumLinha] = "on";
    ajax_read_only["payment_" + iNumLinha] = "on";
    ajax_read_only["payment_receipt_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["date_payment_" + iNumLinha] = null;
    ajax_error_list["payment_" + iNumLinha] = null;
    ajax_error_list["payment_receipt_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "date_payment_": new Array(),
    "payment_": new Array(),
    "payment_receipt_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["date_payment_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["date_payment_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["date_payment_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["date_payment_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["date_payment_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["payment_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["payment_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["payment_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["payment_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["payment_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["payment_receipt_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["payment_receipt_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["payment_receipt_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["payment_receipt_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["payment_receipt_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['date_payment_'])) ? $this->nmgp_cmp_readonly['date_payment_'] : 'off';
?>
    scAjaxFieldRead("date_payment_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['payment_'])) ? $this->nmgp_cmp_readonly['payment_'] : 'off';
?>
    scAjaxFieldRead("payment_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['payment_receipt_'])) ? $this->nmgp_cmp_readonly['payment_receipt_'] : 'off';
?>
    scAjaxFieldRead("payment_receipt_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("date_payment_" + iSeq, "on");
    scAjaxFieldRead("payment_" + iSeq, "on");
    scAjaxFieldRead("payment_receipt_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["date_payment_" + iRow] || "on" == ajax_error_count["payment_" + iRow] || "on" == ajax_error_count["payment_receipt_" + iRow]))
    {
      ...
      $("#hidden_field_data_date_payment_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_payment_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_payment_receipt_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["date_payment_" + iRow] && "off" == ajax_error_count["payment_" + iRow] && "off" == ajax_error_count["payment_receipt_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["date_payment_" + iRow] = "off";
        ajax_error_count["payment_" + iRow] = "off";
        ajax_error_count["payment_receipt_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_date_payment_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_payment_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_payment_receipt_" + iRow).removeClass("scFormErrorLine");
    }
  }
