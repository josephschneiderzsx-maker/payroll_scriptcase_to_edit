  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_UpdateOTRestdayFactorByDept_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_frm_UpdateOTRestdayFactorByDept_mob_form();
        }
...
?>
  ...
  // ---------- Validate sc_field_2
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2()
  {
    var nomeCampo_sc_field_2 = "sc_field_2";
    var var_sc_field_2 = scAjaxGetFieldText(nomeCampo_sc_field_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2(var_sc_field_2, var_script_case_init, do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2_cb);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2

  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_2_cb

  // ---------- Validate sc_field_1
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1_cb);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1

  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_1_cb

  // ---------- Validate sc_field_0
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0_cb);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0

  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_validate_sc_field_0_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form(var_sc_field_2, var_sc_field_1, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form

  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb_after_alert);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form, function() {});
    } else {
      perform_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form();
    }
  }

  function perform_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_UpdateOTRestdayFactorByDept_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form_cb_after_alert);
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form_cb
  function do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_frm_UpdateOTRestdayFactorByDept_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_frm_UpdateOTRestdayFactorByDept_mob_navigate_form_cb_after_alert

  function sc_hide_frm_UpdateOTRestdayFactorByDept_mob_form()
  {
