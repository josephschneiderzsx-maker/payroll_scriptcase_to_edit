  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_batch_boni_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_tbl_batch_boni_mob_form();
        }
...
?>
  ...
  // ---------- Validate boni_code
  function do_ajax_form_tbl_batch_boni_mob_validate_boni_code()
  {
    var nomeCampo_boni_code = "boni_code";
    var var_boni_code = scAjaxGetFieldText(nomeCampo_boni_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_boni_mob_validate_boni_code(var_boni_code, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_validate_boni_code_cb);
  } // do_ajax_form_tbl_batch_boni_mob_validate_boni_code

  function do_ajax_form_tbl_batch_boni_mob_validate_boni_code_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_boni_mob_validate_boni_code_cb

  // ---------- Validate blank01
  function do_ajax_form_tbl_batch_boni_mob_validate_blank01()
  {
    var nomeCampo_blank01 = "blank01";
    var var_blank01 = scAjaxGetFieldText(nomeCampo_blank01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_boni_mob_validate_blank01(var_blank01, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_validate_blank01_cb);
  } // do_ajax_form_tbl_batch_boni_mob_validate_blank01

  function do_ajax_form_tbl_batch_boni_mob_validate_blank01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "blank01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_boni_mob_validate_blank01_cb

  // ---------- Validate boni_description
  function do_ajax_form_tbl_batch_boni_mob_validate_boni_description()
  {
    var nomeCampo_boni_description = "boni_description";
    var var_boni_description = scAjaxGetFieldText(nomeCampo_boni_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_boni_mob_validate_boni_description(var_boni_description, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_validate_boni_description_cb);
  } // do_ajax_form_tbl_batch_boni_mob_validate_boni_description

  function do_ajax_form_tbl_batch_boni_mob_validate_boni_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_boni_mob_validate_boni_description_cb

  // ---------- Validate date_debut
  function do_ajax_form_tbl_batch_boni_mob_validate_date_debut()
  {
    ...
    setTimeout(function() {
      var var_date_debut = scAjaxGetFieldText(nomeCampo_date_debut);
      x_ajax_form_tbl_batch_boni_mob_validate_date_debut(var_date_debut, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_validate_date_debut_cb);
    }, 200);
  } // do_ajax_form_tbl_batch_boni_mob_validate_date_debut

  function do_ajax_form_tbl_batch_boni_mob_validate_date_debut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_boni_mob_validate_date_debut_cb

  // ---------- Validate date_fin
  function do_ajax_form_tbl_batch_boni_mob_validate_date_fin()
  {
    ...
    setTimeout(function() {
      var var_date_fin = scAjaxGetFieldText(nomeCampo_date_fin);
      x_ajax_form_tbl_batch_boni_mob_validate_date_fin(var_date_fin, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_validate_date_fin_cb);
    }, 200);
  } // do_ajax_form_tbl_batch_boni_mob_validate_date_fin

  function do_ajax_form_tbl_batch_boni_mob_validate_date_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_boni_mob_validate_date_fin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbl_batch_boni_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_batch_boni_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_boni_mob_submit_form(var_boni_code, var_blank01, var_boni_description, var_date_debut, var_date_fin, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_batch_boni_mob_submit_form_cb);
  } // do_ajax_form_tbl_batch_boni_mob_submit_form

  function do_ajax_form_tbl_batch_boni_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbl_batch_boni_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_boni_mob_submit_form_cb
  function do_ajax_form_tbl_batch_boni_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_batch_boni_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_batch_boni_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tbl_batch_boni_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tbl_batch_boni_mob_navigate_form();
    }
  }

  function perform_ajax_form_tbl_batch_boni_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_boni_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_batch_boni_mob_navigate_form_cb);
  } // do_ajax_form_tbl_batch_boni_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_batch_boni_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_batch_boni_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_batch_boni_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_boni_mob_navigate_form_cb
  function do_ajax_form_tbl_batch_boni_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbl_batch_boni_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_batch_boni_mob_navigate_form_cb_after_alert

  function sc_hide_form_tbl_batch_boni_mob_form()
  {
