...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____app_logged_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____app_logged_users"]);
   }
