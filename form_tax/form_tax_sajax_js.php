...
?>
  ...
  function do_ajax_form_tax_validate_userid_int_(iNumLinha)
  {
    var nomeCampo_userid_int_ = "userid_int_" + iNumLinha;
    var var_userid_int_ = scAjaxGetFieldHidden(nomeCampo_userid_int_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_userid_int_(var_userid_int_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_userid_int__cb);
  } // do_ajax_form_tax_validate_userid_int_

  function do_ajax_form_tax_validate_userid_int__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_userid_int__cb

  // ---------- Validate employee_name_
  function do_ajax_form_tax_validate_employee_name_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_employee_name_(var_employee_name_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_employee_name__cb);
  } // do_ajax_form_tax_validate_employee_name_

  function do_ajax_form_tax_validate_employee_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_employee_name__cb

  // ---------- Validate dept_
  function do_ajax_form_tax_validate_dept_(iNumLinha)
  {
    var nomeCampo_dept_ = "dept_" + iNumLinha;
    var var_dept_ = scAjaxGetFieldHidden(nomeCampo_dept_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_dept_(var_dept_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_dept__cb);
  } // do_ajax_form_tax_validate_dept_

  function do_ajax_form_tax_validate_dept__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_dept__cb

  // ---------- Validate rate_iris_
  function do_ajax_form_tax_validate_rate_iris_(iNumLinha)
  {
    var nomeCampo_rate_iris_ = "rate_iris_" + iNumLinha;
    var var_rate_iris_ = scAjaxGetFieldText(nomeCampo_rate_iris_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_iris_(var_rate_iris_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_iris__cb);
  } // do_ajax_form_tax_validate_rate_iris_

  function do_ajax_form_tax_validate_rate_iris__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_iris_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_iris_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_iris_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_iris_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_iris__cb

  // ---------- Validate rate_iric_
  function do_ajax_form_tax_validate_rate_iric_(iNumLinha)
  {
    var nomeCampo_rate_iric_ = "rate_iric_" + iNumLinha;
    var var_rate_iric_ = scAjaxGetFieldText(nomeCampo_rate_iric_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_iric_(var_rate_iric_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_iric__cb);
  } // do_ajax_form_tax_validate_rate_iric_

  function do_ajax_form_tax_validate_rate_iric__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_iric_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_iric_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_iric_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_iric_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_iric__cb

  // ---------- Validate rate_cass_
  function do_ajax_form_tax_validate_rate_cass_(iNumLinha)
  {
    var nomeCampo_rate_cass_ = "rate_cass_" + iNumLinha;
    var var_rate_cass_ = scAjaxGetFieldText(nomeCampo_rate_cass_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_cass_(var_rate_cass_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_cass__cb);
  } // do_ajax_form_tax_validate_rate_cass_

  function do_ajax_form_tax_validate_rate_cass__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_cass_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_cass_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_cass_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_cass_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_cass__cb

  // ---------- Validate rate_cfgdct_
  function do_ajax_form_tax_validate_rate_cfgdct_(iNumLinha)
  {
    var nomeCampo_rate_cfgdct_ = "rate_cfgdct_" + iNumLinha;
    var var_rate_cfgdct_ = scAjaxGetFieldText(nomeCampo_rate_cfgdct_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_cfgdct_(var_rate_cfgdct_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_cfgdct__cb);
  } // do_ajax_form_tax_validate_rate_cfgdct_

  function do_ajax_form_tax_validate_rate_cfgdct__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_cfgdct_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_cfgdct_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_cfgdct_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_cfgdct_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_cfgdct__cb

  // ---------- Validate rate_fdu_
  function do_ajax_form_tax_validate_rate_fdu_(iNumLinha)
  {
    var nomeCampo_rate_fdu_ = "rate_fdu_" + iNumLinha;
    var var_rate_fdu_ = scAjaxGetFieldText(nomeCampo_rate_fdu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_fdu_(var_rate_fdu_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_fdu__cb);
  } // do_ajax_form_tax_validate_rate_fdu_

  function do_ajax_form_tax_validate_rate_fdu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_fdu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_fdu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_fdu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_fdu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_fdu__cb

  // ---------- Validate rate_ona_
  function do_ajax_form_tax_validate_rate_ona_(iNumLinha)
  {
    var nomeCampo_rate_ona_ = "rate_ona_" + iNumLinha;
    var var_rate_ona_ = scAjaxGetFieldText(nomeCampo_rate_ona_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_ona_(var_rate_ona_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_ona__cb);
  } // do_ajax_form_tax_validate_rate_ona_

  function do_ajax_form_tax_validate_rate_ona__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_ona_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_ona_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_ona_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_ona_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_ona__cb

  // ---------- Validate rate_tms_
  function do_ajax_form_tax_validate_rate_tms_(iNumLinha)
  {
    var nomeCampo_rate_tms_ = "rate_tms_" + iNumLinha;
    var var_rate_tms_ = scAjaxGetFieldText(nomeCampo_rate_tms_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_tms_(var_rate_tms_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_tms__cb);
  } // do_ajax_form_tax_validate_rate_tms_

  function do_ajax_form_tax_validate_rate_tms__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_tms_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_tms_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_tms_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_tms_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_tms__cb

  // ---------- Validate rate_stamp_
  function do_ajax_form_tax_validate_rate_stamp_(iNumLinha)
  {
    var nomeCampo_rate_stamp_ = "rate_stamp_" + iNumLinha;
    var var_rate_stamp_ = scAjaxGetFieldText(nomeCampo_rate_stamp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_validate_rate_stamp_(var_rate_stamp_, iNumLinha, var_script_case_init, do_ajax_form_tax_validate_rate_stamp__cb);
  } // do_ajax_form_tax_validate_rate_stamp_

  function do_ajax_form_tax_validate_rate_stamp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_stamp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_stamp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_stamp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_stamp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tax_validate_rate_stamp__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tax_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tax_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tax_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tax_add_new_line_cb);
  } // do_ajax_form_tax_add_new_line

  function do_ajax_form_tax_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tax_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tax_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tax_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tax_backup_line_cb);
  } // do_ajax_form_tax_backup_line

  function do_ajax_form_tax_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tax_backup_line_cb

  function do_ajax_form_tax_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tax_cancel_insert

  function do_ajax_form_tax_cancel_update(iSeqVert)
  {
    do_ajax_form_tax_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tax_cancel_update

  function do_ajax_form_tax_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tax_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tax_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tax_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tax_table_refresh_cb);
  } //  do_ajax_form_tax_table_refresh

  function do_ajax_form_tax_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tax_table_refresh_cb_after_alert);
  } // do_ajax_form_tax_table_refresh_cb
  function do_ajax_form_tax_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tax_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tax_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tax_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_rate_iris_ = scAjaxGetFieldText("rate_iris_" + iNumLinha);
    var var_rate_iric_ = scAjaxGetFieldText("rate_iric_" + iNumLinha);
    var var_rate_cass_ = scAjaxGetFieldText("rate_cass_" + iNumLinha);
    var var_rate_cfgdct_ = scAjaxGetFieldText("rate_cfgdct_" + iNumLinha);
    var var_rate_fdu_ = scAjaxGetFieldText("rate_fdu_" + iNumLinha);
    var var_rate_ona_ = scAjaxGetFieldText("rate_ona_" + iNumLinha);
    var var_rate_tms_ = scAjaxGetFieldText("rate_tms_" + iNumLinha);
    var var_rate_stamp_ = scAjaxGetFieldText("rate_stamp_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tax_submit_form(var_userid_int_, var_employee_name_, var_dept_, var_rate_iris_, var_rate_iric_, var_rate_cass_, var_rate_cfgdct_, var_rate_fdu_, var_rate_ona_, var_rate_tms_, var_rate_stamp_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tax_submit_form_cb);
  } // do_ajax_form_tax_submit_form

  function do_ajax_form_tax_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("rate_iris_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_iric_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_cass_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_cfgdct_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_fdu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_ona_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_tms_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_stamp_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tax_submit_form_cb_after_alert);
  } // do_ajax_form_tax_submit_form_cb
  function do_ajax_form_tax_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tax_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tax_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tax_navigate_form, function() {});
    } else {
      perform_ajax_form_tax_navigate_form();
    }
  }

  function perform_ajax_form_tax_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("rate_iris_" + iNavForm);
      scAjaxHideErrorDisplay("rate_iric_" + iNavForm);
      scAjaxHideErrorDisplay("rate_cass_" + iNavForm);
      scAjaxHideErrorDisplay("rate_cfgdct_" + iNavForm);
      scAjaxHideErrorDisplay("rate_fdu_" + iNavForm);
      scAjaxHideErrorDisplay("rate_ona_" + iNavForm);
      scAjaxHideErrorDisplay("rate_tms_" + iNavForm);
      scAjaxHideErrorDisplay("rate_stamp_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tax_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tax_navigate_form_cb);
  } // do_ajax_form_tax_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tax']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tax_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tax_navigate_form_cb_after_alert);
  } // do_ajax_form_tax_navigate_form_cb
  function do_ajax_form_tax_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tax_navigate_form_cb_after_alert

    function sc_form_tax_get_last_line_number()
    {
    ...
    } //sc_form_tax_get_last_line_number

  function sc_hide_form_tax_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_iris_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_iric_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_cass_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_cfgdct_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_fdu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_ona_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_tms_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_stamp_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["rate_iris_" + iNumLinha] = {"label": "IRI / Salary<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_iric_" + iNumLinha] = {"label": "TCA Add Rate<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_cass_" + iNumLinha] = {"label": "Rate CASS<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_cfgdct_" + iNumLinha] = {"label": "Rate CFGDCT<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_fdu_" + iNumLinha] = {"label": "Rate FDU<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_ona_" + iNumLinha] = {"label": "Rate ONA<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_tms_" + iNumLinha] = {"label": "Rate TMS<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_stamp_" + iNumLinha] = {"label": "Rate STAMP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["rate_iris_"][iNumLinha] = "rate_iris_" + iNumLinha;
    ajax_field_mult["rate_iric_"][iNumLinha] = "rate_iric_" + iNumLinha;
    ajax_field_mult["rate_cass_"][iNumLinha] = "rate_cass_" + iNumLinha;
    ajax_field_mult["rate_cfgdct_"][iNumLinha] = "rate_cfgdct_" + iNumLinha;
    ajax_field_mult["rate_fdu_"][iNumLinha] = "rate_fdu_" + iNumLinha;
    ajax_field_mult["rate_ona_"][iNumLinha] = "rate_ona_" + iNumLinha;
    ajax_field_mult["rate_tms_"][iNumLinha] = "rate_tms_" + iNumLinha;
    ajax_field_mult["rate_stamp_"][iNumLinha] = "rate_stamp_" + iNumLinha;
    ...
    ajax_field_id["rate_iris_" + iNumLinha] = new Array("hidden_field_label_rate_iris_", "hidden_field_data_rate_iris_" + iNumLinha);
    ajax_field_id["rate_iric_" + iNumLinha] = new Array("hidden_field_label_rate_iric_", "hidden_field_data_rate_iric_" + iNumLinha);
    ajax_field_id["rate_cass_" + iNumLinha] = new Array("hidden_field_label_rate_cass_", "hidden_field_data_rate_cass_" + iNumLinha);
    ajax_field_id["rate_cfgdct_" + iNumLinha] = new Array("hidden_field_label_rate_cfgdct_", "hidden_field_data_rate_cfgdct_" + iNumLinha);
    ajax_field_id["rate_fdu_" + iNumLinha] = new Array("hidden_field_label_rate_fdu_", "hidden_field_data_rate_fdu_" + iNumLinha);
    ajax_field_id["rate_ona_" + iNumLinha] = new Array("hidden_field_label_rate_ona_", "hidden_field_data_rate_ona_" + iNumLinha);
    ajax_field_id["rate_tms_" + iNumLinha] = new Array("hidden_field_label_rate_tms_", "hidden_field_data_rate_tms_" + iNumLinha);
    ajax_field_id["rate_stamp_" + iNumLinha] = new Array("hidden_field_label_rate_stamp_", "hidden_field_data_rate_stamp_" + iNumLinha);
    ...
    ajax_error_count["rate_iris_" + iNumLinha] = "off";
    ajax_error_count["rate_iric_" + iNumLinha] = "off";
    ajax_error_count["rate_cass_" + iNumLinha] = "off";
    ajax_error_count["rate_cfgdct_" + iNumLinha] = "off";
    ajax_error_count["rate_fdu_" + iNumLinha] = "off";
    ajax_error_count["rate_ona_" + iNumLinha] = "off";
    ajax_error_count["rate_tms_" + iNumLinha] = "off";
    ajax_error_count["rate_stamp_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["rate_iris_" + iNumLinha] = "off";
    ajax_read_only["rate_iric_" + iNumLinha] = "off";
    ajax_read_only["rate_cass_" + iNumLinha] = "off";
    ajax_read_only["rate_cfgdct_" + iNumLinha] = "off";
    ajax_read_only["rate_fdu_" + iNumLinha] = "off";
    ajax_read_only["rate_ona_" + iNumLinha] = "off";
    ajax_read_only["rate_tms_" + iNumLinha] = "off";
    ajax_read_only["rate_stamp_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["rate_iris_" + iNumLinha] = "on";
    ajax_read_only["rate_iric_" + iNumLinha] = "on";
    ajax_read_only["rate_cass_" + iNumLinha] = "on";
    ajax_read_only["rate_cfgdct_" + iNumLinha] = "on";
    ajax_read_only["rate_fdu_" + iNumLinha] = "on";
    ajax_read_only["rate_ona_" + iNumLinha] = "on";
    ajax_read_only["rate_tms_" + iNumLinha] = "on";
    ajax_read_only["rate_stamp_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["rate_iris_" + iNumLinha] = null;
    ajax_error_list["rate_iric_" + iNumLinha] = null;
    ajax_error_list["rate_cass_" + iNumLinha] = null;
    ajax_error_list["rate_cfgdct_" + iNumLinha] = null;
    ajax_error_list["rate_fdu_" + iNumLinha] = null;
    ajax_error_list["rate_ona_" + iNumLinha] = null;
    ajax_error_list["rate_tms_" + iNumLinha] = null;
    ajax_error_list["rate_stamp_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "dept_": new Array(),
    "rate_iris_": new Array(),
    "rate_iric_": new Array(),
    "rate_cass_": new Array(),
    "rate_cfgdct_": new Array(),
    "rate_fdu_": new Array(),
    "rate_ona_": new Array(),
    "rate_tms_": new Array(),
    "rate_stamp_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["rate_iris_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_iris_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_iris_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_iris_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_iris_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_iric_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_iric_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_iric_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_iric_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_iric_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_cass_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_cass_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_cass_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_cass_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_cass_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_cfgdct_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_cfgdct_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_cfgdct_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_cfgdct_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_cfgdct_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_fdu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_fdu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_fdu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_fdu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_fdu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_ona_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_ona_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_ona_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_ona_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_ona_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_tms_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_tms_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_tms_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_tms_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_tms_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_stamp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_stamp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_stamp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_stamp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_stamp_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_iris_'])) ? $this->nmgp_cmp_readonly['rate_iris_'] : 'off';
?>
    scAjaxFieldRead("rate_iris_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_iric_'])) ? $this->nmgp_cmp_readonly['rate_iric_'] : 'off';
?>
    scAjaxFieldRead("rate_iric_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_cass_'])) ? $this->nmgp_cmp_readonly['rate_cass_'] : 'off';
?>
    scAjaxFieldRead("rate_cass_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_cfgdct_'])) ? $this->nmgp_cmp_readonly['rate_cfgdct_'] : 'off';
?>
    scAjaxFieldRead("rate_cfgdct_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_fdu_'])) ? $this->nmgp_cmp_readonly['rate_fdu_'] : 'off';
?>
    scAjaxFieldRead("rate_fdu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_ona_'])) ? $this->nmgp_cmp_readonly['rate_ona_'] : 'off';
?>
    scAjaxFieldRead("rate_ona_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_tms_'])) ? $this->nmgp_cmp_readonly['rate_tms_'] : 'off';
?>
    scAjaxFieldRead("rate_tms_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_stamp_'])) ? $this->nmgp_cmp_readonly['rate_stamp_'] : 'off';
?>
    scAjaxFieldRead("rate_stamp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("rate_iris_" + iSeq, "on");
    scAjaxFieldRead("rate_iric_" + iSeq, "on");
    scAjaxFieldRead("rate_cass_" + iSeq, "on");
    scAjaxFieldRead("rate_cfgdct_" + iSeq, "on");
    scAjaxFieldRead("rate_fdu_" + iSeq, "on");
    scAjaxFieldRead("rate_ona_" + iSeq, "on");
    scAjaxFieldRead("rate_tms_" + iSeq, "on");
    scAjaxFieldRead("rate_stamp_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["userid_int_" + iRow] || "on" == ajax_error_count["employee_name_" + iRow] || "on" == ajax_error_count["dept_" + iRow] || "on" == ajax_error_count["rate_iris_" + iRow] || "on" == ajax_error_count["rate_iric_" + iRow] || "on" == ajax_error_count["rate_cass_" + iRow] || "on" == ajax_error_count["rate_cfgdct_" + iRow] || "on" == ajax_error_count["rate_fdu_" + iRow] || "on" == ajax_error_count["rate_ona_" + iRow] || "on" == ajax_error_count["rate_tms_" + iRow] || "on" == ajax_error_count["rate_stamp_" + iRow]))
    {
      ...
      $("#hidden_field_data_rate_iris_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_iric_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_cass_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_cfgdct_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_fdu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_ona_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_tms_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rate_stamp_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["userid_int_" + iRow] && "off" == ajax_error_count["employee_name_" + iRow] && "off" == ajax_error_count["dept_" + iRow] && "off" == ajax_error_count["rate_iris_" + iRow] && "off" == ajax_error_count["rate_iric_" + iRow] && "off" == ajax_error_count["rate_cass_" + iRow] && "off" == ajax_error_count["rate_cfgdct_" + iRow] && "off" == ajax_error_count["rate_fdu_" + iRow] && "off" == ajax_error_count["rate_ona_" + iRow] && "off" == ajax_error_count["rate_tms_" + iRow] && "off" == ajax_error_count["rate_stamp_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["rate_iris_" + iRow] = "off";
        ajax_error_count["rate_iric_" + iRow] = "off";
        ajax_error_count["rate_cass_" + iRow] = "off";
        ajax_error_count["rate_cfgdct_" + iRow] = "off";
        ajax_error_count["rate_fdu_" + iRow] = "off";
        ajax_error_count["rate_ona_" + iRow] = "off";
        ajax_error_count["rate_tms_" + iRow] = "off";
        ajax_error_count["rate_stamp_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rate_iris_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_iric_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_cass_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_cfgdct_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_fdu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_ona_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_tms_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rate_stamp_" + iRow).removeClass("scFormErrorLine");
    }
  }
