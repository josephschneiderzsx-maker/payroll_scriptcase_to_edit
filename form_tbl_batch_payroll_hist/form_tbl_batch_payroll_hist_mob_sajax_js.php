  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_batch_payroll_hist_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_tbl_batch_payroll_hist_mob_form();
        }
...
?>
  ...
  // ---------- Validate payroll_code
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code()
  {
    var nomeCampo_payroll_code = "payroll_code";
    var var_payroll_code = scAjaxGetFieldText(nomeCampo_payroll_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code(var_payroll_code, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "payroll_code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_code_cb

  // ---------- Validate status
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_status_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_status

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_status_cb

  // ---------- Validate payroll_description
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description()
  {
    var nomeCampo_payroll_description = "payroll_description";
    var var_payroll_description = scAjaxGetFieldText(nomeCampo_payroll_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description(var_payroll_description, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "payroll_description";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_payroll_description_cb

  // ---------- Validate date_debut
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut()
  {
    var nomeCampo_date_debut = "date_debut";
    var var_date_debut = scAjaxGetFieldText(nomeCampo_date_debut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut(var_date_debut, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_debut";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_cb

  // ---------- Validate date_fin
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin()
  {
    var nomeCampo_date_fin = "date_fin";
    var var_date_fin = scAjaxGetFieldText(nomeCampo_date_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin(var_date_fin, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_fin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_cb

  // ---------- Validate date_debut_sem1
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1()
  {
    var nomeCampo_date_debut_sem1 = "date_debut_sem1";
    var var_date_debut_sem1 = scAjaxGetFieldText(nomeCampo_date_debut_sem1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1(var_date_debut_sem1, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_debut_sem1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem1_cb

  // ---------- Validate date_fin_sem1
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1()
  {
    var nomeCampo_date_fin_sem1 = "date_fin_sem1";
    var var_date_fin_sem1 = scAjaxGetFieldText(nomeCampo_date_fin_sem1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1(var_date_fin_sem1, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_fin_sem1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem1_cb

  // ---------- Validate date_debut_sem2
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2()
  {
    var nomeCampo_date_debut_sem2 = "date_debut_sem2";
    var var_date_debut_sem2 = scAjaxGetFieldText(nomeCampo_date_debut_sem2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2(var_date_debut_sem2, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_debut_sem2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_debut_sem2_cb

  // ---------- Validate date_fin_sem2
  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2()
  {
    var nomeCampo_date_fin_sem2 = "date_fin_sem2";
    var var_date_fin_sem2 = scAjaxGetFieldText(nomeCampo_date_fin_sem2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2(var_date_fin_sem2, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2

  function do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "date_fin_sem2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_mob_validate_date_fin_sem2_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbl_batch_payroll_hist_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_batch_payroll_hist_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_payroll_code = scAjaxGetFieldText("payroll_code");
    var var_status = scAjaxGetFieldSelect("status");
    var var_payroll_description = scAjaxGetFieldText("payroll_description");
    var var_date_debut = scAjaxGetFieldText("date_debut");
    var var_date_fin = scAjaxGetFieldText("date_fin");
    var var_date_debut_sem1 = scAjaxGetFieldText("date_debut_sem1");
    var var_date_fin_sem1 = scAjaxGetFieldText("date_fin_sem1");
    var var_date_debut_sem2 = scAjaxGetFieldText("date_debut_sem2");
    var var_date_fin_sem2 = scAjaxGetFieldText("date_fin_sem2");
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_payroll_hist_mob_submit_form(var_payroll_code, var_status, var_payroll_description, var_date_debut, var_date_fin, var_date_debut_sem1, var_date_fin_sem1, var_date_debut_sem2, var_date_fin_sem2, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_submit_form

  function do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("payroll_code");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("payroll_description");
      scAjaxHideErrorDisplay("date_debut");
      scAjaxHideErrorDisplay("date_fin");
      scAjaxHideErrorDisplay("date_debut_sem1");
      scAjaxHideErrorDisplay("date_fin_sem1");
      scAjaxHideErrorDisplay("date_debut_sem2");
      scAjaxHideErrorDisplay("date_fin_sem2");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb
  function do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_batch_payroll_hist_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tbl_batch_payroll_hist_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tbl_batch_payroll_hist_mob_navigate_form();
    }
  }

  function perform_ajax_form_tbl_batch_payroll_hist_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_payroll_hist_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_batch_payroll_hist_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb
  function do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbl_batch_payroll_hist_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_batch_payroll_hist_mob_navigate_form_cb_after_alert

  function sc_hide_form_tbl_batch_payroll_hist_mob_form()
  {
  ...
  ajax_field_list[0] = "payroll_code";
  ajax_field_list[1] = "status";
  ajax_field_list[2] = "payroll_description";
  ajax_field_list[3] = "date_debut";
  ajax_field_list[4] = "date_fin";
  ajax_field_list[5] = "date_debut_sem1";
  ajax_field_list[6] = "date_fin_sem1";
  ajax_field_list[7] = "date_debut_sem2";
  ajax_field_list[8] = "date_fin_sem2";
  ...
  var ajax_error_list = {
    "payroll_code": {"label": "Payroll Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "payroll_description": {"label": "<?php echo $this->Ini->Nm_lang['lang_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_debut": {"label": "<?php echo $this->Ini->Nm_lang['lang_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_fin": {"label": "<?php echo $this->Ini->Nm_lang['lang_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_debut_sem1": {"label": "<?php echo $this->Ini->Nm_lang['lang_start_week1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_fin_sem1": {"label": "<?php echo $this->Ini->Nm_lang['lang_end_date_week1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_debut_sem2": {"label": "<?php echo $this->Ini->Nm_lang['lang_start_week2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "date_fin_sem2": {"label": "<?php echo $this->Ini->Nm_lang['lang_end_date_week2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "payroll_code": new Array(),
    "status": new Array(),
    "payroll_description": new Array(),
    "date_debut": new Array(),
    "date_fin": new Array(),
    "date_debut_sem1": new Array(),
    "date_fin_sem1": new Array(),
    "date_debut_sem2": new Array(),
    "date_fin_sem2": new Array()
  };
  ajax_field_mult["payroll_code"][1] = "payroll_code";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["payroll_description"][1] = "payroll_description";
  ajax_field_mult["date_debut"][1] = "date_debut";
  ajax_field_mult["date_fin"][1] = "date_fin";
  ajax_field_mult["date_debut_sem1"][1] = "date_debut_sem1";
  ajax_field_mult["date_fin_sem1"][1] = "date_fin_sem1";
  ajax_field_mult["date_debut_sem2"][1] = "date_debut_sem2";
  ajax_field_mult["date_fin_sem2"][1] = "date_fin_sem2";

  var ajax_field_id = {
    "payroll_code": new Array("hidden_field_label_payroll_code", "hidden_field_data_payroll_code"),
    "payroll_description": new Array("hidden_field_label_payroll_description", "hidden_field_data_payroll_description"),
    "date_debut": new Array("hidden_field_label_date_debut", "hidden_field_data_date_debut"),
    "date_fin": new Array("hidden_field_label_date_fin", "hidden_field_data_date_fin"),
    "date_debut_sem1": new Array("hidden_field_label_date_debut_sem1", "hidden_field_data_date_debut_sem1"),
    "date_fin_sem1": new Array("hidden_field_label_date_fin_sem1", "hidden_field_data_date_fin_sem1"),
    "date_debut_sem2": new Array("hidden_field_label_date_debut_sem2", "hidden_field_data_date_debut_sem2"),
    "date_fin_sem2": new Array("hidden_field_label_date_fin_sem2", "hidden_field_data_date_fin_sem2")
  };

  var ajax_read_only = {
    "payroll_code": "off",
    "status": "off",
    "payroll_description": "off",
    "date_debut": "off",
    "date_fin": "off",
    "date_debut_sem1": "off",
    "date_fin_sem1": "off",
