  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_batch_payroll_hist" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_tbl_batch_payroll_hist_form();
        }
...
?>
  ...
  function do_ajax_form_tbl_batch_payroll_hist_validate_payroll_code()
  {
    var nomeCampo_payroll_code = "payroll_code";
    var var_payroll_code = scAjaxGetFieldText(nomeCampo_payroll_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_payroll_code(var_payroll_code, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_payroll_code_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_payroll_code

  function do_ajax_form_tbl_batch_payroll_hist_validate_payroll_code_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_payroll_code_cb

  // ---------- Validate status
  function do_ajax_form_tbl_batch_payroll_hist_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_status(var_status, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_status_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_status

  function do_ajax_form_tbl_batch_payroll_hist_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_status_cb

  // ---------- Validate payroll_description
  function do_ajax_form_tbl_batch_payroll_hist_validate_payroll_description()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_payroll_description(var_payroll_description, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_payroll_description_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_payroll_description

  function do_ajax_form_tbl_batch_payroll_hist_validate_payroll_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_payroll_description_cb

  // ---------- Validate date_debut
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut()
  {
    var nomeCampo_date_debut = "date_debut";
    var var_date_debut = scAjaxGetFieldText(nomeCampo_date_debut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_debut(var_date_debut, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_cb

  // ---------- Validate date_fin
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin()
  {
    var nomeCampo_date_fin = "date_fin";
    var var_date_fin = scAjaxGetFieldText(nomeCampo_date_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_fin(var_date_fin, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_cb

  // ---------- Validate date_debut_sem1
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1()
  {
    var nomeCampo_date_debut_sem1 = "date_debut_sem1";
    var var_date_debut_sem1 = scAjaxGetFieldText(nomeCampo_date_debut_sem1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1(var_date_debut_sem1, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem1_cb

  // ---------- Validate date_fin_sem1
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1()
  {
    var nomeCampo_date_fin_sem1 = "date_fin_sem1";
    var var_date_fin_sem1 = scAjaxGetFieldText(nomeCampo_date_fin_sem1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1(var_date_fin_sem1, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem1_cb

  // ---------- Validate date_debut_sem2
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2()
  {
    var nomeCampo_date_debut_sem2 = "date_debut_sem2";
    var var_date_debut_sem2 = scAjaxGetFieldText(nomeCampo_date_debut_sem2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2(var_date_debut_sem2, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_debut_sem2_cb

  // ---------- Validate date_fin_sem2
  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2()
  {
    var nomeCampo_date_fin_sem2 = "date_fin_sem2";
    var var_date_fin_sem2 = scAjaxGetFieldText(nomeCampo_date_fin_sem2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2(var_date_fin_sem2, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2

  function do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_batch_payroll_hist_validate_date_fin_sem2_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tbl_batch_payroll_hist_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_batch_payroll_hist_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_payroll_hist_submit_form(var_payroll_code, var_status, var_payroll_description, var_date_debut, var_date_fin, var_date_debut_sem1, var_date_fin_sem1, var_date_debut_sem2, var_date_fin_sem2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_batch_payroll_hist_submit_form_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_submit_form

  function do_ajax_form_tbl_batch_payroll_hist_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbl_batch_payroll_hist_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_payroll_hist_submit_form_cb
  function do_ajax_form_tbl_batch_payroll_hist_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_batch_payroll_hist_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_batch_payroll_hist_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tbl_batch_payroll_hist_navigate_form, function() {});
    } else {
      perform_ajax_form_tbl_batch_payroll_hist_navigate_form();
    }
  }

  function perform_ajax_form_tbl_batch_payroll_hist_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_batch_payroll_hist_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb);
  } // do_ajax_form_tbl_batch_payroll_hist_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_batch_payroll_hist']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb
  function do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tbl_batch_payroll_hist_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_batch_payroll_hist_navigate_form_cb_after_alert

  function sc_hide_form_tbl_batch_payroll_hist_form()
  {
