...
class grid_income_restday_ot_Hist_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_income_restday_ot_Hist/grid_income_restday_ot_Hist_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_income_restday_ot_Hist_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_income_restday_ot_Hist.zip";
          $this->Arquivo   .= "_grid_income_restday_ot_Hist" . $this->Xls_tp;
          $this->Tit_doc    = "grid_income_restday_ot_Hist" . $this->Xls_tp;
          $this->Tit_zip    = "grid_income_restday_ot_Hist.zip";
      ...
      {
          $this->sum_ot_hh_r = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][2];
          $this->sum_ot_hh_r_pm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][3];
          $this->sum_income_restday_ot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][4];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          $this->sum_ot_hh_r = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][2];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->ot_hh_r = $rs->fields[4] ;  
         $this->ot_hh_r = (string)$this->ot_hh_r;
         $this->ot_hh_r_pm = $rs->fields[5] ;  
         $this->ot_hh_r_pm = (string)$this->ot_hh_r_pm;
         $this->rate_ot_restday_factor = $rs->fields[6] ;  
         ...
         $this->income_restday_ot = $rs->fields[8] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['nolabel'])
       {
 ...
 function quebra_dept_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_dept_sc_free_group_by_bot()
   {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['ot_hh_r'][$Tipo_Sum]) && $Cada_cmp == "ot_hh_r" && (!isset($this->NM_cmp_hidden['ot_hh_r']) || $this->NM_cmp_hidden['ot_hh_r'] != "off"))
           {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['ot_hh_r'][$Tipo_Sum]) && $Cada_cmp == "ot_hh_r" && (!isset($this->NM_cmp_hidden['ot_hh_r']) || $this->NM_cmp_hidden['ot_hh_r'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][$NM_cmp_tot['ot_hh_r'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['ot_hh_r_pm'][$Tipo_Sum]) && $Cada_cmp == "ot_hh_r_pm" && (!isset($this->NM_cmp_hidden['ot_hh_r_pm']) || $this->NM_cmp_hidden['ot_hh_r_pm'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][$NM_cmp_tot['ot_hh_r_pm'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['income_restday_ot'][$Tipo_Sum]) && $Cada_cmp == "income_restday_ot" && (!isset($this->NM_cmp_hidden['income_restday_ot']) || $this->NM_cmp_hidden['income_restday_ot'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['tot_geral'][$NM_cmp_tot['income_restday_ot'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>INCOME RESTDAY OT HISTORIZED :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_income_restday_ot_Hist']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
