...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_userid_label" id="hidden_field_label_userid" style="<?php echo $sStyleHidden_userid; ?>"><span id="id_label_userid"><?php echo $this->nm_new_label['userid']; ?></span></TD>
    <TD class="scFormDataOdd css_userid_line" id="hidden_field_data_userid" style="<?php echo $sStyleHidden_userid; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_createdate_label" id="hidden_field_label_createdate" style="<?php echo $sStyleHidden_createdate; ?>"><span id="id_label_createdate"><?php echo $this->nm_new_label['createdate']; ?></span></TD>
    <TD class="scFormDataOdd css_createdate_line" id="hidden_field_data_createdate" style="<?php echo $sStyleHidden_createdate; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_expirydate_label" id="hidden_field_label_expirydate" style="<?php echo $sStyleHidden_expirydate; ?>"><span id="id_label_expirydate"><?php echo $this->nm_new_label['expirydate']; ?></span></TD>
    <TD class="scFormDataOdd css_expirydate_line" id="hidden_field_data_expirydate" style="<?php echo $sStyleHidden_expirydate; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pay_rate_label" id="hidden_field_label_pay_rate" style="<?php echo $sStyleHidden_pay_rate; ?>"><span id="id_label_pay_rate"><?php echo $this->nm_new_label['pay_rate']; ?></span></TD>
    <TD class="scFormDataOdd css_pay_rate_line" id="hidden_field_data_pay_rate" style="<?php echo $sStyleHidden_pay_rate; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hiring_duration_line" id="hidden_field_data_hiring_duration" style="<?php echo $sStyleHidden_hiring_duration; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_notice");
</script>
<?php
    }
    else {
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
