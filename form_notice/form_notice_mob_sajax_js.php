...
?>
  ...
  // ---------- Validate userid
  function do_ajax_form_notice_mob_validate_userid()
  {
    var nomeCampo_userid = "userid";
    var var_userid = scAjaxGetFieldText(nomeCampo_userid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_userid(var_userid, var_script_case_init, do_ajax_form_notice_mob_validate_userid_cb);
  } // do_ajax_form_notice_mob_validate_userid

  function do_ajax_form_notice_mob_validate_userid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_userid_cb

  // ---------- Validate username
  function do_ajax_form_notice_mob_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldText(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_username(var_username, var_script_case_init, do_ajax_form_notice_mob_validate_username_cb);
  } // do_ajax_form_notice_mob_validate_username

  function do_ajax_form_notice_mob_validate_username_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_username_cb

  // ---------- Validate createdate
  function do_ajax_form_notice_mob_validate_createdate()
  {
    var nomeCampo_createdate = "createdate";
    var var_createdate = scAjaxGetFieldText(nomeCampo_createdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_createdate(var_createdate, var_script_case_init, do_ajax_form_notice_mob_validate_createdate_cb);
  } // do_ajax_form_notice_mob_validate_createdate

  function do_ajax_form_notice_mob_validate_createdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_createdate_cb

  // ---------- Validate expirydate
  function do_ajax_form_notice_mob_validate_expirydate()
  {
    var nomeCampo_expirydate = "expirydate";
    var var_expirydate = scAjaxGetFieldText(nomeCampo_expirydate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_expirydate(var_expirydate, var_script_case_init, do_ajax_form_notice_mob_validate_expirydate_cb);
  } // do_ajax_form_notice_mob_validate_expirydate

  function do_ajax_form_notice_mob_validate_expirydate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_expirydate_cb

  // ---------- Validate pay_rate
  function do_ajax_form_notice_mob_validate_pay_rate()
  {
    var nomeCampo_pay_rate = "pay_rate";
    var var_pay_rate = scAjaxGetFieldText(nomeCampo_pay_rate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_pay_rate(var_pay_rate, var_script_case_init, do_ajax_form_notice_mob_validate_pay_rate_cb);
  } // do_ajax_form_notice_mob_validate_pay_rate

  function do_ajax_form_notice_mob_validate_pay_rate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_pay_rate_cb

  // ---------- Validate hiring_duration
  function do_ajax_form_notice_mob_validate_hiring_duration()
  {
    var nomeCampo_hiring_duration = "hiring_duration";
    var var_hiring_duration = scAjaxGetFieldText(nomeCampo_hiring_duration);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_hiring_duration(var_hiring_duration, var_script_case_init, do_ajax_form_notice_mob_validate_hiring_duration_cb);
  } // do_ajax_form_notice_mob_validate_hiring_duration

  function do_ajax_form_notice_mob_validate_hiring_duration_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_hiring_duration_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_notice_mob_submit_form()
  {
    ...
    var var_auto_no = scAjaxGetFieldText("auto_no");
    ...
    scAjaxProcOn();
    x_ajax_form_notice_mob_submit_form(var_userid, var_username, var_createdate, var_expirydate, var_pay_rate, var_hiring_duration, var_auto_no, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_notice_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_notice_mob_submit_form_cb_after_alert);
  } // do_ajax_form_notice_mob_submit_form_cb
  function do_ajax_form_notice_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_notice_mob_submit_form_cb_after_alert
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_notice_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_notice_mob_navigate_form();
    }
  }

  function perform_ajax_form_notice_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_notice_mob_navigate_form(var_auto_no, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_notice_mob_navigate_form_cb);
  } // do_ajax_form_notice_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_notice_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_notice_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_notice_mob_navigate_form_cb
  function do_ajax_form_notice_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_notice_mob_navigate_form_cb_after_alert
