...
function form_notice_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
...
<?php
    ...
    $_SESSION['scriptcase']['form_notice']['error_buffer'] .= ob_get_flush();
}
