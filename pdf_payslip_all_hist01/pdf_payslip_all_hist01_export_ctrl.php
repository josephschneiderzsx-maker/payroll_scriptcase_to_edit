<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_payslip_all_hist01']['sc_process_barr'] = true;
require_once('../pdf_payslip_all_hist01/index.php');
unset($_SESSION['scriptcase']['pdf_payslip_all_hist01']['sc_process_barr']);
$ExportCtrl = new pdf_payslip_all_hist01_export_control;
$ExportCtrl->Export_barr();

class pdf_payslip_all_hist01_export_control
{
