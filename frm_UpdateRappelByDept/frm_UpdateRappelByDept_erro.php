...
$old_error_handler = set_error_handler("frm_UpdateRappelByDept_scriptcase_error_handler");

function frm_UpdateRappelByDept_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frm_UpdateRappelByDept']['contr_erro']) && $_SESSION['scriptcase']['frm_UpdateRappelByDept']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frm_UpdateRappelByDept->contr_frm_UpdateRappelByDept->Apl_com_erro = true;
            if ($inicial_frm_UpdateRappelByDept->contr_frm_UpdateRappelByDept->NM_ajax_flag)
            {
                $inicial_frm_UpdateRappelByDept->contr_frm_UpdateRappelByDept->NM_ajax_info['errList']['geral_frm_UpdateRappelByDept'][] = $msg;
                return;
            }
            frm_UpdateRappelByDept_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frm_UpdateRappelByDept_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frm_UpdateRappelByDept'])  && '' != $_SESSION['scriptcase']['error_icon']['frm_UpdateRappelByDept'])  ? $_SESSION['scriptcase']['error_icon']['frm_UpdateRappelByDept']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frm_UpdateRappelByDept']) && '' != $_SESSION['scriptcase']['error_span_title']['frm_UpdateRappelByDept']) ? $_SESSION['scriptcase']['error_span_title']['frm_UpdateRappelByDept'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frm_UpdateRappelByDept']) && '' != $_SESSION['scriptcase']['error_icon_title']['frm_UpdateRappelByDept']) ? $_SESSION['scriptcase']['error_icon_title']['frm_UpdateRappelByDept'] : '';
?>
