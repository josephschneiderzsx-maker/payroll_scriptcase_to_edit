  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_note_employee" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_tbl_note_employee_form();
        }
...
?>
  ...
  // ---------- Validate date_note_
  function do_ajax_form_tbl_note_employee_validate_date_note_(iNumLinha)
  {
    var nomeCampo_date_note_ = "date_note_" + iNumLinha;
    var var_date_note_ = scAjaxGetFieldText(nomeCampo_date_note_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_validate_date_note_(var_date_note_, iNumLinha, var_script_case_init, do_ajax_form_tbl_note_employee_validate_date_note__cb);
  } // do_ajax_form_tbl_note_employee_validate_date_note_

  function do_ajax_form_tbl_note_employee_validate_date_note__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "date_note_" + iLineNumber;
    }
    else
    {
      sFieldValid = "date_note_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "date_note_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "date_note_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_note_employee_validate_date_note__cb

  // ---------- Validate note_description_
  function do_ajax_form_tbl_note_employee_validate_note_description_(iNumLinha)
  {
    var nomeCampo_note_description_ = "note_description_" + iNumLinha;
    var var_note_description_ = scAjaxGetFieldText(nomeCampo_note_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_validate_note_description_(var_note_description_, iNumLinha, var_script_case_init, do_ajax_form_tbl_note_employee_validate_note_description__cb);
  } // do_ajax_form_tbl_note_employee_validate_note_description_

  function do_ajax_form_tbl_note_employee_validate_note_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "note_description_" + iLineNumber;
    }
    else
    {
      sFieldValid = "note_description_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "note_description_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "note_description_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_note_employee_validate_note_description__cb

  // ---------- Validate file_name_
  function do_ajax_form_tbl_note_employee_validate_file_name_(iNumLinha)
  {
    var nomeCampo_file_name_ = "file_name_" + iNumLinha;
    var var_file_name_ = scAjaxGetFieldText(nomeCampo_file_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_validate_file_name_(var_file_name_, iNumLinha, var_script_case_init, do_ajax_form_tbl_note_employee_validate_file_name__cb);
  } // do_ajax_form_tbl_note_employee_validate_file_name_

  function do_ajax_form_tbl_note_employee_validate_file_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "file_name_" + iLineNumber;
    }
    else
    {
      sFieldValid = "file_name_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "file_name_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "file_name_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_note_employee_validate_file_name__cb

  // ---------- Validate file_size_
  function do_ajax_form_tbl_note_employee_validate_file_size_(iNumLinha)
  {
    var nomeCampo_file_size_ = "file_size_" + iNumLinha;
    var var_file_size_ = scAjaxGetFieldText(nomeCampo_file_size_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_validate_file_size_(var_file_size_, iNumLinha, var_script_case_init, do_ajax_form_tbl_note_employee_validate_file_size__cb);
  } // do_ajax_form_tbl_note_employee_validate_file_size_

  function do_ajax_form_tbl_note_employee_validate_file_size__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "file_size_" + iLineNumber;
    }
    else
    {
      sFieldValid = "file_size_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "file_size_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "file_size_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_note_employee_validate_file_size__cb

  // ---------- Validate id_
  function do_ajax_form_tbl_note_employee_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbl_note_employee_validate_id__cb);
  } // do_ajax_form_tbl_note_employee_validate_id_

  function do_ajax_form_tbl_note_employee_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_note_employee_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbl_note_employee_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbl_note_employee_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbl_note_employee_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbl_note_employee_add_new_line_cb);
  } // do_ajax_form_tbl_note_employee_add_new_line

  function do_ajax_form_tbl_note_employee_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_tbl_note_employee_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbl_note_employee_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_note_employee_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbl_note_employee_backup_line_cb);
  } // do_ajax_form_tbl_note_employee_backup_line

  function do_ajax_form_tbl_note_employee_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tbl_note_employee_backup_line_cb

  function do_ajax_form_tbl_note_employee_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbl_note_employee_cancel_insert

  function do_ajax_form_tbl_note_employee_cancel_update(iSeqVert)
  {
    do_ajax_form_tbl_note_employee_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbl_note_employee_cancel_update

  function do_ajax_form_tbl_note_employee_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbl_note_employee_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbl_note_employee_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_note_employee_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_note_employee_table_refresh_cb);
  } //  do_ajax_form_tbl_note_employee_table_refresh

  function do_ajax_form_tbl_note_employee_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_tbl_note_employee_table_refresh_cb_after_alert);
<?php if($this->nmgp_opcao != 'novo' && $this->nmgp_opcao != 'nada'): ?>
    $('body').on('DOMSubtreeModified', function(){
        for (var iSeqRow = 1; iSeqRow <= iAjaxNewLine; iSeqRow++){
            $('[id^=id_ajax_doc_document_'+iSeqRow+'],[id^=id_read_on_document_'+iSeqRow+']').each(function(i, t){
                ajax_check_file($(this).text() , 'document_', $('#id_read_on_document_'+iSeqRow+', #id_ajax_doc_document_'+iSeqRow+' a' ), '<?php echo '/PAYROLLHTG/EMPFOLDER'; ?>', '<?php echo '//'; ?>', iSeqRow );
            });

         }
    });

<?php endif; ?>  } // do_ajax_form_tbl_note_employee_table_refresh_cb
  function do_ajax_form_tbl_note_employee_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbl_note_employee_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbl_note_employee_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbl_note_employee_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_date_note_ = scAjaxGetFieldText("date_note_" + iNumLinha);
    var var_note_description_ = scAjaxGetFieldText("note_description_" + iNumLinha);
    var var_file_name_ = scAjaxGetFieldText("file_name_" + iNumLinha);
    var var_file_size_ = scAjaxGetFieldText("file_size_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_file_name__ul_name = scAjaxSpecCharProtect(eval('document.F1.file_name__ul_name' + iNumLinha + '.value'));
    var var_file_name__ul_type = eval('document.F1.file_name__ul_type' + iNumLinha + '.value');
    var var_file_name__salva = document.F1.elements["file_name_" + iNumLinha + "_salva"] ? eval('document.F1.file_name_' + iNumLinha + '_salva.value') : "";
    var var_file_name__limpa = eval('document.F1.file_name__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbl_note_employee_submit_form(var_date_note_, var_note_description_, var_file_name_, var_file_size_, var_id_, var_file_name__ul_name, var_file_name__ul_type, var_file_name__salva, var_file_name__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_note_employee_submit_form_cb);
  } // do_ajax_form_tbl_note_employee_submit_form

  function do_ajax_form_tbl_note_employee_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("date_note_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("note_description_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("file_name_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("file_size_" + sc_num_ult_line);
...
<?php
        ...
        {
?>
          if (document.F1.elements["file_name__limpa" + sc_num_ult_line] && document.F1.elements["file_name__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldDocument("file_name_" + sc_num_ult_line, oImgTemp, "", "");
            document.F1.elements["file_name__limpa" + sc_num_ult_line].checked = false;
          }
          else if (document.getElementById("id_ajax_doc_file_name_" + sc_num_ult_line) && "" != document.getElementById("id_ajax_doc_file_name_" + sc_num_ult_line).innerHTML)
          {
            document.getElementById("id_ajax_doc_file_name_" + sc_num_ult_line).style.display = "";
          }
<?php
        }
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tbl_note_employee_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_note_employee_submit_form_cb
  function do_ajax_form_tbl_note_employee_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_note_employee_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_note_employee_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tbl_note_employee_navigate_form, function() {});
    } else {
      perform_ajax_form_tbl_note_employee_navigate_form();
    }
  }

  function perform_ajax_form_tbl_note_employee_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbl_note_employee_cancel_insert(sc_form_tbl_note_employee_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("date_note_" + iNavForm);
      scAjaxHideErrorDisplay("note_description_" + iNavForm);
      scAjaxHideErrorDisplay("file_name_" + iNavForm);
      scAjaxHideErrorDisplay("file_size_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_note_employee_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_note_employee_navigate_form_cb);
  } // do_ajax_form_tbl_note_employee_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_note_employee']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_note_employee_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_note_employee_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_note_employee_navigate_form_cb
  function do_ajax_form_tbl_note_employee_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tbl_note_employee_navigate_form_cb_after_alert

    function sc_form_tbl_note_employee_get_last_line_number()
    {
    ...
    } //sc_form_tbl_note_employee_get_last_line_number

  function sc_hide_form_tbl_note_employee_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "date_note_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "note_description_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "file_name_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "file_size_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["date_note_" + iNumLinha] = {"label": "Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["note_description_" + iNumLinha] = {"label": "Note Description<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["file_name_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_file_name'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["file_size_" + iNumLinha] = {"label": "File Size<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["date_note_"][iNumLinha] = "date_note_" + iNumLinha;
    ajax_field_mult["note_description_"][iNumLinha] = "note_description_" + iNumLinha;
    ajax_field_mult["file_name_"][iNumLinha] = "file_name_" + iNumLinha;
    ajax_field_mult["file_size_"][iNumLinha] = "file_size_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["date_note_" + iNumLinha] = new Array("hidden_field_label_date_note_", "hidden_field_data_date_note_" + iNumLinha);
    ajax_field_id["note_description_" + iNumLinha] = new Array("hidden_field_label_note_description_", "hidden_field_data_note_description_" + iNumLinha);
    ajax_field_id["file_name_" + iNumLinha] = new Array("hidden_field_label_file_name_", "hidden_field_data_file_name_" + iNumLinha);
    ajax_error_count["date_note_" + iNumLinha] = "off";
    ajax_error_count["note_description_" + iNumLinha] = "off";
    ajax_error_count["file_name_" + iNumLinha] = "off";
    ajax_error_count["file_size_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["date_note_" + iNumLinha] = "off";
    ajax_read_only["note_description_" + iNumLinha] = "off";
    ajax_read_only["file_name_" + iNumLinha] = "off";
    ajax_read_only["file_size_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["date_note_" + iNumLinha] = "on";
    ajax_read_only["note_description_" + iNumLinha] = "on";
    ajax_read_only["file_name_" + iNumLinha] = "on";
    ajax_read_only["file_size_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["date_note_" + iNumLinha] = null;
    ajax_error_list["note_description_" + iNumLinha] = null;
    ajax_error_list["file_name_" + iNumLinha] = null;
    ajax_error_list["file_size_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "date_note_": new Array(),
    "note_description_": new Array(),
    "file_name_": new Array(),
    "file_size_": new Array(),
    "id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["date_note_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["date_note_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["date_note_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["date_note_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["date_note_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["note_description_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["note_description_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["note_description_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["note_description_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["note_description_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["file_name_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["file_name_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["file_name_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["file_name_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["file_name_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["file_size_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["file_size_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["file_size_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["file_size_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["file_size_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['date_note_'])) ? $this->nmgp_cmp_readonly['date_note_'] : 'off';
?>
    scAjaxFieldRead("date_note_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['note_description_'])) ? $this->nmgp_cmp_readonly['note_description_'] : 'off';
?>
    scAjaxFieldRead("note_description_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['file_name_'])) ? $this->nmgp_cmp_readonly['file_name_'] : 'off';
?>
    scAjaxFieldRead("file_name_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['file_size_'])) ? $this->nmgp_cmp_readonly['file_size_'] : 'off';
?>
    scAjaxFieldRead("file_size_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("date_note_" + iSeq, "on");
    scAjaxFieldRead("note_description_" + iSeq, "on");
    scAjaxFieldRead("file_name_" + iSeq, "on");
    scAjaxFieldRead("file_size_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["date_note_" + iRow] || "on" == ajax_error_count["note_description_" + iRow] || "on" == ajax_error_count["file_name_" + iRow] || "on" == ajax_error_count["file_size_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_date_note_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_note_description_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_file_name_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_file_size_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["date_note_" + iRow] && "off" == ajax_error_count["note_description_" + iRow] && "off" == ajax_error_count["file_name_" + iRow] && "off" == ajax_error_count["file_size_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["date_note_" + iRow] = "off";
        ajax_error_count["note_description_" + iRow] = "off";
        ajax_error_count["file_name_" + iRow] = "off";
        ajax_error_count["file_size_" + iRow] = "off";
      ...
      $("#hidden_field_data_date_note_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_note_description_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_file_name_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_file_size_" + iRow).removeClass("scFormErrorLine");
