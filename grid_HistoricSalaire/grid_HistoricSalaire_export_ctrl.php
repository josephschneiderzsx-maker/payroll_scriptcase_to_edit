<?php
@session_start() ;
$_SESSION['scriptcase']['grid_HistoricSalaire']['sc_process_barr'] = true;
require_once('../grid_HistoricSalaire/index.php');
unset($_SESSION['scriptcase']['grid_HistoricSalaire']['sc_process_barr']);
$ExportCtrl = new grid_HistoricSalaire_export_control;
$ExportCtrl->Export_barr();

class grid_HistoricSalaire_export_control
{
