<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_HistoricSalaire']['glo_nm_path_imag_temp'] . "/sc_apl_default_PAYROLL_STANCO02.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_HistoricSalaire_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_HistoricSalaire_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["userid_int"] : "Fingertec ID";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["username"] : "Employee Name";
   $tab_ger_campos['dept'] = "on";
   $tab_def_campos['dept'] = "dept";
   $tab_labels["dept"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["dept"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["dept"] : "Department";
   $tab_ger_campos['designation'] = "on";
   $tab_def_campos['designation'] = "designation";
   $tab_labels["designation"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["designation"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["designation"] : "Designation";
   $tab_ger_campos['pay_startdate'] = "on";
   $tab_def_campos['pay_startdate'] = "pay_startdate";
   $tab_labels["pay_startdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["pay_startdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["pay_startdate"] : "Pay Startdate";
   $tab_ger_campos['pay_enddate'] = "on";
   $tab_def_campos['pay_enddate'] = "pay_enddate";
   $tab_labels["pay_enddate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["pay_enddate"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["pay_enddate"] : "Pay Enddate";
   $tab_ger_campos['sal_brut_reg'] = "on";
   $tab_def_campos['sal_brut_reg'] = "sal_brut_reg";
   $tab_labels["sal_brut_reg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["sal_brut_reg"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["sal_brut_reg"] : "Reg Gross Income";
   $tab_ger_campos['income_comm'] = "on";
   $tab_def_campos['income_comm'] = "income_comm";
   $tab_labels["income_comm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["income_comm"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["income_comm"] : "Income Additional";
   $tab_ger_campos['sal_net'] = "on";
   $tab_def_campos['sal_net'] = "sal_net";
   $tab_labels["sal_net"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["sal_net"])) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['labels']["sal_net"] : "Net Income";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_HistoricSalaire_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_HistoricSalaire']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
