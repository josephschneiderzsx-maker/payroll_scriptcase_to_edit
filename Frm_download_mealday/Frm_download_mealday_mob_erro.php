...
$old_error_handler = set_error_handler("Frm_download_mealday_mob_scriptcase_error_handler");

function Frm_download_mealday_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['Frm_download_mealday_mob']['contr_erro']) && $_SESSION['scriptcase']['Frm_download_mealday_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Frm_download_mealday_mob->contr_Frm_download_mealday_mob->Apl_com_erro = true;
            if ($inicial_Frm_download_mealday_mob->contr_Frm_download_mealday_mob->NM_ajax_flag)
            {
                $inicial_Frm_download_mealday_mob->contr_Frm_download_mealday_mob->NM_ajax_info['errList']['geral_Frm_download_mealday_mob'][] = $msg;
                return;
            }
            Frm_download_mealday_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function Frm_download_mealday_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Frm_download_mealday_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['Frm_download_mealday_mob'])  ? $_SESSION['scriptcase']['error_icon']['Frm_download_mealday_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Frm_download_mealday_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['Frm_download_mealday_mob']) ? $_SESSION['scriptcase']['error_span_title']['Frm_download_mealday_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Frm_download_mealday_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['Frm_download_mealday_mob']) ? $_SESSION['scriptcase']['error_icon_title']['Frm_download_mealday_mob'] : '';
?>
