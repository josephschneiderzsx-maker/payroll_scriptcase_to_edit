<?php
@session_start() ;
$_SESSION['scriptcase']['grid_income_holiday_ot']['sc_process_barr'] = true;
require_once('../grid_income_holiday_ot/index.php');
unset($_SESSION['scriptcase']['grid_income_holiday_ot']['sc_process_barr']);
$ExportCtrl = new grid_income_holiday_ot_export_control;
$ExportCtrl->Export_barr();

class grid_income_holiday_ot_export_control
{
