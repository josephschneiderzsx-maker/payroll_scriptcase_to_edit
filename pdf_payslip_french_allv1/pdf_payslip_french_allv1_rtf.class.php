...
class pdf_payslip_french_allv1_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdf_payslip_french_allv1.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_name']);
      }
   ...
   function NM_export_deduct_assurance()
   {
         ...
         $this->deduct_assurance = str_replace('<', '&lt;', $this->deduct_assurance);
         $this->deduct_assurance = str_replace('>', '&gt;', $this->deduct_assurance);
         $this->Texto_tag .= "<td>" . $this->deduct_assurance . "</td>\r\n";
   }
   //----- amount
   ...
   function NM_export_lbl_assurance()
   {
         ...
         $this->lbl_assurance = str_replace('<', '&lt;', $this->lbl_assurance);
         $this->lbl_assurance = str_replace('>', '&gt;', $this->lbl_assurance);
         $this->Texto_tag .= "<td>" . $this->lbl_assurance . "</td>\r\n";
   }
   //----- lbl_companyname
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
