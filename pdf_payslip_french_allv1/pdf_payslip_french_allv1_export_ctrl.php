<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_payslip_french_allv1']['sc_process_barr'] = true;
require_once('../pdf_payslip_french_allv1/index.php');
unset($_SESSION['scriptcase']['pdf_payslip_french_allv1']['sc_process_barr']);
$ExportCtrl = new pdf_payslip_french_allv1_export_control;
$ExportCtrl->Export_barr();

class pdf_payslip_french_allv1_export_control
{
