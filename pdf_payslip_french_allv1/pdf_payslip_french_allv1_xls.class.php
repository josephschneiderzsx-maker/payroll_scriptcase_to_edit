...
class pdf_payslip_french_allv1_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   {
                       $_SESSION['sc_session'][$script_case_init]['pdf_payslip_french_allv1']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdf_payslip_french_allv1/pdf_payslip_french_allv1_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new pdf_payslip_french_allv1_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdf_payslip_french_allv1.zip";
          $this->Arquivo   .= "_pdf_payslip_french_allv1" . $this->Xls_tp;
          $this->Tit_doc    = "pdf_payslip_french_allv1" . $this->Xls_tp;
          $this->Tit_zip    = "pdf_payslip_french_allv1.zip";
      ...
      require_once($this->Ini->path_aplicacao . "pdf_payslip_french_allv1_total.class.php"); 
      $this->Tot = new pdf_payslip_french_allv1_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->deduct_assurance = $rs->fields[70] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   { 
      ...
      { 
          ...
          if ($Cada_col == "deduct_assurance" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          $SC_Label = (isset($this->New_label['lbl_mealrate'])) ? $this->New_label['lbl_mealrate'] : "Prix repas"; 
          ...
          $SC_Label = (isset($this->New_label['lbl_assurance'])) ? $this->New_label['lbl_assurance'] : ""; 
          if ($Cada_col == "lbl_assurance" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_rate_work()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->rate_work))
      {
             $conteudo = str_replace($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['decimal_db'], "", $conteudo); 
             $this->nm_gera_mask($this->rate_work, "Rate Work"); 
      }
         $this->rate_work = NM_charset_to_utf8($this->rate_work);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rate_work, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rate_work, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- rate_salf
   ...
   function NM_export_work_hh_w()
   {
         ...
         if (is_numeric($this->work_hh_w))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_w);
         $this->Xls_col++;
   }
   //----- ot_hh_w
   ...
   function NM_export_work_hh_r()
   {
         ...
         if (is_numeric($this->work_hh_r))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_r);
         $this->Xls_col++;
   }
   //----- ot_hh_r
   ...
   function NM_export_work_hh_h()
   {
         ...
         if (is_numeric($this->work_hh_h))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_h);
         $this->Xls_col++;
   }
   //----- ot_hh_h
   ...
   function NM_export_sal_hr_worked()
   {
         ...
         if (is_numeric($this->sal_hr_worked))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_hr_worked);
         $this->Xls_col++;
   }
   //----- sal_sunday_1
   function NM_export_sal_sunday_1()
   {
         ...
         if (is_numeric($this->sal_sunday_1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_sunday_1);
         $this->Xls_col++;
   }
   //----- sal_holiday_1
   function NM_export_sal_holiday_1()
   {
         ...
         if (is_numeric($this->sal_holiday_1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_holiday_1);
         $this->Xls_col++;
   }
   //----- sal_brut_reg_1
   function NM_export_sal_brut_reg_1()
   {
         ...
         if (is_numeric($this->sal_brut_reg_1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_brut_reg_1);
         $this->Xls_col++;
   }
   //----- sal_suppl
   function NM_export_sal_suppl()
   {
         ...
         if (is_numeric($this->sal_suppl))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_suppl);
         $this->Xls_col++;
   }
   ...
   function NM_export_sal_holiday_worked_suppl()
   {
         ...
         if (is_numeric($this->sal_holiday_worked_suppl))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_holiday_worked_suppl);
         $this->Xls_col++;
   }
   //----- sal_holiday_suppl
   function NM_export_sal_holiday_suppl()
   {
         ...
         if (is_numeric($this->sal_holiday_suppl))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_holiday_suppl);
         $this->Xls_col++;
   }
   ...
   function NM_export_sal_restday_worked_suppl()
   {
         ...
         if (is_numeric($this->sal_restday_worked_suppl))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_restday_worked_suppl);
         $this->Xls_col++;
   }
   //----- sal_restday_suppl
   function NM_export_sal_restday_suppl()
   {
         ...
         if (is_numeric($this->sal_restday_suppl))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sal_restday_suppl);
         $this->Xls_col++;
   }
   //----- tax_iris
   ...
   function NM_export_day_cons()
   {
         ...
         if (is_numeric($this->day_cons))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->day_cons);
         $this->Xls_col++;
   }
   //----- rate_cons
   function NM_export_rate_cons()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->rate_cons = html_entity_decode($this->rate_cons, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->rate_cons = strip_tags($this->rate_cons);
         $this->rate_cons = NM_charset_to_utf8($this->rate_cons);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rate_cons, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rate_cons, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_other_loan_deduction()
   {
         ...
         if (is_numeric($this->other_loan_deduction))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->other_loan_deduction);
         $this->Xls_col++;
   }
   //----- other_deduct_1
   function NM_export_other_deduct_1()
   {
         ...
         if (is_numeric($this->other_deduct_1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->other_deduct_1);
         $this->Xls_col++;
   }
   //----- other_deduct_desc
   function NM_export_other_deduct_desc()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->other_deduct_desc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->other_deduct_desc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- bank_number
   ...
   function NM_export_work_hh_w_pm()
   {
         ...
         if (is_numeric($this->work_hh_w_pm))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_w_pm);
         $this->Xls_col++;
   }
   //----- ot_hh_w_pm
   ...
   function NM_export_work_hh_h_pm()
   {
         ...
         if (is_numeric($this->work_hh_h_pm))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_h_pm);
         $this->Xls_col++;
   }
   //----- ot_hh_h_pm
   ...
   function NM_export_work_hh_r_pm()
   {
         ...
         if (is_numeric($this->work_hh_r_pm))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_r_pm);
         $this->Xls_col++;
   }
   //----- ot_hh_r_pm
   ...
   function NM_export_work_hh_o()
   {
         ...
         if (is_numeric($this->work_hh_o))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_o);
         $this->Xls_col++;
   }
   //----- work_hh_o_pm
   function NM_export_work_hh_o_pm()
   {
         ...
         if (is_numeric($this->work_hh_o_pm))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->work_hh_o_pm);
         $this->Xls_col++;
   }
   //----- ot_hh_o
   ...
   function NM_export_hh_leavetype()
   {
         ...
         if (is_numeric($this->hh_leavetype))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->hh_leavetype);
         $this->Xls_col++;
   }
   //----- deduct_assurance
   function NM_export_deduct_assurance()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->deduct_assurance = NM_charset_to_utf8($this->deduct_assurance);
         if (is_numeric($this->deduct_assurance))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->deduct_assurance);
         $this->Xls_col++;
   }
   //----- amount
   function NM_export_amount()
   {
      ...
      if (!empty($this->amount))
      {
             ...
             if ($this->amount !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->amount, "MONTANT"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->amount, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->amount, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_0
   ...
   function NM_export_sc_field_2()
   {
      ...
      if (!empty($this->sc_field_2))
      {
             if ($this->sc_field_2 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_2, "Prêt ONA"); 
             } 
      }
   ...
   function NM_export_sc_field_3()
   {
      ...
      if (!empty($this->sc_field_3))
      {
             if ($this->sc_field_3 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_3, "Prêt ENT"); 
             } 
      }
   ...
   function NM_export_sc_field_4()
   {
      ...
      if (!empty($this->sc_field_4))
      {
             if ($this->sc_field_4 !== "&nbsp;") 
             { 
                 $this->sc_field_4 = sc_strtolower($this->sc_field_4); 
                 $this->sc_field_4 = ucfirst($this->sc_field_4); 
             } 
             if ($this->sc_field_4 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_4, "Repas"); 
             } 
      }
   ...
   function NM_export_sc_field_5()
   {
      ...
      if (!empty($this->sc_field_5))
      {
             if ($this->sc_field_5 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_5, "Autre deduct"); 
             } 
      }
   ...
   function NM_export_deductions()
   {
      ...
      if (!empty($this->deductions))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->deductions, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->deductions, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_6
   function NM_export_sc_field_6()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_6))
      {
             if ($this->sc_field_6 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_6, "PRENOM & NOM"); 
             } 
      }
   ...
   function NM_export_irisal()
   {
      ...
      if (!empty($this->irisal))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->irisal, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->irisal, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- incentive_lbl
   function NM_export_incentive_lbl()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->incentive_lbl))
      {
             if ($this->incentive_lbl !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->incentive_lbl, "E𝑥tra"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->incentive_lbl, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->incentive_lbl, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_8
   function NM_export_sc_field_8()
   {
      ...
      if (!empty($this->sc_field_8))
      {
             if ($this->sc_field_8 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_8, "SALAIRE NET"); 
             } 
      }
   ...
   function NM_export_ona()
   {
      ...
      if (!empty($this->ona))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ona, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ona, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_9
   ...
   function NM_export_sc_field_11()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_11))
      {
             if ($this->sc_field_11 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_11, "Payroll du"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_11, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_11, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_12
   function NM_export_sc_field_12()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_12))
      {
             if ($this->sc_field_12 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_12, "au"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_12, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_12, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_13
   function NM_export_sc_field_13()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_13))
      {
             if ($this->sc_field_13 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_13, "lang_lbl_extra"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_13, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_13, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_14
   function NM_export_sc_field_14()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_14))
      {
             if ($this->sc_field_14 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_14, "OT jour férié"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_14, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_14, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_15
   function NM_export_sc_field_15()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_15))
      {
             if ($this->sc_field_15 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_15, "OT jour OFF"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_15, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_15, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_16
   function NM_export_sc_field_16()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_16))
      {
             if ($this->sc_field_16 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_16, "OT jour repos"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_16, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_16, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_17
   function NM_export_sc_field_17()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_17))
      {
             if ($this->sc_field_17 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_17, "OT jour régulier"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_17, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_17, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_18
   function NM_export_sc_field_18()
   {
      ...
      if (!empty($this->sc_field_18))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_18, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_18, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_19
   function NM_export_sc_field_19()
   {
      ...
      if (!empty($this->sc_field_19))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_19, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_19, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_20
   function NM_export_sc_field_20()
   {
      ...
      if (!empty($this->sc_field_20))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_20, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_20, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_21
   function NM_export_sc_field_21()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_21))
      {
             if ($this->sc_field_21 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_21, "Jour travail"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_21, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_21, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_holiday
   function NM_export_lbl_holiday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_holiday))
      {
             if ($this->lbl_holiday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_holiday, "Fériés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_holiday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_holiday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sc_field_22
   function NM_export_sc_field_22()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->sc_field_22))
      {
             if ($this->sc_field_22 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->sc_field_22, "Gain fériés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_22, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sc_field_22, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_holidayhh
   function NM_export_lbl_holidayhh()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_holidayhh))
      {
             if ($this->lbl_holidayhh !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_holidayhh, "Fériés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_holidayhh, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_holidayhh, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_hourearned
   function NM_export_lbl_hourearned()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_hourearned))
      {
             if ($this->lbl_hourearned !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_hourearned, "Gain Heures"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_hourearned, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_hourearned, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_lbl_leavetypebenefits()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_leavetypebenefits))
      {
             if ($this->lbl_leavetypebenefits !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_leavetypebenefits, "Gain congés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_leavetypebenefits, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_leavetypebenefits, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_mealrate
   function NM_export_lbl_mealrate()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_mealrate))
      {
             if ($this->lbl_mealrate !== "&nbsp;") 
             { 
                 $this->lbl_mealrate = sc_strtolower($this->lbl_mealrate); 
                 $this->lbl_mealrate = ucfirst($this->lbl_mealrate); 
             } 
             if ($this->lbl_mealrate !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_mealrate, "Pri repas"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_mealrate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_mealrate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_mealday
   function NM_export_lbl_mealday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_mealday))
      {
             if ($this->lbl_mealday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_mealday, "Repas"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_mealday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_mealday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_ratework
   function NM_export_lbl_ratework()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_ratework))
      {
             if ($this->lbl_ratework !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_ratework, "Salaire horaire"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_ratework, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_ratework, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_restday
   function NM_export_lbl_restday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_restday))
      {
             if ($this->lbl_restday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_restday, "Repos"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_restday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_restday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salholiday
   function NM_export_lbl_salholiday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salholiday))
      {
             if ($this->lbl_salholiday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_salholiday, "Jour fériés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salholiday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salholiday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_saloffday
   function NM_export_lbl_saloffday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_saloffday))
      {
             if ($this->lbl_saloffday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_saloffday, "Jour OFF"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_saloffday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_saloffday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salrestday
   function NM_export_lbl_salrestday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salrestday))
      {
             if ($this->lbl_salrestday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_salrestday, "Jour repos"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salrestday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salrestday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salworkday
   function NM_export_lbl_salworkday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salworkday))
      {
             if ($this->lbl_salworkday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_salworkday, "Jour régulier"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salworkday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salworkday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_sal_reg
   function NM_export_lbl_sal_reg()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_sal_reg))
      {
             if ($this->lbl_sal_reg !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_sal_reg, "Total Sal. Reg"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sal_reg, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sal_reg, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_sundaybenefits
   function NM_export_lbl_sundaybenefits()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_sundaybenefits))
      {
             if ($this->lbl_sundaybenefits !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_sundaybenefits, "Gain Dimanche"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sundaybenefits, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sundaybenefits, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_sundayhh
   function NM_export_lbl_sundayhh()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_sundayhh))
      {
             if ($this->lbl_sundayhh !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_sundayhh, "Dimanche"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sundayhh, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_sundayhh, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_workay
   function NM_export_lbl_workay()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_workay))
      {
             if ($this->lbl_workay !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_workay, "Réguliers"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_workay, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_workay, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_amount01
   function NM_export_lbl_amount01()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_amount01))
      {
             if ($this->lbl_amount01 !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_amount01, "MONTANT"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_amount01, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_amount01, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_assurance
   function NM_export_lbl_assurance()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_assurance))
      {
             if ($this->lbl_assurance !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_assurance, "Assurance"); 
             } 
      }
         $this->lbl_assurance = html_entity_decode($this->lbl_assurance, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_assurance = NM_charset_to_utf8($this->lbl_assurance);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_assurance, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_assurance, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_companyname
   function NM_export_lbl_companyname()
   {
      ...
      if (!empty($this->lbl_companyname))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_companyname, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_companyname, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_deductions
   function NM_export_lbl_deductions()
   {
      ...
      if (!empty($this->lbl_deductions))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_deductions, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_deductions, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_dept
   function NM_export_lbl_dept()
   {
      ...
      if (!empty($this->lbl_dept))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_dept, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_dept, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_earning
   function NM_export_lbl_earning()
   {
      ...
      if (!empty($this->lbl_earning))
      {
             ...
             if ($this->lbl_earning !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_earning, "GAINS"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_earning, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_earning, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_employeename
   function NM_export_lbl_employeename()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_employeename))
      {
             if ($this->lbl_employeename !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_employeename, "PRENOM & NOM"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_employeename, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_employeename, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_fixedsalary
   function NM_export_lbl_fixedsalary()
   {
      ...
      if (!empty($this->lbl_fixedsalary))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_fixedsalary, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_fixedsalary, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_leavehh
   function NM_export_lbl_leavehh()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_leavehh))
      {
             if ($this->lbl_leavehh !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_leavehh, "Congés"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_leavehh, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_leavehh, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_line01
   function NM_export_lbl_line01()
   {
      ...
      if (!empty($this->lbl_line01))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_line01, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_line01, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_offday
   function NM_export_lbl_offday()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_offday))
      {
             if ($this->lbl_offday !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_offday, "OFF"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_offday, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_offday, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_payslip
   function NM_export_lbl_payslip()
   {
      ...
      if (!empty($this->lbl_payslip))
      {
             ...
             if ($this->lbl_payslip !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_payslip, "FICHE DE PAIE"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_payslip, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_payslip, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_rappel
   function NM_export_lbl_rappel()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_rappel))
      {
             if ($this->lbl_rappel !== "&nbsp;") 
             { 
                 $this->nm_gera_mask($this->lbl_rappel, "Divers"); 
             } 
      }
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_rappel, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_rappel, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salholidaydet
   function NM_export_lbl_salholidaydet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salholidaydet))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salholidaydet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salholidaydet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_saloffdaydet
   function NM_export_lbl_saloffdaydet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_saloffdaydet))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_saloffdaydet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_saloffdaydet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salrestdaydet
   function NM_export_lbl_salrestdaydet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salrestdaydet))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salrestdaydet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salrestdaydet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_salworkdaydet
   function NM_export_lbl_salworkdaydet()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->lbl_salworkdaydet))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salworkdaydet, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_salworkdaydet, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_taxcass
   function NM_export_lbl_taxcass()
   {
      ...
      if (!empty($this->lbl_taxcass))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxcass, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxcass, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_taxcfgdct
   function NM_export_lbl_taxcfgdct()
   {
      ...
      if (!empty($this->lbl_taxcfgdct))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxcfgdct, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxcfgdct, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lbl_taxfdu
   function NM_export_lbl_taxfdu()
   {
      ...
      if (!empty($this->lbl_taxfdu))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxfdu, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lbl_taxfdu, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- userid_int
   ...
   //----- work_hh_w
   function NM_sub_cons_work_hh_w()
   {
         $this->work_hh_w = NM_charset_to_utf8($this->work_hh_w);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_w;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_r
   function NM_sub_cons_work_hh_r()
   {
         $this->work_hh_r = NM_charset_to_utf8($this->work_hh_r);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_r;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_h
   function NM_sub_cons_work_hh_h()
   {
         $this->work_hh_h = NM_charset_to_utf8($this->work_hh_h);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_h;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_hr_worked
   function NM_sub_cons_sal_hr_worked()
   {
         $this->sal_hr_worked = NM_charset_to_utf8($this->sal_hr_worked);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_hr_worked;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_sunday_1
   function NM_sub_cons_sal_sunday_1()
   {
         $this->sal_sunday_1 = NM_charset_to_utf8($this->sal_sunday_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_sunday_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- sal_holiday_1
   function NM_sub_cons_sal_holiday_1()
   {
         $this->sal_holiday_1 = NM_charset_to_utf8($this->sal_holiday_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_holiday_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- sal_brut_reg_1
   function NM_sub_cons_sal_brut_reg_1()
   {
         $this->sal_brut_reg_1 = NM_charset_to_utf8($this->sal_brut_reg_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_brut_reg_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- sal_suppl
   function NM_sub_cons_sal_suppl()
   {
         $this->sal_suppl = NM_charset_to_utf8($this->sal_suppl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_suppl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_holiday_worked_suppl
   function NM_sub_cons_sal_holiday_worked_suppl()
   {
         $this->sal_holiday_worked_suppl = NM_charset_to_utf8($this->sal_holiday_worked_suppl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_holiday_worked_suppl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_holiday_suppl
   function NM_sub_cons_sal_holiday_suppl()
   {
         $this->sal_holiday_suppl = NM_charset_to_utf8($this->sal_holiday_suppl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_holiday_suppl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_restday_worked_suppl
   function NM_sub_cons_sal_restday_worked_suppl()
   {
         $this->sal_restday_worked_suppl = NM_charset_to_utf8($this->sal_restday_worked_suppl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_restday_worked_suppl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- sal_restday_suppl
   function NM_sub_cons_sal_restday_suppl()
   {
         $this->sal_restday_suppl = NM_charset_to_utf8($this->sal_restday_suppl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sal_restday_suppl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- day_cons
   function NM_sub_cons_day_cons()
   {
         $this->day_cons = NM_charset_to_utf8($this->day_cons);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->day_cons;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- rate_cons
   function NM_sub_cons_rate_cons()
   {
         $this->rate_cons = html_entity_decode($this->rate_cons, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->rate_cons = strip_tags($this->rate_cons);
         $this->rate_cons = NM_charset_to_utf8($this->rate_cons);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rate_cons;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- other_loan_deduction
   function NM_sub_cons_other_loan_deduction()
   {
         $this->other_loan_deduction = NM_charset_to_utf8($this->other_loan_deduction);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->other_loan_deduction;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- other_deduct_1
   function NM_sub_cons_other_deduct_1()
   {
         $this->other_deduct_1 = NM_charset_to_utf8($this->other_deduct_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->other_deduct_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- other_deduct_desc
   function NM_sub_cons_other_deduct_desc()
   {
         $this->other_deduct_desc = html_entity_decode($this->other_deduct_desc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->other_deduct_desc = strip_tags($this->other_deduct_desc);
         $this->other_deduct_desc = NM_charset_to_utf8($this->other_deduct_desc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->other_deduct_desc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- work_hh_w_pm
   function NM_sub_cons_work_hh_w_pm()
   {
         $this->work_hh_w_pm = NM_charset_to_utf8($this->work_hh_w_pm);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_w_pm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_h_pm
   function NM_sub_cons_work_hh_h_pm()
   {
         $this->work_hh_h_pm = NM_charset_to_utf8($this->work_hh_h_pm);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_h_pm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_r_pm
   function NM_sub_cons_work_hh_r_pm()
   {
         $this->work_hh_r_pm = NM_charset_to_utf8($this->work_hh_r_pm);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_r_pm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_o
   function NM_sub_cons_work_hh_o()
   {
         $this->work_hh_o = NM_charset_to_utf8($this->work_hh_o);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_o;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- work_hh_o_pm
   function NM_sub_cons_work_hh_o_pm()
   {
         $this->work_hh_o_pm = NM_charset_to_utf8($this->work_hh_o_pm);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->work_hh_o_pm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- hh_leavetype
   function NM_sub_cons_hh_leavetype()
   {
         $this->hh_leavetype = NM_charset_to_utf8($this->hh_leavetype);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->hh_leavetype;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- deduct_assurance
   function NM_sub_cons_deduct_assurance()
   {
         $this->deduct_assurance = NM_charset_to_utf8($this->deduct_assurance);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->deduct_assurance;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- deductions
   function NM_sub_cons_deductions()
   {
      if (!empty($this->deductions))
      {
         if ($this->deductions !== "&nbsp;") 
         ...
         $this->deductions = html_entity_decode($this->deductions, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->deductions = NM_charset_to_utf8($this->deductions);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->deductions;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_irisal()
   {
      if (!empty($this->irisal))
      {
         ...
         $this->irisal = html_entity_decode($this->irisal, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->irisal = NM_charset_to_utf8($this->irisal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->irisal;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- incentive_lbl
   function NM_sub_cons_incentive_lbl()
   {
      if (!empty($this->incentive_lbl))
      {
         if ($this->incentive_lbl !== "&nbsp;") 
         ...
         $this->incentive_lbl = html_entity_decode($this->incentive_lbl, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->incentive_lbl = NM_charset_to_utf8($this->incentive_lbl);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->incentive_lbl;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_ona()
   {
      if (!empty($this->ona))
      {
         ...
         $this->ona = html_entity_decode($this->ona, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ona = NM_charset_to_utf8($this->ona);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ona;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_12
   function NM_sub_cons_sc_field_12()
   {
      if (!empty($this->sc_field_12))
      {
         if ($this->sc_field_12 !== "&nbsp;") 
         ...
         $this->sc_field_12 = html_entity_decode($this->sc_field_12, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_12 = NM_charset_to_utf8($this->sc_field_12);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_12;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_13
   function NM_sub_cons_sc_field_13()
   {
      if (!empty($this->sc_field_13))
      {
         if ($this->sc_field_13 !== "&nbsp;") 
         ...
         $this->sc_field_13 = html_entity_decode($this->sc_field_13, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_13 = NM_charset_to_utf8($this->sc_field_13);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_13;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_14
   function NM_sub_cons_sc_field_14()
   {
      if (!empty($this->sc_field_14))
      {
         if ($this->sc_field_14 !== "&nbsp;") 
         ...
         $this->sc_field_14 = html_entity_decode($this->sc_field_14, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_14 = NM_charset_to_utf8($this->sc_field_14);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_14;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_15
   function NM_sub_cons_sc_field_15()
   {
      if (!empty($this->sc_field_15))
      {
         if ($this->sc_field_15 !== "&nbsp;") 
         ...
         $this->sc_field_15 = html_entity_decode($this->sc_field_15, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_15 = NM_charset_to_utf8($this->sc_field_15);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_15;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_16
   function NM_sub_cons_sc_field_16()
   {
      if (!empty($this->sc_field_16))
      {
         if ($this->sc_field_16 !== "&nbsp;") 
         ...
         $this->sc_field_16 = html_entity_decode($this->sc_field_16, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_16 = NM_charset_to_utf8($this->sc_field_16);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_16;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_17
   function NM_sub_cons_sc_field_17()
   {
      if (!empty($this->sc_field_17))
      {
         if ($this->sc_field_17 !== "&nbsp;") 
         ...
         $this->sc_field_17 = html_entity_decode($this->sc_field_17, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_17 = NM_charset_to_utf8($this->sc_field_17);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_17;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_18
   function NM_sub_cons_sc_field_18()
   {
      if (!empty($this->sc_field_18))
      {
         if ($this->sc_field_18 !== "&nbsp;") 
         ...
         $this->sc_field_18 = html_entity_decode($this->sc_field_18, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_18 = NM_charset_to_utf8($this->sc_field_18);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_18;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_19
   function NM_sub_cons_sc_field_19()
   {
      if (!empty($this->sc_field_19))
      {
         if ($this->sc_field_19 !== "&nbsp;") 
         ...
         $this->sc_field_19 = html_entity_decode($this->sc_field_19, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_19 = NM_charset_to_utf8($this->sc_field_19);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_19;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_20
   function NM_sub_cons_sc_field_20()
   {
      if (!empty($this->sc_field_20))
      {
         if ($this->sc_field_20 !== "&nbsp;") 
         ...
         $this->sc_field_20 = html_entity_decode($this->sc_field_20, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_20 = NM_charset_to_utf8($this->sc_field_20);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_20;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_21
   function NM_sub_cons_sc_field_21()
   {
      if (!empty($this->sc_field_21))
      {
         if ($this->sc_field_21 !== "&nbsp;") 
         ...
         $this->sc_field_21 = html_entity_decode($this->sc_field_21, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_21 = NM_charset_to_utf8($this->sc_field_21);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_21;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_holiday
   function NM_sub_cons_lbl_holiday()
   {
      if (!empty($this->lbl_holiday))
      {
         if ($this->lbl_holiday !== "&nbsp;") 
         ...
         $this->lbl_holiday = html_entity_decode($this->lbl_holiday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_holiday = NM_charset_to_utf8($this->lbl_holiday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_holiday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sc_field_22
   function NM_sub_cons_sc_field_22()
   {
      if (!empty($this->sc_field_22))
      {
         if ($this->sc_field_22 !== "&nbsp;") 
         ...
         $this->sc_field_22 = html_entity_decode($this->sc_field_22, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sc_field_22 = NM_charset_to_utf8($this->sc_field_22);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sc_field_22;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_holidayhh
   function NM_sub_cons_lbl_holidayhh()
   {
      if (!empty($this->lbl_holidayhh))
      {
         if ($this->lbl_holidayhh !== "&nbsp;") 
         ...
         $this->lbl_holidayhh = html_entity_decode($this->lbl_holidayhh, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_holidayhh = NM_charset_to_utf8($this->lbl_holidayhh);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_holidayhh;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_hourearned
   function NM_sub_cons_lbl_hourearned()
   {
      if (!empty($this->lbl_hourearned))
      {
         if ($this->lbl_hourearned !== "&nbsp;") 
         ...
         $this->lbl_hourearned = html_entity_decode($this->lbl_hourearned, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_hourearned = NM_charset_to_utf8($this->lbl_hourearned);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_hourearned;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_leavetypebenefits
   function NM_sub_cons_lbl_leavetypebenefits()
   {
      if (!empty($this->lbl_leavetypebenefits))
      {
         if ($this->lbl_leavetypebenefits !== "&nbsp;") 
         ...
         $this->lbl_leavetypebenefits = html_entity_decode($this->lbl_leavetypebenefits, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_leavetypebenefits = NM_charset_to_utf8($this->lbl_leavetypebenefits);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_leavetypebenefits;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_mealrate
   function NM_sub_cons_lbl_mealrate()
   {
      if (!empty($this->lbl_mealrate))
      {
         if ($this->lbl_mealrate !== "&nbsp;") 
         ...
         $this->lbl_mealrate = html_entity_decode($this->lbl_mealrate, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_mealrate = NM_charset_to_utf8($this->lbl_mealrate);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_mealrate;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_mealday
   function NM_sub_cons_lbl_mealday()
   {
      if (!empty($this->lbl_mealday))
      {
         if ($this->lbl_mealday !== "&nbsp;") 
         ...
         $this->lbl_mealday = html_entity_decode($this->lbl_mealday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_mealday = NM_charset_to_utf8($this->lbl_mealday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_mealday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_ratework
   function NM_sub_cons_lbl_ratework()
   {
      if (!empty($this->lbl_ratework))
      {
         if ($this->lbl_ratework !== "&nbsp;") 
         ...
         $this->lbl_ratework = html_entity_decode($this->lbl_ratework, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_ratework = NM_charset_to_utf8($this->lbl_ratework);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_ratework;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_restday
   function NM_sub_cons_lbl_restday()
   {
      if (!empty($this->lbl_restday))
      {
         if ($this->lbl_restday !== "&nbsp;") 
         ...
         $this->lbl_restday = html_entity_decode($this->lbl_restday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_restday = NM_charset_to_utf8($this->lbl_restday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_restday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salholiday
   function NM_sub_cons_lbl_salholiday()
   {
      if (!empty($this->lbl_salholiday))
      {
         if ($this->lbl_salholiday !== "&nbsp;") 
         ...
         $this->lbl_salholiday = html_entity_decode($this->lbl_salholiday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salholiday = NM_charset_to_utf8($this->lbl_salholiday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salholiday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_saloffday
   function NM_sub_cons_lbl_saloffday()
   {
      if (!empty($this->lbl_saloffday))
      {
         if ($this->lbl_saloffday !== "&nbsp;") 
         ...
         $this->lbl_saloffday = html_entity_decode($this->lbl_saloffday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_saloffday = NM_charset_to_utf8($this->lbl_saloffday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_saloffday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salrestday
   function NM_sub_cons_lbl_salrestday()
   {
      if (!empty($this->lbl_salrestday))
      {
         if ($this->lbl_salrestday !== "&nbsp;") 
         ...
         $this->lbl_salrestday = html_entity_decode($this->lbl_salrestday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salrestday = NM_charset_to_utf8($this->lbl_salrestday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salrestday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salworkday
   function NM_sub_cons_lbl_salworkday()
   {
      if (!empty($this->lbl_salworkday))
      {
         if ($this->lbl_salworkday !== "&nbsp;") 
         ...
         $this->lbl_salworkday = html_entity_decode($this->lbl_salworkday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salworkday = NM_charset_to_utf8($this->lbl_salworkday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salworkday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_sal_reg
   function NM_sub_cons_lbl_sal_reg()
   {
      if (!empty($this->lbl_sal_reg))
      {
         if ($this->lbl_sal_reg !== "&nbsp;") 
         ...
         $this->lbl_sal_reg = html_entity_decode($this->lbl_sal_reg, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_sal_reg = NM_charset_to_utf8($this->lbl_sal_reg);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_sal_reg;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_sundaybenefits
   function NM_sub_cons_lbl_sundaybenefits()
   {
      if (!empty($this->lbl_sundaybenefits))
      {
         if ($this->lbl_sundaybenefits !== "&nbsp;") 
         ...
         $this->lbl_sundaybenefits = html_entity_decode($this->lbl_sundaybenefits, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_sundaybenefits = NM_charset_to_utf8($this->lbl_sundaybenefits);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_sundaybenefits;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_sundayhh
   function NM_sub_cons_lbl_sundayhh()
   {
      if (!empty($this->lbl_sundayhh))
      {
         if ($this->lbl_sundayhh !== "&nbsp;") 
         ...
         $this->lbl_sundayhh = html_entity_decode($this->lbl_sundayhh, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_sundayhh = NM_charset_to_utf8($this->lbl_sundayhh);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_sundayhh;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_workay
   function NM_sub_cons_lbl_workay()
   {
      if (!empty($this->lbl_workay))
      {
         if ($this->lbl_workay !== "&nbsp;") 
         ...
         $this->lbl_workay = html_entity_decode($this->lbl_workay, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_workay = NM_charset_to_utf8($this->lbl_workay);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_workay;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_amount01
   function NM_sub_cons_lbl_amount01()
   {
      if (!empty($this->lbl_amount01))
      {
         if ($this->lbl_amount01 !== "&nbsp;") 
         ...
         $this->lbl_amount01 = html_entity_decode($this->lbl_amount01, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_amount01 = NM_charset_to_utf8($this->lbl_amount01);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_amount01;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_assurance
   function NM_sub_cons_lbl_assurance()
   {
      if (!empty($this->lbl_assurance))
      {
         if ($this->lbl_assurance !== "&nbsp;") 
         ...
         $this->lbl_assurance = html_entity_decode($this->lbl_assurance, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_assurance = NM_charset_to_utf8($this->lbl_assurance);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_assurance;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_companyname
   function NM_sub_cons_lbl_companyname()
   {
      if (!empty($this->lbl_companyname))
      {
         if ($this->lbl_companyname !== "&nbsp;") 
         ...
         $this->lbl_companyname = NM_charset_to_utf8($this->lbl_companyname);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_companyname;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_deductions
   function NM_sub_cons_lbl_deductions()
   {
      if (!empty($this->lbl_deductions))
      {
         if ($this->lbl_deductions !== "&nbsp;") 
         ...
         $this->lbl_deductions = html_entity_decode($this->lbl_deductions, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_deductions = NM_charset_to_utf8($this->lbl_deductions);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_deductions;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_lbl_dept()
   {
      if (!empty($this->lbl_dept))
      {
         ...
         $this->lbl_dept = html_entity_decode($this->lbl_dept, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_dept = NM_charset_to_utf8($this->lbl_dept);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_dept;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_earning
   function NM_sub_cons_lbl_earning()
   {
      if (!empty($this->lbl_earning))
      {
         if ($this->lbl_earning !== "&nbsp;") 
         ...
         $this->lbl_earning = html_entity_decode($this->lbl_earning, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_earning = NM_charset_to_utf8($this->lbl_earning);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_earning;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_employeename
   function NM_sub_cons_lbl_employeename()
   {
      if (!empty($this->lbl_employeename))
      {
         if ($this->lbl_employeename !== "&nbsp;") 
         ...
         $this->lbl_employeename = html_entity_decode($this->lbl_employeename, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_employeename = NM_charset_to_utf8($this->lbl_employeename);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_employeename;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_fixedsalary
   function NM_sub_cons_lbl_fixedsalary()
   {
      if (!empty($this->lbl_fixedsalary))
      {
         if ($this->lbl_fixedsalary !== "&nbsp;") 
         ...
         $this->lbl_fixedsalary = html_entity_decode($this->lbl_fixedsalary, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_fixedsalary = NM_charset_to_utf8($this->lbl_fixedsalary);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_fixedsalary;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_leavehh
   function NM_sub_cons_lbl_leavehh()
   {
      if (!empty($this->lbl_leavehh))
      {
         if ($this->lbl_leavehh !== "&nbsp;") 
         ...
         $this->lbl_leavehh = html_entity_decode($this->lbl_leavehh, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_leavehh = NM_charset_to_utf8($this->lbl_leavehh);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_leavehh;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_line01
   function NM_sub_cons_lbl_line01()
   {
      if (!empty($this->lbl_line01))
      {
         if ($this->lbl_line01 !== "&nbsp;") 
         ...
         $this->lbl_line01 = html_entity_decode($this->lbl_line01, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_line01 = NM_charset_to_utf8($this->lbl_line01);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_line01;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_offday
   function NM_sub_cons_lbl_offday()
   {
      if (!empty($this->lbl_offday))
      {
         if ($this->lbl_offday !== "&nbsp;") 
         ...
         $this->lbl_offday = html_entity_decode($this->lbl_offday, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_offday = NM_charset_to_utf8($this->lbl_offday);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_offday;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_payslip
   function NM_sub_cons_lbl_payslip()
   {
      if (!empty($this->lbl_payslip))
      {
         if ($this->lbl_payslip !== "&nbsp;") 
         ...
         $this->lbl_payslip = html_entity_decode($this->lbl_payslip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_payslip = NM_charset_to_utf8($this->lbl_payslip);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_payslip;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_rappel
   function NM_sub_cons_lbl_rappel()
   {
      if (!empty($this->lbl_rappel))
      {
         if ($this->lbl_rappel !== "&nbsp;") 
         ...
         $this->lbl_rappel = html_entity_decode($this->lbl_rappel, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_rappel = NM_charset_to_utf8($this->lbl_rappel);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_rappel;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salholidaydet
   function NM_sub_cons_lbl_salholidaydet()
   {
      if (!empty($this->lbl_salholidaydet))
      {
         if ($this->lbl_salholidaydet !== "&nbsp;") 
         ...
         $this->lbl_salholidaydet = html_entity_decode($this->lbl_salholidaydet, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salholidaydet = NM_charset_to_utf8($this->lbl_salholidaydet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salholidaydet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_saloffdaydet
   function NM_sub_cons_lbl_saloffdaydet()
   {
      if (!empty($this->lbl_saloffdaydet))
      {
         if ($this->lbl_saloffdaydet !== "&nbsp;") 
         ...
         $this->lbl_saloffdaydet = html_entity_decode($this->lbl_saloffdaydet, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_saloffdaydet = NM_charset_to_utf8($this->lbl_saloffdaydet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_saloffdaydet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salrestdaydet
   function NM_sub_cons_lbl_salrestdaydet()
   {
      if (!empty($this->lbl_salrestdaydet))
      {
         if ($this->lbl_salrestdaydet !== "&nbsp;") 
         ...
         $this->lbl_salrestdaydet = html_entity_decode($this->lbl_salrestdaydet, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salrestdaydet = NM_charset_to_utf8($this->lbl_salrestdaydet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salrestdaydet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_salworkdaydet
   function NM_sub_cons_lbl_salworkdaydet()
   {
      if (!empty($this->lbl_salworkdaydet))
      {
         if ($this->lbl_salworkdaydet !== "&nbsp;") 
         ...
         $this->lbl_salworkdaydet = html_entity_decode($this->lbl_salworkdaydet, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_salworkdaydet = NM_charset_to_utf8($this->lbl_salworkdaydet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_salworkdaydet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_taxcass
   function NM_sub_cons_lbl_taxcass()
   {
      if (!empty($this->lbl_taxcass))
      {
         if ($this->lbl_taxcass !== "&nbsp;") 
         ...
         $this->lbl_taxcass = html_entity_decode($this->lbl_taxcass, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_taxcass = NM_charset_to_utf8($this->lbl_taxcass);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_taxcass;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_taxcfgdct
   function NM_sub_cons_lbl_taxcfgdct()
   {
      if (!empty($this->lbl_taxcfgdct))
      {
         if ($this->lbl_taxcfgdct !== "&nbsp;") 
         ...
         $this->lbl_taxcfgdct = html_entity_decode($this->lbl_taxcfgdct, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_taxcfgdct = NM_charset_to_utf8($this->lbl_taxcfgdct);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_taxcfgdct;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lbl_taxfdu
   function NM_sub_cons_lbl_taxfdu()
   {
      if (!empty($this->lbl_taxfdu))
      {
         if ($this->lbl_taxfdu !== "&nbsp;") 
         ...
         $this->lbl_taxfdu = html_entity_decode($this->lbl_taxfdu, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lbl_taxfdu = NM_charset_to_utf8($this->lbl_taxfdu);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lbl_taxfdu;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> tbl_salary :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
