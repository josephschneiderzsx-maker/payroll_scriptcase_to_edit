<?php
class pdf_payslip_french_allv1_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdf_payslip_french_allv1']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_select']['dept'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_select']['userid_int'] = 'asc'; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_ant']  = "dept,userid_int"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['userid_int'] = "Userid Int";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['hiredate'] = "Hiredate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['username'] = "Username";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['dept'] = "Dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['designation'] = "Designation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['rate_work'] = "Rate Work";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['rate_salf'] = "Rate SALF";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_workday'] = "Income Workday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_holiday'] = "Income Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_restday'] = "Income Restday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_offday'] = "Income Offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_sunday'] = "Sal Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_holiday'] = "Sal Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_leavetype'] = "Sal Leavetype";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_brut_reg'] = "Sal Brut Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_workday_ot'] = "Income Workday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_holiday_ot'] = "Income Holiday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_restday_ot'] = "Income Restday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_offday_ot'] = "Income Offday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['incentive'] = "Incentive";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['income_comm'] = "Income Comm";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['rappel'] = "Rappel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_cass'] = "Tax Cass";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_cfgdct'] = "Tax Cfgdct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_fdu'] = "Tax Fdu";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_ona'] = "Tax Ona";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_iric'] = "Tax Iric";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['dedeuct_cons'] = "Dedeuct Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['loan_deduction'] = "Loan Deduction";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['loan_deduction_bank'] = "Loan Deduction Bank";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['other_deduct'] = "Other Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['total_deduct'] = "Total Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_net'] = "Sal Net";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_w'] = "Work Hh W";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_w'] = "Ot Hh W";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['hh_sunday'] = "Hh Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_r'] = "Work Hh R";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_r'] = "Ot Hh R";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['hh_offday'] = "Hh Offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_h'] = "Work Hh H";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_h'] = "Ot Hh H";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_hr_worked'] = "Sal Hr Worked";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_sunday_1'] = "Sal Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_holiday_1'] = "Sal Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_brut_reg_1'] = "Sal Brut Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_suppl'] = "Sal Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_holiday_worked_suppl'] = "Sal Holiday Worked Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_holiday_suppl'] = "Sal Holiday Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_restday_worked_suppl'] = "Sal Restday Worked Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sal_restday_suppl'] = "Sal Restday Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['tax_iris'] = "Tax Iris";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['day_cons'] = "Day Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['rate_cons'] = "Rate Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['other_loan_deduction'] = "Other Loan Deduction";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['other_deduct_1'] = "Other Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['other_deduct_desc'] = "Other Deduct Desc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['bank_number'] = "Bank Number";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['pay_startdate'] = "Pay Startdate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['pay_enddate'] = "Pay Enddate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_w_pm'] = "Work Hh W PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_w_pm'] = "Ot Hh W PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_h_pm'] = "Work Hh H PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_h_pm'] = "Ot Hh H PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_r_pm'] = "Work Hh R PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_r_pm'] = "Ot Hh R PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_o'] = "Work Hh O";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['work_hh_o_pm'] = "Work Hh O PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_o'] = "Ot Hh O";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ot_hh_o_pm'] = "Ot Hh O PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['hh_leavetype'] = "Hh Leavetype";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['deduct_assurance'] = "Deduct Assurance";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['amount'] = "Amount";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_0'] = "Attendance AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_1'] = "Attendance PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_2'] = "Deduct Loan Bank";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_3'] = "Deduct Loan Enterprise";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_4'] = "Deduct Meal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_5'] = "Deduct Other";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['deductions'] = "Deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_6'] = "Employee Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_7'] = "Fingertec ID";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['irisal'] = "IRISal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['incentive_lbl'] = "Incentive_lbl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_8'] = "NET EARNINGS";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['ona'] = "ONA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_9'] = "OT AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_10'] = "OT PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_11'] = "Pay From";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_12'] = "Pay To";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_13'] = "Rappel / Extra";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_14'] = "Sal. Holiday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_15'] = "Sal. Offday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_16'] = "Sal. Restday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_17'] = "Sal. Workday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_18'] = "TCA Add";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_19'] = "Tota Sal. Additional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_20'] = "Total Deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_21'] = "Workday AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_holiday'] = "lbl_Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['sc_field_22'] = "lbl_HolidayBenefits ";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_holidayhh'] = "lbl_HolidayHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_hourearned'] = "lbl_Hourearned";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_leavetypebenefits'] = "lbl_LeavetypeBenefits";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_mealrate'] = "Prix repas";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_mealday'] = "lbl_Mealday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_ratework'] = "lbl_RateWork";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_restday'] = "lbl_Restday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salholiday'] = "lbl_SalHoliday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_saloffday'] = "lbl_SalOffday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salrestday'] = "lbl_SalRestday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salworkday'] = "lbl_SalWorkday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_sal_reg'] = "lbl_Sal_Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_sundaybenefits'] = "lbl_SundayBenefits";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_sundayhh'] = "lbl_SundayHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_workay'] = "lbl_Workay";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_amount01'] = "lbl_amount01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_assurance'] = "lbl_assurance";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_companyname'] = "lbl_companyname";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_deductions'] = "lbl_deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_dept'] = "lbl_dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_earning'] = "lbl_earning";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_employeename'] = "lbl_employeename";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_fixedsalary'] = "lbl_fixedsalary";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_leavehh'] = "lbl_leaveHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_line01'] = "lbl_line01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_offday'] = "lbl_offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_payslip'] = "lbl_payslip";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_rappel'] = "lbl_rappel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salholidaydet'] = "lbl_salHolidaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_saloffdaydet'] = "lbl_salOffdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salrestdaydet'] = "lbl_salRestdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_salworkdaydet'] = "lbl_salWorkdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_taxcass'] = "lbl_taxCASS";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_taxcfgdct'] = "lbl_taxCFGDCT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['labels']['lbl_taxfdu'] = "lbl_taxFDU";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_french_allv1']['lig_edit'];
   }
...
// 
   ...
   $Contr_Y_init          = 6.527773541665844; 
   $Contr_lin_Pdf         = 0; 
   ...
   {  
      ...
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['qt_col_grid']) 
      {  
          ...
          $this->deduct_assurance[$this->nm_grid_colunas] = $this->rs_grid->fields[70] ;  
          $this->deduct_assurance[$this->nm_grid_colunas] =  str_replace(",", ".", $this->deduct_assurance[$this->nm_grid_colunas]);
          $this->deduct_assurance[$this->nm_grid_colunas] = (string)$this->deduct_assurance[$this->nm_grid_colunas];
          ...
          $this->lbl_assurance[$this->nm_grid_colunas] = "";
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $this->deduct_assurance[$this->nm_grid_colunas] = NM_encode_input(sc_strip_script($this->deduct_assurance[$this->nm_grid_colunas]));
          }
          else {
              $this->deduct_assurance[$this->nm_grid_colunas] = sc_strip_script($this->deduct_assurance[$this->nm_grid_colunas]);
          }
          if ($this->deduct_assurance[$this->nm_grid_colunas] === "") 
          { 
              $this->deduct_assurance[$this->nm_grid_colunas] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->deduct_assurance[$this->nm_grid_colunas], ",", ".", "2", "S", "2", "HTG", "V:3:12", "-") ; 
          } 
          $this->deduct_assurance[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->deduct_assurance[$this->nm_grid_colunas]);
          ...
          $this->nm_gera_mask($this->amount[$this->nm_grid_colunas], "MONTANT"); 
          ...
          $this->nm_gera_mask($this->sc_field_2[$this->nm_grid_colunas], "Prêt ONA"); 
          ...
          $this->nm_gera_mask($this->sc_field_3[$this->nm_grid_colunas], "Prêt ENT"); 
          ...
          if ($this->sc_field_4[$this->nm_grid_colunas] !== "") 
          { 
              $this->sc_field_4[$this->nm_grid_colunas] = sc_strtolower($this->sc_field_4[$this->nm_grid_colunas]); 
              $this->sc_field_4[$this->nm_grid_colunas] = ucfirst($this->sc_field_4[$this->nm_grid_colunas]); 
          } 
          $this->nm_gera_mask($this->sc_field_4[$this->nm_grid_colunas], "Repas"); 
          ...
          $this->nm_gera_mask($this->sc_field_5[$this->nm_grid_colunas], "Autre deduct"); 
          ...
          $this->nm_gera_mask($this->sc_field_6[$this->nm_grid_colunas], "PRENOM & NOM"); 
          ...
          $this->nm_gera_mask($this->incentive_lbl[$this->nm_grid_colunas], "E𝑥tra"); 
          ...
          $this->nm_gera_mask($this->sc_field_8[$this->nm_grid_colunas], "SALAIRE NET"); 
          ...
          $this->nm_gera_mask($this->sc_field_11[$this->nm_grid_colunas], "Payroll du"); 
          ...
          $this->nm_gera_mask($this->sc_field_12[$this->nm_grid_colunas], "au"); 
          ...
          $this->nm_gera_mask($this->sc_field_13[$this->nm_grid_colunas], "lang_lbl_extra"); 
          ...
          $this->nm_gera_mask($this->sc_field_14[$this->nm_grid_colunas], "OT jour férié"); 
          ...
          $this->nm_gera_mask($this->sc_field_15[$this->nm_grid_colunas], "OT jour OFF"); 
          ...
          $this->nm_gera_mask($this->sc_field_16[$this->nm_grid_colunas], "OT jour repos"); 
          ...
          $this->nm_gera_mask($this->sc_field_17[$this->nm_grid_colunas], "OT jour régulier"); 
          ...
          $this->nm_gera_mask($this->sc_field_21[$this->nm_grid_colunas], "Jour travail"); 
          ...
          $this->nm_gera_mask($this->lbl_holiday[$this->nm_grid_colunas], "Fériés"); 
          ...
          $this->nm_gera_mask($this->sc_field_22[$this->nm_grid_colunas], "Gain fériés"); 
          ...
          $this->nm_gera_mask($this->lbl_holidayhh[$this->nm_grid_colunas], "Fériés"); 
          ...
          $this->nm_gera_mask($this->lbl_hourearned[$this->nm_grid_colunas], "Gain Heures"); 
          ...
          $this->nm_gera_mask($this->lbl_leavetypebenefits[$this->nm_grid_colunas], "Gain congés"); 
          ...
          if ($this->lbl_mealrate[$this->nm_grid_colunas] !== "") 
          { 
              $this->lbl_mealrate[$this->nm_grid_colunas] = sc_strtolower($this->lbl_mealrate[$this->nm_grid_colunas]); 
              $this->lbl_mealrate[$this->nm_grid_colunas] = ucfirst($this->lbl_mealrate[$this->nm_grid_colunas]); 
          } 
          $this->nm_gera_mask($this->lbl_mealrate[$this->nm_grid_colunas], "Pri repas"); 
          ...
          $this->nm_gera_mask($this->lbl_mealday[$this->nm_grid_colunas], "Repas"); 
          ...
          $this->nm_gera_mask($this->lbl_ratework[$this->nm_grid_colunas], "Salaire horaire"); 
          ...
          $this->nm_gera_mask($this->lbl_restday[$this->nm_grid_colunas], "Repos"); 
          ...
          $this->nm_gera_mask($this->lbl_salholiday[$this->nm_grid_colunas], "Jour fériés"); 
          ...
          $this->nm_gera_mask($this->lbl_saloffday[$this->nm_grid_colunas], "Jour OFF"); 
          ...
          $this->nm_gera_mask($this->lbl_salrestday[$this->nm_grid_colunas], "Jour repos"); 
          ...
          $this->nm_gera_mask($this->lbl_salworkday[$this->nm_grid_colunas], "Jour régulier"); 
          ...
          $this->nm_gera_mask($this->lbl_sal_reg[$this->nm_grid_colunas], "Total Sal. Reg"); 
          ...
          $this->nm_gera_mask($this->lbl_sundaybenefits[$this->nm_grid_colunas], "Gain Dimanche"); 
          ...
          $this->nm_gera_mask($this->lbl_sundayhh[$this->nm_grid_colunas], "Dimanche"); 
          ...
          $this->nm_gera_mask($this->lbl_workay[$this->nm_grid_colunas], "Réguliers"); 
          ...
          $this->nm_gera_mask($this->lbl_amount01[$this->nm_grid_colunas], "MONTANT"); 
          $this->lbl_amount01[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->lbl_amount01[$this->nm_grid_colunas]);
          if ($this->lbl_assurance[$this->nm_grid_colunas] === "") 
          { 
              $this->lbl_assurance[$this->nm_grid_colunas] = "" ;  
          } 
          $this->nm_gera_mask($this->lbl_assurance[$this->nm_grid_colunas], "Assurance"); 
          $this->lbl_assurance[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->lbl_assurance[$this->nm_grid_colunas]);
          $this->Lookup->lookup_lbl_companyname($this->lbl_companyname[$this->nm_grid_colunas], $this->array_lbl_companyname); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_french_allv1']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          $this->nm_gera_mask($this->lbl_earning[$this->nm_grid_colunas], "GAINS"); 
          ...
          $this->nm_gera_mask($this->lbl_employeename[$this->nm_grid_colunas], "PRENOM & NOM"); 
          ...
          $this->nm_gera_mask($this->lbl_leavehh[$this->nm_grid_colunas], "Congés"); 
          ...
          $this->nm_gera_mask($this->lbl_offday[$this->nm_grid_colunas], "OFF"); 
          ...
          $this->nm_gera_mask($this->lbl_payslip[$this->nm_grid_colunas], "FICHE DE PAIE"); 
          ...
          $this->nm_gera_mask($this->lbl_rappel[$this->nm_grid_colunas], "Divers"); 
          ...
          $this->lbl_taxfdu[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->lbl_taxfdu[$this->nm_grid_colunas]);
            $cell_username = array('posx' => '38', 'posy' => '13', 'data' => $this->username[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cellpaystartdate = array('posx' => '25', 'posy' => '20.99706874999735', 'data' => $this->pay_startdate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            ...
            $cell_totaldeduct = array('posx' => '95', 'posy' => '75', 'data' => $this->total_deduct[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            $cellIncomeComm = array('posx' => '35', 'posy' => '85', 'data' => $this->income_comm[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            ...
            $cell_89 = array('posx' => '9.20480124999884', 'posy' => '89.68845833332203', 'data' => $this->SC_conv_utf8('________________________________________________________________________________________'), 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $celllblpayslip = array('posx' => '84.74524791665598', 'posy' => '6.527773541665844', 'data' => $this->lbl_payslip[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '15', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'BU');
            ...
            $cell_DeductMeal = array('posx' => '95', 'posy' => '57', 'data' => $this->dedeuct_cons[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_DeductLoan = array('posx' => '95', 'posy' => '61', 'data' => $this->loan_deduction[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_DeductLoanBank = array('posx' => '95', 'posy' => '65', 'data' => $this->loan_deduction_bank[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_deductOther = array('posx' => '95', 'posy' => '69', 'data' => $this->other_deduct[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_PayEndDate = array('posx' => '52', 'posy' => '21', 'data' => $this->pay_enddate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            $cell_Rappel = array('posx' => '35', 'posy' => '81', 'data' => $this->rappel[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_sc_field_19 = array('posx' => '9.5', 'posy' => '85', 'data' => $this->sc_field_19[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            $cell_sc_field_13 = array('posx' => '9.5', 'posy' => '80.99557291665646', 'data' => $this->lbl_rappel[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_sc_field_6 = array('posx' => '9.5', 'posy' => '13', 'data' => $this->sc_field_6[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            ...
            $cell_sc_field_12 = array('posx' => '45.5', 'posy' => '21', 'data' => $this->sc_field_12[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_sc_field_4 = array('posx' => '69.5', 'posy' => '57', 'data' => $this->sc_field_4[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sc_field_3 = array('posx' => '69.5', 'posy' => '61', 'data' => $this->sc_field_3[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sc_field_2 = array('posx' => '69.5', 'posy' => '65', 'data' => $this->sc_field_2[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sc_field_5 = array('posx' => '69.5', 'posy' => '69', 'data' => $this->sc_field_5[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_sc_field_20 = array('posx' => '69.5', 'posy' => '75', 'data' => $this->sc_field_20[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            ...
            $cell_RateWork = array('posx' => '135', 'posy' => '21', 'data' => $this->rate_work[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => 'B');
            ...
            $cell_lbl_MealRate = array('posx' => '130', 'posy' => '59', 'data' => $this->lbl_mealrate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'Times', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_Linexxx = array('posx' => '129.9654499999836', 'posy' => '58.90736249999257', 'data' => $this->SC_conv_utf8('_______________________________________'), 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_lbl_ratemeal = array('posx' => '180', 'posy' => '59', 'data' => $this->designation[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_lbl_assurance = array('posx' => '69.5', 'posy' => '53', 'data' => $this->lbl_assurance[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_assurance = array('posx' => '95', 'posy' => '53', 'data' => $this->deduct_assurance[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($celllblpayslip['font_type'], $celllblpayslip['font_style'], $celllblpayslip['font_size']);
            $this->pdf_text_color($celllblpayslip['data'], $celllblpayslip['color_r'], $celllblpayslip['color_g'], $celllblpayslip['color_b']);
            if (!empty($celllblpayslip['posx']) && !empty($celllblpayslip['posy']))
            {
                $this->Pdf->SetXY($celllblpayslip['posx'] + $this->SC_incr_col,  $celllblpayslip['posy'] + $this->SC_incr_lin);
            }
            elseif (!empty($celllblpayslip['posx']))
            {
                $this->Pdf->SetX($celllblpayslip['posx'] + $this->SC_incr_col);
            }
            elseif (!empty($celllblpayslip['posy']))
            {
                $this->Pdf->SetY($celllblpayslip['posy'] + $this->SC_incr_lin);
            }
            $this->Pdf->Cell($celllblpayslip['width'], 0, $celllblpayslip['data'], 0, 0, $celllblpayslip['align']);
            ...
            $this->Pdf->SetFont($cell_lbl_ratemeal['font_type'], $cell_lbl_ratemeal['font_style'], $cell_lbl_ratemeal['font_size']);
            $this->pdf_text_color($cell_lbl_ratemeal['data'], $cell_lbl_ratemeal['color_r'], $cell_lbl_ratemeal['color_g'], $cell_lbl_ratemeal['color_b']);
            if (!empty($cell_lbl_ratemeal['posx']) && !empty($cell_lbl_ratemeal['posy']))
            {
                $this->Pdf->SetXY($cell_lbl_ratemeal['posx'] + $this->SC_incr_col,  $cell_lbl_ratemeal['posy'] + $this->SC_incr_lin);
            }
            elseif (!empty($cell_lbl_ratemeal['posx']))
            {
                $this->Pdf->SetX($cell_lbl_ratemeal['posx'] + $this->SC_incr_col);
            }
            elseif (!empty($cell_lbl_ratemeal['posy']))
            {
                $this->Pdf->SetY($cell_lbl_ratemeal['posy'] + $this->SC_incr_lin);
            }
            $this->Pdf->Cell($cell_lbl_ratemeal['width'], 0, $cell_lbl_ratemeal['data'], 0, 0, $cell_lbl_ratemeal['align']);

            $this->Pdf->SetFont($cell_lbl_assurance['font_type'], $cell_lbl_assurance['font_style'], $cell_lbl_assurance['font_size']);
            $this->pdf_text_color($cell_lbl_assurance['data'], $cell_lbl_assurance['color_r'], $cell_lbl_assurance['color_g'], $cell_lbl_assurance['color_b']);
            if (!empty($cell_lbl_assurance['posx']) && !empty($cell_lbl_assurance['posy']))
            {
                $this->Pdf->SetXY($cell_lbl_assurance['posx'] + $this->SC_incr_col,  $cell_lbl_assurance['posy'] + $this->SC_incr_lin);
            }
            elseif (!empty($cell_lbl_assurance['posx']))
            {
                $this->Pdf->SetX($cell_lbl_assurance['posx'] + $this->SC_incr_col);
            }
            elseif (!empty($cell_lbl_assurance['posy']))
            {
                $this->Pdf->SetY($cell_lbl_assurance['posy'] + $this->SC_incr_lin);
            }
            $this->Pdf->Cell($cell_lbl_assurance['width'], 0, $cell_lbl_assurance['data'], 0, 0, $cell_lbl_assurance['align']);

            $this->Pdf->SetFont($cell_assurance['font_type'], $cell_assurance['font_style'], $cell_assurance['font_size']);
            $this->pdf_text_color($cell_assurance['data'], $cell_assurance['color_r'], $cell_assurance['color_g'], $cell_assurance['color_b']);
            if (!empty($cell_assurance['posx']) && !empty($cell_assurance['posy']))
            {
                $this->Pdf->SetXY($cell_assurance['posx'] + $this->SC_incr_col,  $cell_assurance['posy'] + $this->SC_incr_lin);
            }
            elseif (!empty($cell_assurance['posx']))
            {
                $this->Pdf->SetX($cell_assurance['posx'] + $this->SC_incr_col);
            }
            elseif (!empty($cell_assurance['posy']))
            {
                $this->Pdf->SetY($cell_assurance['posy'] + $this->SC_incr_lin);
            }
            $this->Pdf->Cell($cell_assurance['width'], 0, $cell_assurance['data'], 0, 0, $cell_assurance['align']);
          $max_Y = 0;
