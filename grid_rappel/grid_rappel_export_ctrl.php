<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rappel']['sc_process_barr'] = true;
require_once('../grid_rappel/index.php');
unset($_SESSION['scriptcase']['grid_rappel']['sc_process_barr']);
$ExportCtrl = new grid_rappel_export_control;
$ExportCtrl->Export_barr();

class grid_rappel_export_control
{
