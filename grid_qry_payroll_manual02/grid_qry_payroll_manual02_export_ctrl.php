<?php
@session_start() ;
$_SESSION['scriptcase']['grid_qry_payroll_manual02']['sc_process_barr'] = true;
require_once('../grid_qry_payroll_manual02/index.php');
unset($_SESSION['scriptcase']['grid_qry_payroll_manual02']['sc_process_barr']);
$ExportCtrl = new grid_qry_payroll_manual02_export_control;
$ExportCtrl->Export_barr();

class grid_qry_payroll_manual02_export_control
{
