<?php
@session_start() ;
$_SESSION['scriptcase']['grid_deduction_iris_hist']['sc_process_barr'] = true;
require_once('../grid_deduction_iris_hist/index.php');
unset($_SESSION['scriptcase']['grid_deduction_iris_hist']['sc_process_barr']);
$ExportCtrl = new grid_deduction_iris_hist_export_control;
$ExportCtrl->Export_barr();

class grid_deduction_iris_hist_export_control
{
