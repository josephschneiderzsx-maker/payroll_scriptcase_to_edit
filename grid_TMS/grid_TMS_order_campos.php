...
<?php
   ...
   $Ord_Cmp = new grid_TMS_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_TMS_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["userid_int"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["userid_int"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["userid_int"] : "ID";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["username"] : "Employee Name";
   $tab_ger_campos['pay_startdate'] = "on";
   $tab_def_campos['pay_startdate'] = "pay_startdate";
   $tab_labels["pay_startdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["pay_startdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["pay_startdate"] : "Start Date";
   $tab_ger_campos['pay_enddate'] = "on";
   $tab_def_campos['pay_enddate'] = "pay_enddate";
   $tab_labels["pay_enddate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["pay_enddate"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["pay_enddate"] : "End Date";
   $tab_ger_campos['sal_net'] = "on";
   $tab_def_campos['sal_net'] = "sal_net";
   $tab_labels["sal_net"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["sal_net"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["sal_net"] : "Net Income";
   $tab_ger_campos['tax_tms'] = "on";
   $tab_def_campos['tax_tms'] = "tax_tms";
   $tab_labels["tax_tms"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["tax_tms"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["tax_tms"] : "Tax TMS";
   $tab_ger_campos['tax_stamp'] = "on";
   $tab_def_campos['tax_stamp'] = "tax_stamp";
   $tab_labels["tax_stamp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["tax_stamp"])) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['labels']["tax_stamp"] : "Tax Stamp";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_TMS']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_TMS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_TMS']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
