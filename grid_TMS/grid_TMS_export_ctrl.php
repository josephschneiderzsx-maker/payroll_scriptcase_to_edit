<?php
@session_start() ;
$_SESSION['scriptcase']['grid_TMS']['sc_process_barr'] = true;
require_once('../grid_TMS/index.php');
unset($_SESSION['scriptcase']['grid_TMS']['sc_process_barr']);
$ExportCtrl = new grid_TMS_export_control;
$ExportCtrl->Export_barr();

class grid_TMS_export_control
{
