...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____pdf_payslip_search"]))
   {
      unset($_SESSION['session_sec_aplicacao']["PAYROLL_STANCO02_____pdf_payslip_search"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pdf_payslip_search</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pdf_payslip_search']['embutida_filho'] as $ind => $sc_init)
          {
