...
//
   ...
   $_SESSION['scriptcase']['pdf_payslip_search']['default_font'] = $this->default_font;
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['cols']);
   }
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_ant']  = "dept,userid_int"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['userid_int'] = "Userid Int";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['hiredate'] = "Hiredate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['username'] = "Username";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['dept'] = "Dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['designation'] = "Designation";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['rate_work'] = "Rate Work";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['rate_salf'] = "Rate SALF";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_workday'] = "Income Workday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_holiday'] = "Income Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_restday'] = "Income Restday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_offday'] = "Income Offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_sunday'] = "Sal Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_holiday'] = "Sal Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_leavetype'] = "Sal Leavetype";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_brut_reg'] = "Sal Brut Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_workday_ot'] = "Income Workday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_holiday_ot'] = "Income Holiday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_restday_ot'] = "Income Restday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_offday_ot'] = "Income Offday Ot";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['incentive'] = "Incentive";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['income_comm'] = "Income Comm";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['rappel'] = "Rappel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_cass'] = "Tax Cass";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_cfgdct'] = "Tax Cfgdct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_fdu'] = "Tax Fdu";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_ona'] = "Tax Ona";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_iric'] = "Tax Iric";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['dedeuct_cons'] = "Dedeuct Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['loan_deduction'] = "Loan Deduction";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['loan_deduction_bank'] = "Loan Deduction Bank";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['other_deduct'] = "Other Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['total_deduct'] = "Total Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_net'] = "Sal Net";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_w'] = "Work Hh W";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_w'] = "Ot Hh W";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['hh_sunday'] = "Hh Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_r'] = "Work Hh R";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_r'] = "Ot Hh R";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['hh_offday'] = "Hh Offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_h'] = "Work Hh H";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_h'] = "Ot Hh H";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_hr_worked'] = "Sal Hr Worked";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_sunday_1'] = "Sal Sunday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_holiday_1'] = "Sal Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_brut_reg_1'] = "Sal Brut Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_suppl'] = "Sal Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_holiday_worked_suppl'] = "Sal Holiday Worked Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_holiday_suppl'] = "Sal Holiday Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_restday_worked_suppl'] = "Sal Restday Worked Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sal_restday_suppl'] = "Sal Restday Suppl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['tax_iris'] = "Tax Iris";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['day_cons'] = "Day Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['rate_cons'] = "Rate Cons";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['other_loan_deduction'] = "Other Loan Deduction";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['other_deduct_1'] = "Other Deduct";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['other_deduct_desc'] = "Other Deduct Desc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['bank_number'] = "Bank Number";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['pay_startdate'] = "Pay Startdate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['pay_enddate'] = "Pay Enddate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_w_pm'] = "Work Hh W PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_w_pm'] = "Ot Hh W PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_h_pm'] = "Work Hh H PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_h_pm'] = "Ot Hh H PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_r_pm'] = "Work Hh R PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_r_pm'] = "Ot Hh R PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_o'] = "Work Hh O";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['work_hh_o_pm'] = "Work Hh O PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_o'] = "Ot Hh O";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ot_hh_o_pm'] = "Ot Hh O PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['hh_leavetype'] = "Hh Leavetype";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['amount'] = "Amount";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_0'] = "Attendance AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_1'] = "Attendance PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_2'] = "Deduct Loan Bank";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_3'] = "Deduct Loan Enterprise";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_4'] = "Deduct Meal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_5'] = "Deduct Other";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['deductions'] = "Deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_6'] = "Employee Name";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_7'] = "Fingertec ID";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['irisal'] = "IRISal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['incentive_lbl'] = "Incentive_lbl";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_8'] = "NET EARNINGS";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['ona'] = "ONA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_9'] = "OT AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_10'] = "OT PM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_11'] = "Pay From";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_12'] = "Pay To";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_13'] = "Rappel / Extra";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_14'] = "Sal. Holiday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_15'] = "Sal. Offday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_16'] = "Sal. Restday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_17'] = "Sal. Workday OT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_18'] = "TCA Add";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_19'] = "Tota Sal. Additional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_20'] = "Total Deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_21'] = "Workday AM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_holiday'] = "lbl_Holiday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['sc_field_22'] = "lbl_HolidayBenefits ";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_holidayhh'] = "lbl_HolidayHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_hourearned'] = "lbl_Hourearned";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_leavetypebenefits'] = "lbl_LeavetypeBenefits";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_mealrate'] = "lbl_MealRate";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_mealday'] = "lbl_Mealday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_ratework'] = "lbl_RateWork";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_restday'] = "lbl_Restday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salholiday'] = "lbl_SalHoliday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_saloffday'] = "lbl_SalOffday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salrestday'] = "lbl_SalRestday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salworkday'] = "lbl_SalWorkday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_sal_reg'] = "lbl_Sal_Reg";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_sundaybenefits'] = "lbl_SundayBenefits";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_sundayhh'] = "lbl_SundayHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_workay'] = "lbl_Workay";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_amount01'] = "lbl_amount01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_companyname'] = "lbl_companyname";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_deductions'] = "lbl_deductions";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_dept'] = "lbl_dept";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_earning'] = "lbl_earning";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_employeename'] = "lbl_employeename";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_fixedsalary'] = "lbl_fixedsalary";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_leavehh'] = "lbl_leaveHH";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_line01'] = "lbl_line01";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_offday'] = "lbl_offday";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_payslip'] = "lbl_payslip";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_rappel'] = "lbl_rappel";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salholidaydet'] = "lbl_salHolidaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_saloffdaydet'] = "lbl_salOffdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salrestdaydet'] = "lbl_salRestdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_salworkdaydet'] = "lbl_salWorkdaydet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_taxcass'] = "lbl_taxCASS";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_taxcfgdct'] = "lbl_taxCFGDCT";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['labels']['lbl_taxfdu'] = "lbl_taxFDU";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_payslip_search']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['qt_col_grid']) 
      {  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_payslip_search']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
